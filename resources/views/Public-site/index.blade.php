                    ...
                    <div class="main">
                        ...
                        <div class="Hero-Main-Scetion">
                            <div class="hero-Main-Content">
                                ...
                                <span class="hero-Text" style="line-height: 30px;"><strong>{{$home->notification_heading}}</strong>{{$home->notification}}</span>
                                @endif
                                ...
                                <div class="Hero-Search-Bar">
                                    <div class="Hero-Search-Site">
                                        <div class="Hero-search search-container search-container-main" >  
                                            ...
                                            <input type="text" id="keyword_main" name="keyword" autocomplete="off" placeholder="Search here" />
                                            ...
                                            <div class="suggestions" id="suggestions_main" style="width: max-content;"></div>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid category-sec">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_1" data-cate="{{$home->category_name_1}}" style="cursor: pointer">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_2" data-cate="{{$home->category_name_2}}" style="cursor: pointer">
                        <div class="card text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_3" data-cate="{{$home->category_name_3}}" style="cursor: pointer">
                        <div class="card text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_4" data-cate="{{$home->category_name_4}}" style="cursor: pointer">
                        <div class="card text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_5" data-cate="{{$home->category_name_5}}" style="cursor: pointer">
                        <div class="card text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_6" data-cate="{{$home->category_name_6}}" style="cursor: pointer">
                        <div class="card text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_7" data-cate="{{$home->category_name_7}}" style="cursor: pointer">
                        <div class="card text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <a onclick="SearchCate(this.id)" id="search_cate_8" data-cate="{{$home->category_name_8}}" style="cursor: pointer">
                        <div class="card text-white">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @for ($i = 1; $i <= 8; $i++)
                                ...
                                <div class="dream-card-upper-section">
                                  <div style="height: 180px;">
                                    ...
                                    <video autoplay loop muted  style="height: 100%; width: 100%;">
                                        <source src="assets/teacher/listing/data_{{ $item->user_id }}/media/{{$item->main_file}}" type="video/mp4" >
                                        Your browser does not support the video tag.
                                    </video>
                                @elseif (Str::endsWith($item->main_file, ['.jpg', '.jpeg', '.png', '.gif']))
                                    <!-- Image Display -->
                                    <img src="assets/teacher/listing/data_{{ $item->user_id }}/media/{{$item->main_file}}" style="height: 100%;" alt="Uploaded Image">
                                @endif
                                    </div>
                                ...
                                <a href="#" style="text-decoration: none;">
                                    ...
                                    <div class="dream-card-dawon-section" type="button" data-bs-toggle="offcanvas"   aria-controls="offcanvasRight">
                                        ...
                                        <div class="card-last">
                                            ...
                                            <img data-toggle="tooltip" title="Online-Service" src="assets/seller-listing/asset/img/globe.png" style="height: 25px; width: 25px;" alt="">
                                            
                                            @else
                                            <a  >
                                                <svg  data-toggle="tooltip" title="In Person-Service" xmlns="http://www.w3.org/2000/svg" width="24" height="24" color="#0072b1" fill="currentColor" class="bi bi-house  fa-house" viewBox="0 0 16 16">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="main-Dream-card">
                            <div class="card dream-Card" style="height: 410px;justify-content: center;align-items: center; ">
    ...
    <div class="container-fluid meetcreator-sec">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="slider">
                    <div class="slides">
                        <div class="slide"><img src="assets/public-site/asset/img/{{$home2->banner_1_image}}" alt="Slide 1"></div>
                        <div class="slide"><img src="assets/public-site/asset/img/{{$home2->banner_1_image}}" alt="Slide 2"></div>
                        <div class="slide"><img src="assets/public-site/asset/img/{{$home2->banner_1_image}}" alt="Slide 3"></div>
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel card_carousel">
                        <div class="card card-slider">
                            <div class="card-body">
                                <div class="d-flex"><img src="assets/public-site/asset/img/{{$home2->review_image_1}}" class="rounded-circle">
                        ...
                        <div class="card card-slider">
                            <div class="card-body">
                                <div class="d-flex"><img src="assets/public-site/asset/img/{{$home2->review_image_2}}" class="rounded-circle">
                                    <div class="d-flex flex-column">
                        ...
                        <div class="card  card-slider">
                            <div class="card-body">
                                <div class="d-flex"><img src="assets/public-site/asset/img/{{$home2->review_image_3}}" class="rounded-circle">
                                    <div class="d-flex flex-column">
                        ...
                        <div class="card  card-slider">
                            <div class="card-body">
                                <div class="d-flex"><img src="assets/public-site/asset/img/{{$home2->review_image_4}}" class="rounded-circle">
                                    <div class="d-flex flex-column">
