        ...
        <div class="row">
            <div class="col-md-12">
                <div class="deamHero">
                                    ...
                                    <div class="Hero-Search-Bar">
                                        <div class="Hero-Search-Site">
                                            <div class="Hero-search search-container search-container-main">
                                                ...
                                                <input type="text" id="keyword_main" name="keyword"
                                        ...
                                        <div class="vertical-line"
                                            style="border-right:1px solid #E5F5FF ; height: 82px;">
                    ...
                    <div class="Hero-img">
                        @if ($home)
                            <img class="Hero-img-outer" src="assets/public-site/asset/img/{{ $home->hero_image }}"
                                alt="">
                        @endif
                        <div class="Hero-img-inner" style="z-index: 111;">
                            ...
                            @if ($home)
                                <div class="Hero-main-rateing">
                                    <div class="main-profiles">
                                        <div id="porofile0">
                                            <img src="assets/public-site/asset/img/{{ $home->rating_image_1 }}"
                                                alt="">
                                        </div>
                                        <div id="porofile1">
                                            <img src="assets/public-site/asset/img/{{ $home->rating_image_2 }}"
                                                alt="">
                                        </div>
                                        <div id="porofile2">
                                            <img src="assets/public-site/asset/img/{{ $home->rating_image_3 }}"
                                                alt="">
                                        </div>
                                        <div id="porofile3">
                                            <img src="assets/public-site/asset/img/{{ $home->rating_image_4 }}"
                                                alt="">
                                        </div>
                                        <div id="porofile4">
                                            <img src="assets/public-site/asset/img/{{ $home->rating_image_5 }}"
                                                alt="">
                                        </div>
                                        <div id="porofile5">
                                            <img src="assets/public-site/asset/img/{{ $home->rating_image_6 }}"
                                                alt="">
                            ...
                            <div class="Hero-img-label">
                                <img class="label-img" src="assets/public-site/asset/img/Hero-image-label.png"
                                    alt="">
        ...
        <div class="container">
            @if ($home)
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-top">
                            <img src="assets/public-site/asset/img/{{ $home->work_image_2 }}"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-top">
                            <img src="assets/public-site/asset/img/{{ $home->work_image_3 }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_1" data-cate="{{ $home->category_name_1 }}"
                            ...
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_1 }}"
                                    class="card-img">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_2" data-cate="{{ $home->category_name_2 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_2 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_3" data-cate="{{ $home->category_name_3 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_3 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_4" data-cate="{{ $home->category_name_4 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_4 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_5" data-cate="{{ $home->category_name_5 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_5 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_6" data-cate="{{ $home->category_name_6 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_6 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_7" data-cate="{{ $home->category_name_7 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_7 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a onclick="SearchCate(this.id)" id="search_cate_8" data-cate="{{ $home->category_name_8 }}"
                            style="cursor: pointer">
                            <div class="card text-white">
                                <img src="assets/public-site/asset/img/{{ $home->category_image_8 }}"
                                    class="card-img">
                                <div class="card-img-overlay">
                                        ...
                                        <div class="dream-card-upper-section">
                                            <div style="height: 180px;">
                                                ...
                                                @elseif (Str::endsWith($item->main_file, ['.jpg', '.jpeg', '.png', '.gif']))
                                                    <!-- Image Display -->
                                                    <img src="assets/teacher/listing/data_{{ $item->user_id }}/media/{{ $item->main_file }}"
                                                    ...
                                                    @else
                                                        <a>
                                                            <svg data-toggle="tooltip" title="In Person-Service"
                                                                ...
                                                                height="24" color="#0072b1" fill="currentColor"
                    ...
                    <div class="col-lg-8 col-md-12 meet-textsec">
                        ...
                        <div class="meetcreator-btn">
                            <a href="{{ $home2->banner_1_btn1_link }}" target="__">
                                ...
                                <button type="button"
                                    class="btn freelance-btn">{{ $home2->banner_1_btn1_name }}</button>
                            </a>
                            <a href="{{ $home2->banner_1_btn2_link }}" target="__">

                                <button type="button"
                                    class="btn online-btn">{{ $home2->banner_1_btn2_name }}</button>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="meetcreator-imgsec">
                        ...
                        <div class="border-background">
                            <div class="slider">
                                <div class="slides">
                                    <div class="slide"><img
                                            src="assets/public-site/asset/img/{{ $home2->banner_1_image }}"
                                            alt="Slide 1"></div>
                                    <div class="slide"><img
                                            src="assets/public-site/asset/img/{{ $home2->banner_1_image }}"
                                            alt="Slide 2"></div>
                            ...
                            <div class="main-Dream-card">
                                <div class="card dream-Card">
                                    ...
                                    <div class="dream-card-dawon-section">
                                        <div class="dream-Card-inner-profile">
                                            @php
                                                $firstLetter = $service->user
                                                    ? strtoupper(substr($service->user->first_name ?? 'U', 0, 1))
                                                    : 'U';
                                            @endphp
                                            @if ($service->user && $service->user->profile_image)
                                                <img src="assets/profile/img/{{ $service->user->profile_image }}"
                                                    alt="">
                                            @else
                                                <img src="assets/profile/avatars/({{ $firstLetter }}).jpg"
                                                    alt="">
                                        ...
                                        @php
                                            ...
                                            $full_name = $service->user
                                                ? $service->user->first_name .
                                                    ' ' .
                                                    strtoupper(substr($service->user->last_name ?? '', 0, 1))
                                                : 'Unknown';
                                        @endphp
                                        ...
                                        <div class="d-flex">
                                            @if ($review->user && $review->user->profile)
                                                <img src="{{ asset('uploads/users/' . $review->user->profile) }}"
                                                    class="rounded-circle" alt="{{ $review->user->name ?? 'User' }}"
...
<script>
    $('.owl-carousel').owlCarousel({
        ...
        autoplayHoverPause: true, // hover করলে থামবে
