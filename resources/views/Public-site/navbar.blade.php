...
<head>
    ...
    <title>DreamCrowd | Navbar</title>
</head>
<body>
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="assets/public-site/asset/img/navlogo.png" width="100%">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex nav-search" style="width: 50%;">
                <div class="d-flex justify-content-center" style="width: 100%;">
                    <div class="search">
                        <input type="text" class="search-input" placeholder="Search for a services" name="">
            ...
            <div class="btn-area">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#">Become an Expert</a>
                </li>
                <button type="button" class="btn login-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Login
                </button>
                <button type="button" class="btn register-btn" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                    Register
                </button>
            </div>
        </div>
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex nav-search logdin-nav" style="width: 50%;">
                <div class="d-flex justify-content-center" style="width: 100%;">
                    <div class="search">
                        <input type="text" class="search-input" placeholder="Search for a services" name="">
                        <a href="#" class="search-icon"> <i class="fa fa-search"></i> </a>
            ...
            <div class="btn-area">
                ...
                <!-- BELL SVG START  -->
                <li class="nav-item dropdown dropdown-mega position-static">
                    <a class="nav-link dropdown-toggle p-0" style="padding-left:0px !important ;" href="#"
                ...
                <div class="profile-sec">
                    <p class="mb-0">
                        <img src="assets/public-site/asset/img/profile.png"> <span>Abdullah</span>
                    </p>
                </div>
                <img src="assets/public-site/asset/img/dashboard.png" class="btn dropdown-toggle dash-img" type="button"
                     id="dropdownMicroProcessorTrigger" data-bs-toggle="dropdown" aria-expanded="false">
                <ul class="dropdown-menu dropdown-menu-lg-end dropdown-menu-sm-start logout-dropdawon"
                    ...
                    <li>
                        <a class="dropdown-item" href="#">
                            <i class='bx bx-recycle'></i>&nbsp;Switch To Buyer Account</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="#">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-section">
            ...
            <div class="modal-body p-0 border-0">
                <form class="login-signup-form">
                    <div class="mb-3">
                        ...
                        <div class="">
                            <input type="email" class="form-control place" name="email" value=""
                    ...
                    <div class="login/signup-password">
                        ...
                        <div class="">
                            <input id="password-field" type="password" class="form-control place" name="password"
                    ...
                    <div class="form-check form-checkbox">
                        ...
                        <label class="form-check-pass" for="exampleCheck1">Remember
                            Password</label>
                        <a href="#" class="forget-password float-end fst-italic text-decoration-none">Forgot
                            Password?</a>
                    </div>
            ...
            <div class="modal-footer border-0">
                ...
                <p class="last-section text-center">Didn’t Have an Account? <a href="" class="link" id="signup-link">
                        Signup</a></p>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-signup">
        <div class="modal-content modal-section">
            ...
            <div class="modal-body p-0 border-0">
                <form class="login-signup-form">
                    ...
                    <div class="mb-3 login-signup-password">
                        <label class="control-label">Password</label>
                        <div class="">
                            <input id="password-field1" type="password" class="form-control place" name="password"
                                   value="" placeholder="Password">
                    ...
                    <div class="mb-3 login-signup-password">
                        ...
                        <div class="">
                            <input id="password-field2" type="password" class="form-control place" name="password"
                                   value="" placeholder="Password">
                            <span toggle="#password-field2" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                        </div>
                    </div>
                    <div class="sign-up">
                        <p>Signing up you agree <a href="term-condition.html"><span>Terms &
                                                            Condition </span></a>and <a href="privacy.html"><span>
            ...
            <div class="modal-footer border-0">
                ...
                <p class="last-section text-center">Already Have an Account? <a href="" class="link" id="login-link">
                        Login</a></p>
            </div>
        </div>
    </div>
