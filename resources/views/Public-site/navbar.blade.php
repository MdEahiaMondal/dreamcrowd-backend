    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-section">
            ...
            <div class="modal-body p-0 border-0">
                <form class="login-signup-form">
                    <div class="mb-3">
                        ...
                        <div class="">
                            <input type="email" class="form-control place" name="email" value="" placeholder="Example@gmail.com">
                        </div>
                    </div>
                    <div class="login/signup-password">
                        <label class="control-label">Password</label>
                        <div class="">
                            <input id="password-field" type="password" class="form-control place" name="password" value="" placeholder="Password">
            ...
            <div class="modal-footer border-0">
                ...
                <p class="last-section text-center">Didn’t Have an Account? <a href="" class="link" id="signup-link"> Signup</a></p>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-signup">
                                <div class="modal-content modal-section">
                                    ...
                                    <div class="modal-body p-0 border-0">
                                        <form class="login-signup-form">
                                            ...
                                            <div class="mb-3 login-signup-password">
                                                <label class="control-label">Password</label>
                                                <div class="">
                                                    <input id="password-field1" type="password" class="form-control place" name="password" value="" placeholder="Password">
                                            ...
                                            <div class="mb-3 login-signup-password">
                                                ...
                                                <div class="">
                                                    <input id="password-field2" type="password" class="form-control place" name="password" value="" placeholder="Password">
                                    ...
                                    <div class="modal-footer border-0">
                                        ...
                                        <p class="last-section text-center">Already Have an Account? <a href="" class="link" id="login-link"> Login</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
