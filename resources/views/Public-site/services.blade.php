      ...
      Share &nbsp;
                                            ...
                                            <a id="whatsappShare" target="blank" class="social-margin">
                                                <div class="social-icon whatsapp">
                                                    <img
                                                        ...
                                                        width="60" style="position: relative;bottom: 14px;right:7px;">
                                                </div>
                                            </a>
                    ...
                    @if (Auth::user())
                        ...
                        @if ($profile->user_id != Auth::user()->id)
                            ...
                            <span>
                <div class="con-like">
                  <input title="like" type="checkbox" class="like" id="profile_wish" onclick="AddWishList(this.id);"
                         data-gig_id="{{$profile->id}}" data-type="Profile"
                ...
                <div class="main-tab">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-fill nav-tabs filter-dropdowns" role="tablist">
                            <li><a class="dropdown-item" id="fill-tab-2" data-bs-toggle="tab" href="#fill-tabpanel-2"
                                   role="tab" aria-controls="fill-tabpanel-2" aria-selected="true"
                                   data-service="All,All">All Services (Online & Inperson)</a></li>
                            <li><a class="dropdown-item" id="fill-tab-7" data-bs-toggle="tab" href="#fill-tabpanel-7"
                                   role="tab" aria-controls="fill-tabpanel-7" aria-selected="false"
                                   data-service="Online,Class">Classes (Online & Inperson)</a></li>
                            ...
                            <li><a class="dropdown-item" id="fill-tab-5" data-bs-toggle="tab" href="#fill-tabpanel-5"
                                   role="tab" aria-controls="fill-tabpanel-5" aria-selected="false"
                                   data-service="Online,Freelance">Freelance (Online & Inperson)</a></li>
                    ...
                    <div class="tab-content" id="tab-content">
                            ...
                            <div class="tab-content-data tab-2-rad">
                                ...
                                <div class="form-group">
                                    <input class="form-check-input" type="radio" name="group1" id="flexRadioDefault1"
                                           onclick="ServiceType(this.id)" value="Online" data-tab="record-1"
                                           data-role="All" checked/>
                                ...
                                <div class="d-flex form-inputs">
                                    ...
                                    <div class="dropdown" style="margin: auto;position: relative;right: 13px;">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <hr>
                                            <li><a id="subscription1" onclick="PaymentType(this.id)" data-tab="record-1"
                                                   data-role="All" data-value="Subscription" style="cursor: pointer;"
                                                   onmouseover="this.style.color='#0072b1';"
                                                   onmouseout="this.style.color='black';">Subscription Payment</a></li>
                                                        ...
                                                        <a href="/quick-booking/{{$item->id}}"
                                                           class="col-12 heading view-btn view" id="views">
                                                            ...
                                                            @else
                                                                ...
                                                                @else
                                                                    <div class="col-12 heading view-btn view"
                                                                         type="button"
                        ...
                        <div class="tab-pane" id="fill-tabpanel-7" role="tabpanel" aria-labelledby="fill-tab-7">
                            <div class="tab-content-data tab-7-rad">
                                <!-- Default radio -->
                                <div class="form-group">
                                    <input class="form-check-input" type="radio" name="group11" id="flexRadioDefault10"
                                           onclick="LessonType(this.id)" value="One" data-tab="record-2"
                                           data-role="Class" checked/>
                                    <label class="form-check-label" for="flexRadioDefault10">1 to 1 Lessons</label>
                                </div>

                                <!-- Default checked radio -->
                                <div class="form-group">
                                    <input class="form-check-input" type="radio" name="group11" id="flexRadioDefault11"
                                           onclick="LessonType(this.id)" value="Group" data-tab="record-2"
                                           data-role="Class"/>
                                ...
                                <div class="col-12">
                                    <div class="d-flex form-inputs">
                                        ...
                                        <div class="dropdown" style="margin: auto;position: relative;right: 13px;">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a id="Online2" onclick="ServiceType2(this.id)" data-tab="record-2"
                                                       data-role="Class" data-value="Online" style="cursor: pointer;"
                                                       onmouseover="this.style.color='#0072b1';"
                                                ...
                                                <hr>
                                                <li><a id="oneof2" onclick="PaymentType(this.id)" data-tab="record-2"
                                                       data-role="Class" data-value="OneOff" style="cursor: pointer;"
                                                       onmouseover="this.style.color='#0072b1';"
                                                       onmouseout="this.style.color='black';">One-Off Payment</a></li>
                                                <hr>
                                                <li><a id="subscription2" onclick="PaymentType(this.id)"
                                                       data-tab="record-2" data-role="Class" data-value="Subscription"
                                                       style="cursor: pointer;"
                                                       onmouseover="this.style.color='#0072b1';"
                        ...
                        <div class="tab-pane" id="fill-tabpanel-5" role="tabpanel" aria-labelledby="fill-tab-5">
                            <div class="tab-content-data tab-5-rad">
                                ...
                                <!-- Default radio -->
                                <div class="form-group">
                                    <input class="form-check-input" type="radio" name="group4" id="flexRadioDefault5"
                                           onclick="FreelanceType(this.id)" value="Basic" data-tab="record-3"
                                           data-role="Freelance" checked/>
                                    <label class="form-check-label" for="flexRadioDefault5">Basic Services</label>
                                </div>

                                <!-- Default checked radio -->
                                <div class="form-group">
                                    <input class="form-check-input" type="radio" name="group4" id="flexRadioDefault6"
                                           onclick="FreelanceType(this.id)" value="Premium" data-tab="record-3"
                                           data-role="Freelance"/>
                                    ...
                                    <div class="dropdown" style="margin: auto;position: relative;right: 13px;">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a id="Online3" onclick="ServiceType2(this.id)" data-tab="record-3"
                                                   data-role="Freelance" data-value="Online" style="cursor: pointer;"
                                                   onmouseover="this.style.color='#0072b1';"
                                                   onmouseout="this.style.color='black';">Online</a></li>
                                            <hr>
                                            <li><a id="Inperson3" onclick="ServiceType2(this.id)" data-tab="record-3"
                                                   data-role="Freelance" data-value="Inperson" style="cursor: pointer;"
                                                   onmouseover="this.style.color='#0072b1';"
                                                   onmouseout="this.style.color='black';">Inperson</a></li>
                                            <hr>
                                            <li><a id="oneof3" onclick="PaymentType(this.id)" data-tab="record-3"
                                                   data-role="Freelance" data-value="OneOff" style="cursor: pointer;"
                                                   onmouseover="this.style.color='#0072b1';"
                                                   onmouseout="this.style.color='black';">One-Off Payment</a></li>
                                            <hr>
                                            <li><a id="subscription3" onclick="PaymentType(this.id)" data-tab="record-3"
                                                   data-role="Freelance" data-value="Subscription"
                                                   style="cursor: pointer;" onmouseover="this.style.color='#0072b1';"
                                                   onmouseout="this.style.color='black';">Subscription Payment</a></li>
            ...
            <div class="row scrol-nav">
                <div class="col-lg-8 col-md-12 servise-scroll-section ">
                    <a href="/professional-profile/{{$profile->id}}/{{$profile->first_name}}{{$profile->last_name}}#Service-Overview"><span
                            class="Underline un-active">Service Overview</span></a>
                    <a href="/professional-profile/{{$profile->id}}/{{$profile->first_name}}{{$profile->last_name}}#servise-Card-slider"><span
                            class="Underline">Recently Viewed</span></a>
                    <a href="/professional-profile/{{$profile->id}}/{{$profile->first_name}}{{$profile->last_name}}#FaQ-Accordion"><span
                            class="Underline">FAQ’s</span></a>
                    <a href="/professional-profile/{{$profile->id}}/{{$profile->first_name}}{{$profile->last_name}}#servise-Card-slider2"><span
                            class="Underline">Seller Listing</span></a>
                    <a href="/professional-profile/{{$profile->id}}/{{$profile->first_name}}{{$profile->last_name}}#About-Expert"><span
                                    ...
                                    <i class="fa fa-heart-o" aria-hidden="true"></i>
                                                        ...
                                                        <a href="#" style="text-decoration: none;">
                                                            ...
                                                            <div class="dream-card-dawon-section" type="button"
                                                                ...
                                                                @if ($item->service_role == 'Class')
                                                                    @if ($item->class_type == 'Recorded')
                                                                        <p class="about-teaching"><a
                                                                                class="about-teaching"
                    ...
                    <div class="row rating">
                        <div class="col-md-4">
                            ...
                            <div class="rating-star">
                                ...
                                <div class="star" aria-hidden="true" title="{{ number_format($avgRating,1) }} out of 5">
                                    @php
                                ...
                                <p>Overall Rating</p>
                                <p class="meta-small">{{ $totalReviews }} {{ \Illuminate\Support\Str::plural('review', $totalReviews) }}</p>
                            </div>
                        </div>
