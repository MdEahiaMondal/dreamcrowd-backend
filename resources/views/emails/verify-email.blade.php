														...
														<tr>
															<td class="pad" style="vertical-align: middle; color: #000000; font-family: inherit; font-size: 14px; font-weight: 400; text-align: center;">
																<table class="icons-outer" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-table;">
																	<tr>
																		<td style="vertical-align: middle; text-align: center; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px;"><a  target="_self" style="text-decoration: none;">
                                                                            <img class="icon"  src="https://6246f85385.imgdist.com/pub/bfra/aqt02fag/eki/ejv/mae/navlogo.png" alt="Logo" height="auto" width="212" align="center" style="display: block; height: auto; margin: 0 auto; border: 0;">
                                                                        </a></td>
																	</tr>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 232px;">
                                                                        <img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/8146/confirm.png" style="display: block; height: auto; border: 0; width: 100%;" width="232" alt="Confirm Email" title="Confirm Email" height="auto">
                                                                    </div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:20px;">
																<div style="color:#393d47;direction:ltr;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:center;mso-line-height-alt:24px;">
																	<p style="margin: 0;">We're excited to have you on board! Before we get started, we need you to confirm your email. This ensures that you'll receive all our updates.</p>
																</div>
															</td>
														</tr>
													</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://example.com" style="height:45px;width:124px;v-text-anchor:middle;" arcsize="16%" strokeweight="0.75pt" strokecolor="#0a74ae" fillcolor="#0072b1">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center dir="false" style="color:#ffffff;font-family:Tahoma, sans-serif;font-size:17px">
<![endif]--><a href="{{ url('verify-email/' .$mailData['token']) }}" target="_blank" style="background-color:#0072b1;border-bottom:1px solid #0a74ae;border-left:1px solid #0a74ae;border-radius:7px;border-right:1px solid #0a74ae;border-top:1px solid #0a74ae;color:#ffffff;display:inline-block;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:17px;font-weight:400;mso-border-alt:none;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:auto;word-break:keep-all;"><span style="word-break: break-word; padding-left: 20px; padding-right: 20px; font-size: 17px; display: inline-block; letter-spacing: 2px;"><span style="word-break: break-word; line-height: 34px;">Confirm</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
															</td>
														</tr>
													</table>
												</td>
