											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="icons_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; text-align: center; line-height: 0;">
														<tr>
															<td class="pad" style="vertical-align: middle; color: #000000; font-family: inherit; font-size: 14px; font-weight: 400; text-align: center; padding-top: 20px; padding-bottom: 20px;">
																<table class="icons-outer" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-table;">
																	<tr>
																		<td style="vertical-align: middle; text-align: center;"><a href="#" target="_self" style="text-decoration: none;">
													...
													<table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #393d47; direction: ltr; font-family: Montserrat, sans-serif; font-size: 32px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
																	<span style="word-break: break-word;">{{$isFree ? 'Free' : 'Paid'}} Trial Class Confirmed!</span>
																</h1>
															</td>
														</tr>
													</table>
													<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-top:10px;">
																<div style="color:#393d47;direction:ltr;font-family:Montserrat, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:center;">
																	<p style="margin: 0;">Hi {{$userName}},</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">Your {{$isFree ? 'free' : 'paid'}} trial class has been successfully booked!</p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="paragraph_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-top:10px;">
																<div style="background-color:#f8f9fa;border-radius:10px;padding:20px;border:1px solid #e1e4e8;">
																	<table width="100%" cellpadding="0" cellspacing="0" style="color:#393d47;font-family:Montserrat, sans-serif;font-size:15px;">
																		...
																		<tr>
																			...
																			<td style="padding:8px 0;text-align:right;">{{$classDateTime}}</td>
																		</tr>
																		<tr>
													...
													<table class="paragraph_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:20px;">
																<div style="color:#393d47;direction:ltr;font-family:Montserrat, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:center;">
																	<p style="margin: 0;">You'll receive another email with the Zoom meeting link 30 minutes before your class starts.</p>
																	<p style="margin: 0;">&nbsp;</p>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;text-align:center;">
																<div class="alignment" align="center">
																	<a href="{{$dashboardUrl}}" target="_blank" style="background-color:#0072b1;border-radius:7px;color:#ffffff;display:inline-block;font-family:Montserrat, sans-serif;font-size:16px;font-weight:500;padding:12px 30px;text-align:center;text-decoration:none;">
																		<span style="word-break: break-word;">View My Bookings</span>
																	</a>
																</div>
															</td>
														</tr>
