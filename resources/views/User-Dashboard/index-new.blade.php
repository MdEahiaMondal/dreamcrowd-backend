                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <div class="btn-group flex-wrap" role="group">
                                ...
                                <button type="button" class="btn btn-outline-primary filter-preset" data-preset="year_to_date">Year to Date</button>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <button class="btn btn-primary w-100 mt-2" onclick="applyCustomDateFilter()">Apply Custom</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @if($booking->gig && $booking->gig->images)
                                                        <img src="/{{ json_decode($booking->gig->images)[0] ?? 'assets/default-service.jpg' }}"
                                                             alt="Service" class="rounded me-2" style="width: 40px; height: 40px; object-fit: cover;">
                                                    @endif
                                                    <div>
                                            ...
                                            <td>
                                                <span class="badge bg-secondary">{{ $booking->gig->category_name ?? 'N/A' }}</span>
                                            </td>
