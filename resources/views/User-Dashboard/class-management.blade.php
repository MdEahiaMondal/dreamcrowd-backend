   ...
   <section class="home-section">
                        ...
                        <nav>
                          <ul class="tabs">
                            ...
                            <li class="tab-li icon-badges">
                              <a href="#tab1" class="tab-li__link">Pending Orders<span class="icon-button__badge" style="position: relative;left: 10px;">{{$pendingOrders->count()}}</span></a>
                            </li>
                            
                            <li class="tab-li icon-badges">
                              <a href="#tab2" class="tab-li__link">Active Orders<span class="icon-button__badge">{{$activeOrders->count()}}</span></a>
                            </li>
                            
                            <li class="tab-li badges-sec">
                              <a href="#tab3" class="tab-li__link">Delivered Orders<span class="icon-button__badge">{{$deliveredOrders->count()}}</span></a>
                            </li>
                            
                            <li class="tab-li badges-sec">
                              <a href="#tab4" class="tab-li__link">Completed Orders<span class="icon-button__badge">{{$completedOrders->count()}}</span></a>
                            </li>
                            <li class="tab-li badges-sec">
                              <a href="#tab5" class="tab-li__link">Cancelled Orders<span class="icon-button__badge">{{$cancelledOrders->count()}}</span></a>
                            </li>
                                        ...
                                        <tr>
                                          <td>
                                            <div class="profile-sec">
                                                <img src="assets/profile/img/{{$order->profile_image}}" alt="">
                                                <p>{{ $order->first_name }}  {{strtoupper(substr($order->last_name, 0, 1))}}.<br><span>{{ $order->profession }}</span></p>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="service-title">
                                              <p type="button" id="show_detail_model_{{$order->order_id}}" onclick="ShowDetailsModel(this.id)" data-values="{{ json_encode($order) }}" class="btn seller-desc"  data-bs-toggle="modal" data-bs-target="#sell-service-modal" data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}" 
                                                data-order_id="{{$order->order_id}}"  data-teacher_reschedule="{{$order->teacher_reschedule}}" data-status="{{$order->status}}"  data-service_role="{{$order->service_role}}" data-start_date="{{$order->start_date}}" data-end_date="{{$order->end_date}}"
                                                data-price="{{$order->finel_price}}" data-new_all_classes="{{ json_encode($order->new_all_classes) }}" data-all_classes="{{$order->all_classes}}" data-payment_type="{{$order->payment_type}}" data-freelance_service="{{$order->freelance_service}}" data-lesson_type="{{$order->lesson_type}}" data-service_type="{{$order->service_type}}" data-description="{{$order->description}}" >{{$order->title}}</p>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="service-badges">
                                                <h3 class="mb-0"><span class="badge service-class-badge">{{ $order->service_type }} {{ $order->service_role }}</span></h3>
                                            </div>
                                          </td>
                                          <td>
                                          ...
                                          <td>
                                            <div class="action-sec">
                                              <button class="btn action-btn" onclick="ActionModelShow(this.id)"   data-values="{{ json_encode($order) }}"   data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}"   data-user_id="{{$order->user_id}}"
                                                data-order_id="{{$order->order_id}}" data-reschedule="{{$order->teacher_reschedule}}" data-freelance_service="{{$order->freelance_service}}"  data-status="{{$order->status}}"  data-service_role="{{$order->service_role}}" data-start_date="{{$order->start_date}}" data-end_date="{{$order->end_date}}"
                                                data-price="{{$order->finel_price}}" data-new_all_classes="{{ json_encode($order->new_all_classes) }}" data-all_classes="{{$order->all_classes}}" data-payment_type="{{$order->payment_type}}" data-freelance_service="{{$order->freelance_service}}" data-lesson_type="{{$order->lesson_type}}" data-service_type="{{$order->service_type}}"  data-teacher_reschedule="{{$order->teacher_reschedule}}" data-description="{{$order->description}}"     id="class-reshedule_{{$order->order_id}}" >...</button>
                                            </div>
                                          </td>
                                        </tr>
                  ...
                  <div class="demo">
                    ...
                    <nav class="pagination-outer" aria-label="Page navigation">
                        <ul class="pagination"> 
                            ...
                            @else
                            <li class="page-item">
                              <a   class="page-link" href="{{ $pendingOrders->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                            ...
                            @for ($i = $start; $i <= $end; $i++)
                                ...
                                <li class="page-item active" aria-current="page"><a class="page-link" >{{ $i }}</a></li>
                                  @else
                                <li class="page-item "><a class="page-link" href="{{ $pendingOrders->url($i) }}">{{ $i }}</a></li>
                                @endif
                            @endfor
                            ...
                            <li class="page-item">
                              <a class="page-link" href="{{ $pendingOrders->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                                »
                              </a>
                          </li>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="action-sec">
                                              <button class="btn action-btn" onclick="ActionModelShow(this.id)"   data-values="{{ json_encode($order) }}"   data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}"   data-user_id="{{$order->user_id}}"
                                                data-order_id="{{$order->order_id}}" data-current_class="{{json_encode($order->current_class)}}" data-reschedule="{{$order->teacher_reschedule}}" data-freelance_service="{{$order->freelance_service}}"  data-status="{{$order->status}}"  data-service_role="{{$order->service_role}}" data-start_date="{{$order->start_date}}" data-end_date="{{$order->end_date}}"
                                                data-price="{{$order->finel_price}}"  data-past_classes="{{ json_encode($order->past_classes) }}"  data-new_all_classes="{{ json_encode($order->new_all_classes) }}" data-all_classes="{{$order->all_classes}}" data-payment_type="{{$order->payment_type}}" data-freelance_service="{{$order->freelance_service}}" data-lesson_type="{{$order->lesson_type}}" data-service_type="{{$order->service_type}}"  data-teacher_reschedule="{{$order->teacher_reschedule}}" data-description="{{$order->description}}"     id="class-reshedule_{{$order->order_id}}" >...</button>
                                            </div>
                                          </td>
                                        </tr>
    ...
    <nav class="pagination-outer" aria-label="Page navigation">
        <ul class="pagination"> 
            ...
            @else
            <li class="page-item">
              <a   class="page-link" href="{{ $activeOrders->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                  <span aria-hidden="true">«</span>
              </a>
          </li>
            ...
            @for ($i = $start; $i <= $end; $i++)
                ...
                <li class="page-item active" aria-current="page"><a class="page-link" >{{ $i }}</a></li>
                  @else
                <li class="page-item "><a class="page-link" href="{{ $activeOrders->url($i) }}">{{ $i }}</a></li>
                 @endif
            @endfor
            ...
            <li class="page-item">
              <a class="page-link" href="{{ $activeOrders->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                »
              </a>
          </li>
...
@endif
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                           ...
                                           <td>
                                            <div class="service-badges">
                                                <h3 class="mb-0"><span class="badge service-badge">Delivered</span></h3>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="action-sec">
    ...
    <nav class="pagination-outer" aria-label="Page navigation">
        <ul class="pagination"> 
            ...
            @else
            <li class="page-item">
              <a   class="page-link" href="{{ $deliveredOrders->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                  <span aria-hidden="true">«</span>
              </a>
          </li>
            ...
            @for ($i = $start; $i <= $end; $i++)
                ...
                <li class="page-item active" aria-current="page"><a class="page-link" >{{ $i }}</a></li>
                  @else
                <li class="page-item "><a class="page-link" href="{{ $deliveredOrders->url($i) }}">{{ $i }}</a></li>
                 @endif
            @endfor
            ...
            <li class="page-item">
              <a class="page-link" href="{{ $deliveredOrders->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                »
              </a>
          </li>
...
@endif
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                           ...
                                           <td>
                                            <div class="service-badges">
                                                <h3 class="mb-0"><span class="badge service-badge">Completed</span></h3>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="action-sec">
                  ...
                  <div class="demo">
                    ...
                    <nav class="pagination-outer" aria-label="Page navigation">
                        <ul class="pagination"> 
                            ...
                            @else
                            <li class="page-item">
                              <a   class="page-link" href="{{ $completedOrders->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                                  <span aria-hidden="true">«</span>
                              </a>
                          </li>
                            ...
                            @for ($i = $start; $i <= $end; $i++)
                                ...
                                <li class="page-item active" aria-current="page"><a class="page-link" >{{ $i }}</a></li>
                                  @else
                                <li class="page-item "><a class="page-link" href="{{ $completedOrders->url($i) }}">{{ $i }}</a></li>
                                @endif
                            @endfor
                            ...
                            <li class="page-item">
                              <a class="page-link" href="{{ $completedOrders->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                                »
                              </a>
                          </li>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                           ...
                                           <td>
                                            <div class="service-badges">
                                                <h3 class="mb-0"><span class="badge service-badge">  
                                                 @if($order->refund == 1) Refunded @elseif ( $order->user_dispute == 1)   Disputed  @else  Cancelled  @endif
                                                   </span></h3>
                                            </div>
                                          </td>
                                          <td>
                ...
                <nav class="pagination-outer" aria-label="Page navigation">
                    <ul class="pagination"> 
                        ...
                        @else
                        <li class="page-item">
                          <a   class="page-link" href="{{ $cancelledOrders->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                              <span aria-hidden="true">«</span>
                          </a>
                      </li>
                        ...
                        @for ($i = $start; $i <= $end; $i++)
                            ...
                            <li class="page-item active" aria-current="page"><a class="page-link" >{{ $i }}</a></li>
                              @else
                            <li class="page-item "><a class="page-link" href="{{ $cancelledOrders->url($i) }}">{{ $i }}</a></li>
                            @endif
                        @endfor
                        ...
                        <li class="page-item">
                          <a class="page-link" href="{{ $cancelledOrders->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                            »
                          </a>
                      </li>
                                        ...
                                        <td>
                                          <div class="row">
                                            ...
                                            <div class="float-end expert-dropdown">
                                              ...
                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <a class="dropdown-item" href="#"><li>Send Message</li></a>
                                                <a class="dropdown-item" href="#"><li>View Profile</li></a>
                                                <a class="dropdown-item" href="#"type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cancel-service-modal"><li>Cancel Subscription</li></a>
                                                <a class="dropdown-item" href="#"><li>Report Seller</li></a>
                                              </ul>
                                            </div>
                                            </div>
                                          </div>                                           
                                                              ...
                                                              <tr>
                                                                <td>
                                                                  <div class="row">
                                                                    <div class="col-md-12">
                                                                      <div class="float-start profile-section">
                                                                        <img src="assets/user/asset/img/expert-img-5.png" alt="">
                                                                        <p>Cameron W. <br><span>Graphic Designer</span></p>
                                                                    </div> 
                                                                    <div class="float-end expert-dropdown">
                                                                      <button class="btn action-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">...</button>
...
<!-- =============================================================================================================================================================== -->
          ...
          <div class="modal-body p-0">
            <form class="row">
              ...
              <div class="col-12 services-form">
                ...
                <input type="text" class="form-control" id="detail_service" placeholder="Freelance Service" readonly>
              </div>
              <div class="col-12 services-form">
                <label for="inputAddress2" class="form-label">Payment Type</label>
                <input type="text" class="form-control" id="detail_payment" placeholder="Freelance Service" readonly>
              </div>
              <div class="col-12 services-form">
                <label for="inputAddress" class="form-label">Service Title</label>
                <input type="text" class="form-control" id="detail_title" placeholder="I wil Design best UI design for you" readonly>
              </div>
              <div class="col-12 service-desc">
                <label for="inputAddress" class="form-label">Description</label><br>
                <textarea name="" id="detail_description" cols="30" rows="10" placeholder="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged." readonly></textarea>
              </div>
              ...
              <div class="col-12 services-form date_main">
                ...
                <input type="text" class="form-control" id="detail_current_date" placeholder="November 23,2023" readonly>
              </div>
              <div class="col-12 services-form date_main extended_date_main">
                <label for="inputAddress" class="form-label">Extended date</label>
                <input type="text" class="form-control" id="detail_extended_date" placeholder="November 23,2023" readonly>
              </div>

              <div class="col-12 services-form view_date_model">
                <label for="inputAddress" class="form-label">Subscription Start Date & Time</label>
                <input type="text" class="form-control" id="detail_start_date" placeholder="November 23,2023" readonly>
              </div>
              <div class="col-12 services-form view_date_model">
                <label for="inputAddress" class="form-label">Subscription End Date & Time</label>
                <input type="text" class="form-control" id="detail_end_date" placeholder="November 23,2023" readonly>
              </div>
              ...
              <button type="button" id="detail_service_reject" data-bs-dismiss="modal" aria-label="Close"   class="btn booking-cancel reject_view view_model_btns mt-1 btn-outline-danger">Reject</button>
              <button type="button" class="btn reschedule-btn  active_btn_css reschedule_view view_model_btns" style=" margin: 0 auto;"  id="reschedule-btn-model"> Reschedule</button> 
              
              <button type="button"  id="detail_service_accept" class="btn float-end accept_view active_btn_css view_model_btns  mt-1" > Accept</button>
            </div>
            ...
            <button type="button"  id="detail_service_accept" class="btn float-end active_btn_css  mt-1" data-bs-dismiss="modal"  onclick="SendSMS()"> Accept</button> --}}
          </div>
        </div>
      </div> 
    </div>
    ...
    <!-- Action Freelace Modal Start From Here -->
      <div class="modal fade" id="freelance-extend-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content like-to-do-modal">
          <div class="modal-body p-0">
            <h5 class="text-center mb-0 all_classes_past_heading">The following classes can no longer be rescheduled as they are under 12 hours</h5>
            <div class="row">
              <div class="col-md-12 ">
              ...
              <h5 class="text-center mb-0">Would you still like to go Reschedule page</h5>
                <div class="col-md-6 services-buttons">
                  <button type="button" class="btn cancel-service-btn"   data-bs-dismiss="modal" aria-label="Close" >No</button>
                </div>
            ...
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                ...
                <div class="col-md-12 services-buttons all_actions_buttons" id="accept"  >
                  <button class="btn accept-service-btn" id="accept-btn">Accept Reshedule</button>
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel">
                  <button type="button" class="btn cancel-btn"  id="cancel-btn" onclick="CancelModelShow(this.id);"> Cancel Order </button> 
                </div>

                <div class="col-md-12     services-buttons all_actions_buttons"  id="send_message">
                  <button type="button" class="btn   send-message-btn"  data-bs-toggle="modal" data-bs-target="#contact-me-modal"   id="send-message-btn">Send Message</button>
                </div>
              </div>
                {{-- Pending Orders ===== --}}
                ...
                <div id="active_class_main" class="actions_main">
                            ...
                            <div class="col-md-12 services-buttons all_actions_buttons reschedule_main" id="accept_reschedule"  >
                  <button class="btn   accept-reschedule" id="accept-reschedule-class">Accept Reschedule</button>
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons reschedule_main"  id="reject_reshedule_class">
                  <button type="button" class="btn reject-reschedule"  id="reject-reschedule-class-btn"  > Reject Reschedule</button> 
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="reschedule_class">
                  <button type="button" class="btn reschedule-class-btn " data-bs-toggle="modal" data-bs-target="#freelance-extend-modal" onclick="$('#OrdersActionModel').modal('hide')"  id="reschedule-class-btn"> Reschedule Class</button> 
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_class">
                  <button type="button" class="btn cancel-class-btn"  id="cancel-class-btn"  onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>

                  <div class="col-md-12 dispute_main services-buttons all_actions_buttons"  id="dispute3">
                  <button type="button" class="btn  dispute-btn"  id="dispute-btn3"> Cancel & Dispute Order</button> 
                </div>

                {{-- <div class="col-md-12   services-buttons all_actions_buttons"  id="complete">
                  <button type="button" class="btn  mark-completed-btn" data-bs-toggle="modal" data-bs-target="#mark-as-completed-modal" id="mark-completed-btn">Mark as Completed</button>
                </div> --}}
              </div>
                ...
                <div id="active_consultation_main" class="actions_main">
                 ...
                 <div class="col-md-12 services-buttons all_actions_buttons reschedule_main" id="accept_reschedule_session"  >
                  <button class="btn   accept-reschedule" id="accept-reschedule-session">Accept Reschedule</button>
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="reschedule_session">
                  <button type="button" class="btn reschedule-session-btn  " data-bs-toggle="modal" data-bs-target="#freelance-extend-modal" onclick="$('#OrdersActionModel').modal('hide')"  id="reschedule-session-btn"> Reschedule Session</button> 
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_session">
                  <button type="button" class="btn cancel-session-btn"  id="cancel-session-btn"  onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>

                  <div class="col-md-12 dispute_main services-buttons all_actions_buttons"  id="dispute2">
                  <button type="button" class="btn  dispute-btn"  id="dispute-btn2"> Cancel & Dispute Order</button> 
                </div>
              ...
              <div id="active_normal_main" class="actions_main">
                                  ...
                                  <div class="col-md-12 services-buttons all_actions_buttons reschedule_main" id="accept_reschedule_date"  >
                  <button class="btn   accept-reschedule" id="accept-reschedule-date">Accept Extend Date</button>
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons reschedule_main"  id="reject_reshedule_class">
                  <button type="button" class="btn reject-reschedule"  id="reject-reschedule-date-btn"  > Reject Extend Date</button> 
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_order">
                  <button type="button" class="btn cancel-order-btn"  id="cancel-order-btn"  onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>

                  {{-- <div class="col-md-12 dispute_main services-buttons all_actions_buttons"  id="dispute1">
                  <button type="button" class="btn  dispute-btn"  id="dispute-btn1"> Cancel & Dispute Order</button> 
                </div> --}}
                ...
                {{-- Delivered Orders ===== --}}
                {{-- Class/Consultation ===== --}}
                <div id="delivered_class_main" class="actions_main">
                ...
                <div class="col-md-12 dispute_main services-buttons all_actions_buttons"  id="dispute">
                  <button type="button" class="btn  dispute-btn"  id="dispute-btn"> Cancel & Dispute Order</button> 
                </div>
              </div>
                {{-- Normal Freelance ===== --}}
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="move_order">
                  <button type="button" class="btn move-order-btn"  id="move-order-btn"> Unsatisfactory - Needs Improvement </button> 
                </div>
                ...
                <div class="col-md-12 dispute_main services-buttons all_actions_buttons"  id="dispute_order">
                  <button type="button" class="btn dispute-btn dispute-order-btn"  id="dispute-order-btn"> Cancel & Dispute Order</button> 
                </div>
                ...
                <div class="col-md-12   services-buttons all_actions_buttons view_rate_main"  id="view_rate">
                  <button type="button" class="btn mb-0 view-rate-btn"  data-bs-toggle="modal" data-bs-target="#view-review-modal"  id="view-rate-btn">View Feedback</button>
                </div>
                <div class="col-md-12   services-buttons all_actions_buttons rate_main"  id="rate">
                  <button type="button" class="btn mb-0 rate-btn"  data-bs-toggle="modal" data-bs-target="#add-review-modal"  id="rate-btn">Rate Service & Leave Feedback</button>
                </div>
              </div>
                {{-- Completed Orders ===== --}}
                ...
                <div class="col-md-12   services-buttons all_actions_buttons view_rate_main"  id="view_feedback">
                  <button type="button" class="btn   view-feadback-btn"  data-bs-toggle="modal" data-bs-target="#view-review-modal"  id="view-feadback-btn">View Feedback</button>
                </div>

                <div class="col-md-12   services-buttons all_actions_buttons rate_main"  id="feedback">
                  <button type="button" class="btn   feadback-btn"  data-bs-toggle="modal" data-bs-target="#add-review-modal"  id="feadback-btn">Rate Service & with Feedback</button>
                </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 review-rating  ">
                            ...
                            <i class="fa-regular fa-star star-rating" data-value="1" style="padding-left: 6px;cursor: pointer;"></i>
                            <i class="fa-regular fa-star star-rating" data-value="2" style="padding-left: 6px;cursor: pointer;"></i>
                            <i class="fa-regular fa-star star-rating" data-value="3" style="padding-left: 6px;cursor: pointer;"></i>
                            <i class="fa-regular fa-star star-rating" data-value="4" style="padding-left: 6px;cursor: pointer;"></i>
                            <i class="fa-regular fa-star star-rating" data-value="5" style="padding-left: 6px;cursor: pointer;"></i>
                        </div>
                    </div>
                    <h5 class="">Review <span>(optional)</span></h5>
                    <input type="hidden" name="order_id" id="review_order_id" value=""> 
                    <textarea class="form-control add-review mb-3" name="cmnt" id="feedback_comments" placeholder="Give your feedback" rows="4"></textarea>
    ...
    <div class="modal-dialog">
        <div class="modal-content add-review-rating-modal">
                ...
                <div class="modal-body p-4">
                    ...
                    <h5 class="">Review <span>(optional)</span></h5> 
                    <textarea class="form-control add-review mb-3" name="cmnt_view" id="feedback_comments_view" disabled placeholder="Give your feedback" rows="4"></textarea>
                  </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content add-review-rating-modal">
            ...
            <form action="/cancel-order" method="POST"> @csrf
              ...
              <p ><b>Note:</b> <small class="text-danger cancellation_text_note">Refunds are free within 24 hours, and will only be provided if the seller reschedules and the buyer requests one.</small> </p>
                <ul id="partial-class-list"></ul>
              <input type="hidden" name="order_id" id="cancel_order_id">
              <input type="hidden" name="cancel_order_refund" id="cancel_order_refund" value="0">
              <textarea class="form-control add-review" name="reason" id="cancel_reason" placeholder="write cancelation reason..." required></textarea>
              <button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn booking-cancel btn-outline-danger ">Close</button>
...
<!-- Order Cancel  Modal END =========-->
    ...
    <!-- Modal -->
    <div class="modal fade" id="dispute-request-refund-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
            ...
            <div class="row">
              ...
              <div class="col-md-12 radio-tabs-sec">          
                  <div class="col-md-12 radio-tab-section active partial_am_main">
                    ...
                    <input type="radio" id="dispute_partial_refund" name="refund" class="radio-but" value="1" checked>
                ...
                <input type="number" class="form-control dispute_partial_am" name="refund_amount" id="dispute_refund_amount" placeholder="$1500" >
                  <h5 class="mb-0 refund">Refund Reason</h5>
                  <textarea class="form-control" name="reason" id="dispute_refund_reason" placeholder="explain why dispute order..." required></textarea>
                  <button type="button" class="btn float-start cancel-button btn-outline-danger">Cancel</button>
                  <button type="submit" class="btn float-end submit-button"   id="submit-cancel-service">Submit</button>
                </article>
          ...
          <div class="modal-dialog">
            <div class="modal-content add-review-rating-modal">
              <div class="modal-body p-0">
                ...
                <textarea class="form-control add-review" name="message-textarea" id="message-textarea" placeholder="type your message..." ></textarea>
                <button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn booking-cancel  btn-outline-danger">Cancel</button>
                <button type="button" class="btn float-end submit-review-btn" data-bs-dismiss="modal"  onclick="SendSMS()"> Send Message</button>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Send Message  Modal END =========-->
    ...
    <!-- Modal -->
    <div class="modal fade" id="reshedule-service-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content extended-deadline-modal">
          <div class="modal-body">
      ...
      <div class="modal-dialog">
        <div class="modal-content cancel-service-only-modal">
          <div class="modal-body">
            ...
            <button type="button" class="btn yes-btn" data-bs-toggle="modal" data-bs-target="#successfully-cancelled-modal" id="successfully-cancelled">Yes</button>
    ...
    <!-- Modal -->
    <div class="modal fade" id="successfully-cancelled-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content yes-successfully-cancelled-modal">
          <div class="modal-body p-0">
            ...
            <button type="button" class="btn add-review-btn" data-bs-toggle="modal" data-bs-target="#add-review-modal" id="rating-review">Add Review</button>
          </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-12 radio-tabs-sec">          
                  <div class="col-md-12 radio-tab-section active">
                    <input type="radio" id="tab1" name="tab" class="radio-but" checked>
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="$1500">
                  ...
                  <button type="button" class="btn float-end submit-button" data-bs-toggle="modal" data-bs-target="#cancel-services-modal" id="submit-cancel-services">Submit</button>
                </article>
                <article>
                  <h5 class="mb-0 refund">Refund Reason</h5>
                <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="write here reason of refund"></textarea>
    ...
    <!-- freelance extend deadline modal start from here -->
     ...
     <div class="modal fade" id="freelance-priority-extended-deadline-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content extended-deadline-modal">
          <div class="modal-body">
            <h5 class="mb-0">Extend Service</h5>
    ...
    <!-- Modal -->
    <div class="modal fade" id="mark-as-completed-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content yes-successfully-cancelled-modal">
          <div class="modal-body p-0">
            ...
            <div class="text-center">
            <button type="button" class="btn add-review-btn" data-bs-toggle="modal" data-bs-target="#rating-modal" id="add-reviews">Add Review</button>
          </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content add-review-rating-modal">
          <div class="modal-body p-0">
            ...
            <textarea class="form-control add-review" name="comments" id="feedback_comments" placeholder="give your feedback" ></textarea>
          ...
          <div class="modal-body p-0">
            ...
            <div class="cancel-section">
              <div class="row cancel-service-modal-sec">
                <div class="col-md-12">
                  <p>Elevate Your Designs: Mastering the Art of Creating Striking UI for Client Satisfaction</p>
                </div> 
              </div>
              <hr>
              <div class="row cancel-service-modal-sec">
          ...
          <div class="modal-body p-0">
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                ...
                <div class="col-md-12 services-buttons">
                  <a href="reschedule-classes.html"><button type="button" class="btn extend-deadline-btn"> Reschedule Class</button></a>
                </div>
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn cancel-service-btn" data-bs-toggle="modal" data-bs-target="#cancel-services-modal" id="cancel-only">Cancel Class</button>
                </div>
                <!-- Ali -->
                <div class="col-md-12 mb-0 services-buttons">
                  <button type="button" class="btn mb-0 mark-completed-btn" data-bs-toggle="modal" data-bs-target="#mark-as-completed-modal" id="mark-as-completed">Mark as Completed</button>
                </div>-
              </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="freelance-priority-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content like-to-do-modal">
          <div class="modal-body p-0">
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn extend-deadline-btn" data-bs-toggle="modal" data-bs-target="#freelance-priority-extended-deadline-modal" id="extend-deadlines">Extended Deadline</button>
                </div>
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn cancel-service-btn" data-bs-toggle="modal" data-bs-target="#cancel-services-modal" id="cancel-service">Cancel Order</button>
                </div>
                <div class="col-md-12 mb-0 services-buttons">
                  <button type="button" class="btn mb-0 mark-completed-btn" data-bs-toggle="modal" data-bs-target="#mark-as-completed-modal" id="completed-mark">Mark as Completed</button>
                </div>
              </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="freelance-priority-modal-delivered" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content like-to-do-modal">
          <div class="modal-body p-0">
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">         
                ...
                <div class="col-md-12 services-buttons" style="margin-top: 12px;">
                  <button type="button" class="btn extend-deadline-btn" data-bs-toggle="modal" data-bs-target="#freelance-priority-extended-deadline-modal">Unsatisfactory - Needs Improvement</button>
                </div>
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn cancel-service-btn" data-bs-toggle="modal" data-bs-target="#cancel-services-modal" id="cancel-service">Cancel Order</button>
                </div>
    ...
    <!-- Delivered orders freelance modal ended here -->
     ...
     <div class="modal fade" id="delivered-orders-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content like-to-do-modal">
          <div class="modal-body p-0">
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                <div class="col-md-12 mb-0 services-buttons">
                  <button type="button" class="btn mark-completed-btn" data-bs-toggle="modal" data-bs-target="#mark-as-completed-modal" id="marked-completely">Mark as Completed</button>
                </div>
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn refund-btn" data-bs-toggle="modal" data-bs-target="#cancel-services-modal" id="cancelled-only">Cancel Service only</button>
                </div>
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn mb-0 refund-btn" data-bs-toggle="modal" data-bs-target="#request-refund-modal" id="cancel-refund">Cancel Service & Request refund</button>
                </div>
              </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="completed-orders-modal-rating1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content like-to-do-modal">
          <div class="modal-body p-0">
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                <div class="col-md-12 mb-0 services-buttons">
                  <button type="button" class="btn mark-completed-btn" data-bs-toggle="modal" data-bs-target="#mark-as-completed-modal" id="give-reviews">Rate Service</button>
                </div>
              </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="completed-orders-modal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content like-to-do-modal">
          <div class="modal-body p-0">
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                ...
                <div class="col-md-12 services-buttons">
                  <button type="button" class="btn refund-btn" data-bs-toggle="modal" data-bs-target="#request-refund-modal2" id="refund-request2">Request Refund</button>
                </div>
              </div>
          </div>
        </div>
...
var more_text = '' ;
 ...
 document.getElementById('dispute_refund_amount').placeholder = 'max amount : $'+price;
    ...
    all_classes.forEach(cls => {
        const classTime = moment.tz(cls.user_date, cls.user_time_zone);
    ...
    if (allAttended || allWithinReschedule || freelance_service == 'Normal') {
      ...
      cancelation_text = "You will be refunded imediately after cancellation.";
...
$('.new_all_classes_ul').empty();
      ...
      if (service_role == 'Class') {
        ...
        for (let i = 0; i < all_classes.length; i++) {
          ...
          var user_date = all_classes[i].user_date  ;
          ...
          if (all_classes[i].user_attend == 0) {
        ...
        for (let i = 0; i < new_all_classes.length; i++) {
          var user_date = new_all_classes[i].user_date ;
        ...
        if (new_all_classes.length > 0) {
          $('.date_main').show();
          $('#detail_current_date').val(all_classes[0].user_date);
          $('#detail_extended_date').val(new_all_classes[0].user_date);
        } else {
          $('.date_main').hide(); 
        }
...
if (all_classes_past.length > 0) {
  ...
  $('.all_classes_past_heading').hide();
        ...
        for (let i = 0; i < all_classes_past.length; i++) {
          var user_date = all_classes_past[i].user_date ;
           user_date = moment(user_date).format('ddd MMM DD, YYYY h:mmA');
          if (all_classes_past[i].user_attend == 0) {
            var user_attend =  'Not Attend' ;
          } else {
                var user_attend =  'Attended' ;
          }
...
if (current_class) {
    var teacherDateTime = new Date(current_class.user_date.replace(' ', 'T')); // Converts to Date object
    var now = new Date();
    ...
    var hideTime = null ;
      ...
      window.location.href = '/back-to-active/' + order_id;
            ...
            $('#delivered_freelance_main').show(); 
          } else {
            $('#delivered_class_main').show(); 
    ...
    $('#feedback_comments_view').val(review.cmnt);
          ...
          if (dispute == 0 && hoursDiff <= 48 && values.refund == 0) {
              $('#dispute-main').show();
          } else {
              $('#dispute-main').hide();
          }
