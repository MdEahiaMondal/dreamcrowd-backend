        ...
        <div class="modal-content add-review-rating-modal">
            <div class="modal-body p-4">
                <form id="review-form" method="post" action="/submit-review">
                    @csrf
                    <input type="hidden" name="order_id" id="edit_review_order_id" value="">
                    <input type="hidden" name="rating" id="edit_review_rating" value="0">
...
<script>
    ...
    function ActionModelShow(Clicked) {
        ...
        $('#edit_review_order_id').val(order_id);
        $('#edit_review_rating').val(values?.review?.rating ?? 0);
        $('#review_id').val(values?.review?.id ?? '');
