...
<body>
    ...
    <div class="container-fluid">
        <div class="container">
            <form id="formsubmit" action="/user-update-classes" method="POST"> @csrf
            <div class="row">
            ...
            <div class="confirmation-btns">
                <div class="row">
                    <div class="col-md-12 confirmation-buttons">
                                <a href="/order-management" class="btn canelation-btn">Cancel</a> 
                            @if ($class->count() != 0)
...
function getBlockedSlots() {
        ...
        bookedTimes.forEach((booking) => {
            let { user_date, duration } = booking;
            if (!user_date || !duration) return;
            let date = user_date ;
