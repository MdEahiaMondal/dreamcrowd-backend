            ...
            <div class="row payment-type mx-1 my-3">
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  ...
                  <input class="payment-input" name="public_rate" id="public_rate" placeholder="$50" type="number"   onfocusout="validateRatePrice(this)"  />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" name="public_group_size" id="public_size" placeholder="max 100"  type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" name="public_discount" id="public_discount" placeholder="50%" type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" name="public_earning" id="public_estimated_earning" placeholder="$50" readonly type="text" />
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  ...
                  <input class="payment-input" name="private_rate" id="private_rate" placeholder="$50" type="number"  onfocusout="validateRatePrice(this)" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" name="private_group_size" id="private_size" placeholder="max 100"  type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" name="private_discount" id="private_discount" placeholder="50%" type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" name="private_earning" id="private_estimated_earning" placeholder="$50" readonly type="text" />
                </div>
              </div>
