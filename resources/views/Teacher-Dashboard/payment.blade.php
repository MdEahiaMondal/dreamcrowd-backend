                        ...
                        @if (in_array($gigData->group_type, ['Public', 'Both']))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12">
                                    ...
                                    <input class="payment-input" name="public_rate" id="public_rate" placeholder="$50"
                                           type="number" onfocusout="validateRatePrice(this)"/>
                                </div>
                                <div class="col-md-3 col-sm-12">
                                    <h3
                                        class="online-Class-Select-Heading"
                        ...
                        @if(in_array($gigData->group_type, ['Private', 'Both']))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12">
                                    ...
                                    <input class="payment-input" name="private_rate" id="private_rate" placeholder="$50"
                                           type="number" onfocusout="validateRatePrice(this)"/>
                                </div>
                                <div class="col-md-3 col-sm-12">
                                    <h3
                                ...
                                <div class="col-md-3 col-sm-12">
                                    ...
                                    <input class="payment-input" name="private_earning" id="private_estimated_earning"
                                           placeholder="$50" readonly type="text"/>
                                </div>
                            </div>
