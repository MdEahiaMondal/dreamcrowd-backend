...
<script src="https://kit.fontawesome.com/be69b59144.js" crossorigin="anonymous"></script>
    <!-- Defualt css -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.2/font/bootstrap-icons.min.css">
    <link rel="stylesheet" type="text/css" href="assets/teacher/asset/css/style.css" />
...
<section class="home-section">
  ...
  <section id="hero_section">
    ...
    <div class="content">
    <h2>Thank You</h2>
    <p>You have successfully updated your service on DreamCrowd Plateform</p>
    <a href="payment-2.html"><button class="btn check-service-btn">Check your service</button></a>
  </div>
          </div>
        </div>
      </div>
