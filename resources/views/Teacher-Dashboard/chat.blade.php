                                               ...
                                               <div class="model-heading">
                                                ...
                                                <div class="d-flex option-btn">
                                                    <div class="d-flex radio-toolbar">
                                                          <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="radio" id="radioClass" name="radioService" value="Class" checked   data-bs-dismiss="modal"> 
                                                        <label for="radioClass">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="radio" id="radioFreelance" name="radioService" value="Freelance"   data-bs-dismiss="modal">
                                                                <label for="radioFreelance">
                                       ...
                                       <div class="modal" id="secondModal">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body bg-white services_main">
                                       ...
                                       <div class="modal" id="fourmodal">
                                        <div class="modal-dialog">
                                          <div class="modal-content date-modal">
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="head w-100">
                                                    <h1 class="text-center">Choose how you want to get paid</h1>
                                                   </div>
                                               <div class="model-heading">
                                     ...
                                     <div class="modal" id="fiveModal">
                                      <div class="modal-dialog">
                                        <div class="modal-content date-modal">
                                          <div class="modal-body p-0">
                                            <div class="head">
                                                <h1 class="text-center">Create a milestone offer</h1>
                                            </div>
                                      ...
                                      <div class="modal" id="sixModal">
                                        <div class="modal-dialog">
                                          <div class="modal-content date-modal">
                                            <div class="modal-body p-0">
                                              <div class="head">
                                                  <h1 class="text-center">Create a single payment offer</h1>
                                              </div>
                                              <div class="model-heading bg-white p-3 freelancing">
    ...
    var service = $(this).val();
     ...
     $.ajaxSetup({
            ...
            $.ajax({
                ...
                data:{ service:service, _token: '{{csrf_token()}}'},
                dataType: 'json',
                success: function (response) {
            ...
            if (gigs[i].duration) {
                var durationParts = gigs[i].duration.split(':');
              ...
              if (gigs[i].rate) {
                  ...
                  rate = gigs[i].rate.split('|*|');
                rate = rate[0] ;
              }else{ console.log(gigs[i].group_type.toLowerCase());
              
               let type = gigs[i].group_type === 'Both' ? 'public_rate' : gigs[i].group_type.toLowerCase() + '_rate';
                rate = gigs[i][type]; // dynamic access using the key stored in `type`

              }
    
                     
                         
                         var html = ` <div class="row service"  onClick="SelectService(this.id)" id="service_select_${gigs[i].id}" data-gig_id="${gigs[i].id}" data-values="${gigs[i]}" data-bs-dismiss="modal">
                                                             <div class="col-md-6">
                                                              <h2>${gigs[i].title}</h2>`;
                                                              if (totalMinutes) {
                                                             html +=   `<a >Duration: ${totalMinutes} Mins</a>`;
                                                                  
                                                                }
                                                       html +=   ` </div>
                                                            <div class="col-md-6">
                                                                <a >Start From $${rate} per Person</a>
                                                            </di>
                                                        </div>
                                                        </div>`;
...
// Select Service 
function SelectService(Clicked) { 
  console.log(Clicked);
