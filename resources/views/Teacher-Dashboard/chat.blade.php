        ...
        <div class="row dash-notification">
                                ...
                                <div class="card chat-box-right">
                                    ...
                                    <div class="card-footer" id="sms_div"
                                        ...
                                        <div class="input-group emoji-picker-container">
                                            ...
                                            <textarea type="text" class="form-control" id="message-textarea" data-emojiable="true"
                                                    ...
                                                    <span class="label">
                                                        ...
                                                        <div class="input-group-append icon2">
                                                            ...
                                                            <button type="button" class="custom-btn"
                                                                data-bs-target="#myModal" data-bs-toggle="modal">custom
                                                                offer</button>
            ...
            <div class="content" id="tabsMainDiv">
                <div class="media">
                    ...
                    <div class="mainBtn">
                        <button class="tablink active" id="htab1" onclick="openTab(this.id)" data-tab="tab1">Photos
                        </button>
        ...
        <div class="modal-dialog modal-dialog-centered mt-5">
            <div class="modal-content mt-2">
                ...
                <div class="model_popup">
                    ...
                    <textarea class="form-control" list="datalistOptions" id="car" placeholder="write something here....."></textarea>
