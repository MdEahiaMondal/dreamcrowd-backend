                ...
                <div class="dash">
                    ...
                    @if($chatList->count() > 0)
                        ...
                        <span class="label">
                         ...
                         <a><input type="file" id="fileInputImages" accept="image/*" style="display: none;"><i
                                 class="fa-regular fa-images"
                                 onclick="document.getElementById('fileInputImages').click();"></i></a>
                            <a><input type="file" id="fileInputVideos" accept="video/*" style="display: none;"><i
                                    class="fa-solid fa-video"
                                    onclick="document.getElementById('fileInputVideos').click();"></i></a>
                                    <button type="button" class="custom-btn" data-bs-target="#myModal"
                                             ...
                                             <div class="model-heading">
                                              ...
                                              <div class="d-flex option-btn">
                                                  <div class="d-flex radio-toolbar">
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                              <input type="radio" id="offerTypeClass" name="offer_type"
                                                                     value="Class" checked data-bs-toggle="modal"
                                                      ...
                                                      <label for="offerTypeClass">
                                                          ...
                                                          <div class="col-md-6">
                                                              <input type="radio" id="offerTypeFreelance"
                                                                     name="offer_type" value="Freelance"
                                      ...
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <i class="fa-solid fa-arrow-left" data-bs-target="#myModal"
                                                        ...
                                                        <div class="model-heading">
                                                            ...
                                                            <div class="d-flex option-btn">
                                                                <div class="d-flex radio-toolbar">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <input type="radio" id="serviceModeOnline"
                                                                                   name="service_mode" value="Online"
                                                                                   checked data-bs-toggle="modal"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="radio" id="serviceModeInPerson"
                                                                                   name="service_mode" value="In-person"
                                                            ...
                                                            <div class="model-footer">
                                                                <button class="back-btn" data-bs-target="#secondModal"
                                                 ...
                                                 <div class="model-heading">
                                                  ...
                                                  <div class="d-flex option-btn">
                                                      <div class="d-flex radio-toolbar">
                                                            <div class="row">
                                                              <div class="col-md-6">
                                                                <input type="radio" id="paymentTypeSingle"
                                                                       name="payment_type" value="Single" checked>
                                                                <label for="paymentTypeSingle"
                                                                       data-bs-target="#sixModal" data-bs-toggle="modal"
                                                                       data-bs-dismiss="modal">
                                                              ...
                                                              <div class="col-md-6">
                                                                  <input type="radio" id="paymentTypeMilestone"
                                                                         name="payment_type" value="Milestone">
                                                                  <label for="paymentTypeMilestone"
                                                  ...
                                                  <div class="model-footer">
                                                      <button class="back-btn" data-bs-target="#servicemode-modal"
                                                              data-bs-toggle="modal"
                                              ...
                                              <div class="modal-body p-0">
                                                ...
                                                <div class="model-heading bg-white p-3 freelancing">
                                                 ...
                                                 <p class="offer-title"><span
                                                         class="selected-service-title">Loading...</span></p>
                                                 <textarea class="form-control offer-area" id="offer-description"
                                                           name="offer"
                                                           placeholder="Describe your offer...."></textarea>
                                                 <p class="offer-title mt-3">Set up your milestones or <a href="#"
                                                                                                          data-bs-target="#sixModal"
                                                                                                          data-bs-toggle="modal"
                                                                                                          data-bs-dismiss="modal">switch to single payment</a></p>
                                                 <p class="offer-title">Divide your work into pre-defined steps with goals (minimum $10 for each milestone).</p>
                                                  ...
                                                  <div class="rado mt-3">
                                                    ...
                                                    <div class="model-footer mt-4">
                                                      <button class="bacck-btn" data-bs-target="#fourmodal"
                                                              data-bs-toggle="modal"
                                                              data-bs-dismiss="modal">Back</button>
                                              ...
                                              <div class="modal-content date-modal">
                                                <div class="modal-body p-0">
                                                  ...
                                                  <div class="model-heading bg-white p-3 freelancing">
                                                   ...
                                                   <textarea class="form-control offer-area" id="offer-description"
                                                             placeholder="Describe your offer...."></textarea>
                                                   <p class="offer-title mt-3">Single payment or <a href="#"
                                                                                                    data-bs-target="#fiveModal"
                                                                                                    data-bs-toggle="modal"
                                                                                                    data-bs-dismiss="modal">switch to milestones</a></p>
                                                      ...
                                                      <div class="col-md-4 rectangle-desc">
                                                        <div class="rectangle">
                                                         ...
                                                         <input type="number" class="form-control"
                                                                id="single-payment-price" placeholder="Enter price"
                                                    ...
                                                    <div class="row mt-4">
                                                      <div class="col-md-12">
                                                        <h4>Total Amount: <span
                                                                class="total-amount-display text-primary">$0.00</span></h4>
                                                      </div>
                                                    </div>
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                          <div class="rectangle-desc desc-1">
                                                                ...
                                                                <select class="form-select" id="expire-days-select"
                                                                        disabled>
                                                                  <option value="1">1 day</option>
                                                                  <option value="2">2 days</option>
                                                                  <option value="3">3 days</option>
                            ...
                            {{-- Custom Offers Creation Models END ============ --}}
                                    ...
                                    <div class="card-footer" id="block_div"
                                        ...
                                        <h5 class="Safety-term text-center">You can no longer send a message to this
                                            user</h5>
                                    </div>
                                            ...
                                            <div class="link">
                                                <a onclick="BlockUser();"
                                                   style="text-decoration: none; cursor: pointer;">
                                                    ...
                                                    <p id="block_user">@if ($block != 0 && Auth::id() == $block_by)
                                                            Unblock
                                                        @else
                                                            Block
                                                        @endif</p>
                                                                ...
                                                                <div class="d-grid gap-2">
                                                                    <a>
                                                                        <button class="btn btn-primary active"
                                                                                type="button" id="mediaFileBtn"><img
                                                                                src="assets/user/asset/img/carbon_media-library-filled.svg">Media
                                                                        </button>
                                                                    </a>
                                                                </div>
                                                                <div class="d-grid gap-2">
                                                                    <a>
                                                                        <button class="btn btn-primary select1"
                                                                                type="button" id="FileMediaBtn"><img
                                                                                src="assets/user/asset/img/ph_files-fill.svg">Files
                                                                        </button>
                                                                    </a></div>
                                                            </div>
                                                    ...
                                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <button type="button" class="btn btn-primary"
                                                                    ...
                                                                    data-bs-toggle="modal" id="accordian-select"><img
                                                                    src="assets/user/asset/img/ic_round-report.svg">Report
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
...
// Loop through each file and generate the appropriate anchor tag
                    fileArray.forEach(file => {
                        const filePath = `/assets/chat_media/$${response['chat'].receiver_id}_chat_files_${user_id}/${file}`;
                        const fileName = file.split('/').pop(); // Extract the base name of the file
