        ...
        function renderNotifications(notifications) {
            ...
            notifications.forEach(function(notification) {
                ...
                if (notification.order_id && notification.order && notification.order.order_number) {
                    viewOrderBtn = `<a href="/teacher/order-details/${notification.order_id}" class="btn btn-sm" style="background-color: #007bff; color: white; margin-top: 8px; padding: 5px 15px; border-radius: 4px; text-decoration: none; display: inline-block;"><i class="bx bx-show"></i> View Order Details</a>`;
                }
