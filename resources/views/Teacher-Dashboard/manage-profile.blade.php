     ...
     {{-- ===========Teacher NavBar End==================== --}}
      ...
      <div class="container-fluid main-section">
            ...
            <div class="row profile-form">
              ...
              <div class="col-6" >
                <label for="inputAddress2" class="form-label prof-lang"
                  >Show Full Name</label
                >
                <div class="form-check form-switch  col-md-12">
                  <input class="form-check-input form-control" type="checkbox" value="{{$profile->show_full_name}}" role="switch"  id="show_full_name" @if ($profile->show_full_name == 1)  checked @endif  >
              ...
              <div class="col-6">
                ...
                >
                <option selected  value="{{$profile->primary_language}}">{{$profile->primary_language}}</option>
              ...
              <div class="col-6" >
                ...
                >
                <div class="form-check form-switch  col-md-12">
                  <input class="form-check-input form-control" type="checkbox" value="{{$profile->speak_other_language}}" role="switch"  id="speak_other_language" @if ($profile->speak_other_language == 1)  checked @endif  >
                  <input type="hidden" name="speak_other_language" id="speak_other_lang" value="{{$profile->speak_other_language}}"> 
                </div>
              </div>


              <div class="col-6" id="other_language_main_div" @if ($profile->speak_other_language == 0)  style="display:none;" @endif >
               <label class="form-label prof-lang"  > 
                ...
                <div class="dropdown">
                  ...
                  <input type="hidden" name="other_language" id="other_lang" required value="{{$profile->fluent_other_language}}">
                  ...
                  <div class="input-file-wrapper transition-linear-3 position-relative">
                    ...
                    >
                      <span v-show="preview===null">
                        <svg  style="position: relative; top: 15px"  xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60"  fill="none" >
                        <path
              ...
              <div class="col-md-12 form-sec personal-info">
                ...
                <div class="col-md-4 identity" id="upload-image4" style="margin-bottom: 10px;">
                  <div class="input-file-wrapper transition-linear-3 position-relative">
                    ...
                    <label
                      class="input-style input-label lh-1-7 p-4 text-center cursor-pointer"
                      for="post-thumbnail4" style="background: #f4fbff;border-radius: 4px;cursor: pointer; width: 100%;"
                    >
                      <span v-show="preview===null">
                        <svg  style="position: relative; top: 15px"  xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60"  fill="none" >
                        <path
                ...
                <div class="col-md-4 identity" id="upload-image5" style="margin-bottom: 10px;">
                  <div class="input-file-wrapper transition-linear-3 position-relative">
                    ...
                    <label
                      class="input-style input-label lh-1-7 p-4 text-center cursor-pointer"
                      for="post-thumbnail5" style="background: #f4fbff;border-radius: 4px;cursor: pointer; width: 100%;"
                    >
                      <span v-show="preview===null">
                        <svg  style="position: relative; top: 15px"  xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60"  fill="none" >
                        <path
                ...
                <div class="col-md-4 identity" id="upload-image6" style="margin-bottom: 10px;">
                  <div class="input-file-wrapper transition-linear-3 position-relative">
                    ...
                    <label
                      class="input-style input-label lh-1-7 p-4 text-center cursor-pointer"
                      for="post-thumbnail6" style="background: #f4fbff;border-radius: 4px;cursor: pointer; width: 100%;"
                    >
                      <span v-show="preview===null">
                        <svg  style="position: relative; top: 15px"  xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60"  fill="none" >
                        <path
                ...
                >
                  ...
                  <div class="col-md-12 identity" id="upload-image7" style="margin-bottom: 10px;">
                    <div class="input-file-wrapper transition-linear-3 position-relative">
                      ...
                      <label
                        class="input-style input-label lh-1-7 p-4 text-center cursor-pointer"
                        for="post-thumbnail7" style="background: #f4fbff;border-radius: 4px;cursor: pointer; width: 100%;"
                      >
                        <span v-show="preview===null">
                          <svg  style="position: relative; top: 15px"  xmlns="http://www.w3.org/2000/svg" width="61" height="60" viewBox="0 0 61 60"  fill="none" >
                          <path
              ...
              <div class="col-12 profile-form">
                ...
                <select class="form-select" name="first_service"  aria-label="Default select example">
                  <option selected value="{{$profile->first_service}}">{{$profile->first_service}}</option>
          ...
          <div class="col-md-12 profile-section">
            <div class="row profile-form">
              <div class="col-md-12">
                ...
                />
                <input type="hidden" name="ip_address" id="ip_address" readonly value="{{$profile->ip_address}}">
                <input type="hidden" name="country_code" id="country_code" readonly value="{{$profile->country_code}}">
                <input type="hidden" name="latitude" id="latitude" readonly value="{{$profile->latitude}}">
                <input type="hidden" name="longitude" id="longitude" readonly value="{{$profile->longitude}}">
              </div>
              <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-12 manage-profile-faq-sec">
            ...
            <a href="/teacher-add-faq"
              ><button class="btn float-end add-faq-btn">Add New FAQ</button></a
            >
          </div>
        </div>
            ...
            <div class="accordion">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="accordion-item">
                    <a href="/teacher-edit-faq/{{$item->id}}">
                      <div class="accordion-item-head">{{$item->question}}</div></a
                    >
                ...
                <div class="col-md-6">
                  <div class="accordion-item">
                    <a  >
                      <div class="accordion-item-head">Not Added Any Faqs Yet!</div></a
                    >
                    <div class="accordion-item-body">
                      <div class="accordion-item-body-content"></div>
                    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 faq-sec">
            ...
            <div class="input-group mb-3 category main_class_1">
              ...
              onclick="RejectCategory(this.id)" id="reject_class_category_1" data-category="{{$profile->category_class}}"  data-type="Class" 
            >Remove</button>
              <button
                class="btn view-button"
                type="button"
                 
                 onclick="ViewClassSub(this.id)" id="class_view_1" data-cate="{{$profile->category_class}}"  data-cates_type="{{$cates->service_type}}"
              >View</button>
            </div>
        <div class="col-md-12 sub_cate mt-2" id="class_sub_cate_1"></div>
          ...
          <div class="input-group mb-3 category main_class_{{$i}}">
            ...
            class="btn view-button btn btn-outline-secondary remove-button"
            type="button" style="display: none"
            onclick="RejectCategory(this.id)" id="reject_class_category_{{$i}}" data-category="{{$item}}"  data-type="Class" 
          >Remove</button>
            <button
              class="btn view-button"
              type="button"
               
               onclick="ViewClassSub(this.id)" id="class_view_{{$i}}" data-cate="{{$item}}"  data-cates_type="{{$cates->service_type}}"
            >View</button>
          </div>
      ...
      <div class="col-md-12 sub_cate mt-2 mb-2" id="class_sub_cate_{{$i}}"></div>
          ...
          <div class="col-md-12 faq-sec">
            ...
            class="btn view-button btn btn-outline-secondary remove-button"
            type="button" style="display: none"
            onclick="RejectCategory(this.id)" id="reject_freelance_category_1" data-category="{{$profile->category_freelance}}"  data-type="Freelance"
          >Remove</button>
              <button
                class="btn view-button"
                type="button"
                 
                 onclick="ViewFreelanceSub(this.id)" id="freelance_view_1" data-cate="{{$profile->category_class}}"  data-cates_type="{{$cates->service_type}}"
              >View</button>
            </div>
        <div class="col-md-12 sub_cate mt-2" id="freelance_sub_cate_1"></div>
          ...
          <div class="input-group mb-3 category main_freelance_{{$i}}">
            ...
            class="btn view-button btn btn-outline-secondary remove-button"
            type="button" style="display: none" 
            onclick="RejectCategory(this.id)" id="reject_freelance_category_{{$i}}" data-category="{{$item}}"  data-type="Freelance"
          >Remove</button>
            <button
              class="btn view-button"
              type="button"
               
               onclick="ViewFreelanceSub(this.id)" id="freelance_view_{{$i}}" data-cate="{{$item}}"  data-cates_type="{{$cates->service_type}}"
            >View</button>
          </div>
