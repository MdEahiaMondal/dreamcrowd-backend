                ...
                <div class=" col-md-12 ">
                    <div class=" row mainSelect ">
                        <div class=" col-md-6 col-sm-12 ">
                            ...
                            <h3 class=" Select-Heading mt-2 ">Class category </h3>
                            <div class=" select-box ">
                                <select name=" sample " id=" sample " class=" fa ">
                                            <option value=" ">----</option>
                                            <option value=" fa fa-address-card " class=" fa "> address card</option>
            ...
            <div class=" row ">
                <div class=" col-md-12 ">
                    <div class=" mainSelect ">
                        ...
                        <textarea id=" textArea-class " name=" w3review " rows=" 4 " cols=" 50 ">Discription 
            </textarea>
                        <h3 class=" Select-Heading ">Requirements</h3>
                        <textarea id=" textArea-class " name=" w3review " rows=" 4 " cols=" 50 ">What should guest bring
            </textarea>
                ...
                <div class="col-md-12">
                    <div class="Teacher-next-back-Section">
                        ...
                        <a href="Learn-How.html" class="teacher-back-btn">Back</a>


                        <a href="payment-1.html" class="teacher-next-btn">Next</a>
