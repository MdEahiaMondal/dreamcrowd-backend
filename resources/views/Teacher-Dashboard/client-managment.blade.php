                        ...
                        <nav>
                          <ul class="tabs">
                            ...
                            <li class="tab-li icon-badges">
                              <a href="#tab1" class="tab-li__link">Buyer Request<span class="icon-button__badge">{{$pendingOrders->count()}}</span></a>
                            </li>
                            
                            <li class="tab-li icon-badges">
                              <a href="#tab7" class="tab-li__link">Priority Orders<span class="icon-button__badge">{{$priorityOrders->count()}}</span></a>
                            </li>
                            <li class="tab-li icon-badges">
                                        ...
                                        <tr>
                                            ...
                                            <div class="profile-sec">
                                             ...
                                             <img src="assets/profile/avatars/({{$firstLetter}}).jpg" class="card-img-top-profile"> 
                                               @else
                                                ...
                                                <img src="assets/profile/img/{{$order->profile}}" class="card-img-top-profile"> 
                                                @endif
                                          ...
                                          <td>
                                            <div class="service-title">
                                                <p type="button" id="show_detail_model_{{$order->order_id}}" onclick="ShowDetailsModel(this.id)" data-values="{{ json_encode($order) }}" class="btn seller-desc" data-bs-toggle="modal" data-bs-target="#sell-service-modal" data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}"   data-user_id="{{$order->id}}"
                                          ...
                                          <td>
                                            <div class="action-sec">
                                              <button class="btn action-btn" onclick="ActionModelShow(this.id)"  data-values="{{ json_encode($order) }}"  data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}"   data-user_id="{{$order->id}}"
                                                data-order_id="{{$order->order_id}}"  data-reschedule="{{$order->user_reschedule}}" data-freelance_service="{{$order->freelance_service}}"  data-status="{{$order->status}}"  data-service_role="{{$order->service_role}}" data-start_date="{{$order->start_date}}" data-end_date="{{$order->end_date}}"
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="action-sec">
                                              <button class="btn action-btn" onclick="ActionModelShow(this.id)"  data-values="{{ json_encode($order) }}"  data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}"   data-user_id="{{$order->id}}"
                                                data-order_id="{{$order->order_id}}"  data-current_class="{{ json_encode($order->current_class) }}" data-reschedule="{{$order->user_reschedule}}" data-freelance_service="{{$order->freelance_service}}"  data-status="{{$order->status}}"  data-service_role="{{$order->service_role}}" data-start_date="{{$order->start_date}}" data-end_date="{{$order->end_date}}"
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                           ...
                                           <td>
                                            <div class="service-badges">
                                                <h3 class="mb-0"><span class="badge service-badge">
                                                   @if($order->refund == 1) Refunded @elseif ( $order->user_dispute == 1 ||$order->teacher_dispute == 1)   Disputed  @else  Cancelled  @endif
                                                  </span></h3>
                                            </div>
                                          </td>
                                          <td>
                                            <div class="action-sec">
                                              <button class="btn action-btn" onclick="ActionModelShow(this.id)"  data-values="{{ json_encode($order) }}"  data-name="{{ $order->first_name }} {{$order->last_name}}" data-title="{{$order->title}}"   data-user_id="{{$order->id}}"
                                                data-order_id="{{$order->order_id}}"  data-dispute="{{$order->teacher_dispute}}" data-reschedule="{{$order->user_reschedule}}" data-freelance_service="{{$order->freelance_service}}"  data-status="{{$order->status}}"  data-service_role="{{$order->service_role}}" data-start_date="{{$order->start_date}}" data-end_date="{{$order->end_date}}"
                                                data-price="{{$order->finel_price}}" data-new_all_classes="{{ json_encode($order->new_all_classes) }}" data-all_classes="{{$order->all_classes}}" data-payment_type="{{$order->payment_type}}" data-freelance_service="{{$order->freelance_service}}" data-lesson_type="{{$order->lesson_type}}" data-service_type="{{$order->service_type}}"  data-updated_at="{{$order->updated_at}}" data-teacher_reschedule="{{$order->teacher_reschedule}}" data-description="{{$order->description}}"     id="class-reshedule_{{$order->order_id}}" >...</button>
                                            </div>
                                          </td>
                                        </tr>
        ...
        <div class="modal-content service-modal">
          <div class="modal-body p-0">
            <form class="row">
              ...
              <button type="button" id="detail_service_reject" data-bs-dismiss="modal" aria-label="Close" id="" class="btn booking-cancel reject_view view_model_btns mt-1 btn-outline-danger">Reject</button>
            ...
            <h5 class="text-center mb-0">What would you like to do?</h5>
              <div class="row">
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel">
                  <button type="button" class="btn cancel-btn"  id="cancel-btn" data-refund="0" onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_class">
                  <button type="button" class="btn cancel-class-btn"  id="cancel-class-btn" data-refund="0" onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_refund_class">
                  <button type="button" class="btn cancel-refund-class-btn"  id="cancel-refund-class-btn" data-refund="1" onclick="CancelModelShow(this.id);"> Cancel and Refund Order</button> 
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_session">
                  <button type="button" class="btn cancel-session-btn"  id="cancel-session-btn" data-refund="0" onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>
                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_refund_session">
                  <button type="button" class="btn cancel-refund-session-btn"  id="cancel-refund-session-btn" data-refund="1" onclick="CancelModelShow(this.id);"> Cancel & Refund Order</button> 
                </div>
              ...
              <div id="active_normal_main" class="actions_main">
                  ...
                  <button class="btn   accept-reschedule" id="accept-reschedule-date">Accept Exted Date</button>
                </div>
                ...
                <div class="col-md-12 services-buttons all_actions_buttons"  id="extend">
                  <button type="button" class="btn extend-btn reschedule-btn"  id="extend-btn"> Extend Deadline</button> 
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_order">
                  <button type="button" class="btn cancel-order-btn"  id="cancel-order-btn" data-refund="0" onclick="CancelModelShow(this.id);"> Cancel Order</button> 
                </div>

                <div class="col-md-12 services-buttons all_actions_buttons"  id="cancel_refund_order">
                  <button type="button" class="btn cancel-refund-order-btn"  id="cancel-refund-order-btn" data-refund="1" onclick="CancelModelShow(this.id);"> Cancel & Refund Order</button> 
                </div>
                ...
                <div id="delivered_main" class="actions_main">
                  ...
                  <div class="col-md-12 services-buttons all_actions_buttons"  id="move_order">
                    <button type="button" class="btn move-order-btn"  id="move-order-btn"> Move back to active</button> 
                  </div>
                ...
                <div class="col-md-12   services-buttons all_actions_buttons dispute-main"  id="dispute-main1">
                  <button type="button" class="btn  accept-dispute-btn"   id="accept-dispute-btn" >Accept Refund</button>
                </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content add-review-rating-modal">
              ...
              <form action="/cancel-order" method="POST"> @csrf
                ...
                <textarea class="form-control add-review" name="reason" id="cancel_reason" placeholder="write rejection reason..." required ></textarea>
  ...
  <!-- Order Cancel  Modal END =========-->
   ...
   <!-- Cancel and Refund Modal ended here -->
            ...
            <div class="row">
              ...
              <div class="col-md-12 radio-tabs-sec">          
                  <div class="col-md-12 radio-tab-section active partial_am_main">
                    ...
                    <input type="radio" id="partial_refund" name="refund" class="radio-but" value="1" checked>
                ...
                <input type="number" class="form-control partial_am" name="refund_amount" id="refund_amount" placeholder="$1500" >
                  <h5 class="mb-0 refund">Refund Reason</h5>
                  <textarea class="form-control" name="reason" id="refund_reason" placeholder="write here reason of refund" required></textarea>
           ...
           <p class="mb-0">once you cancel the services, you <br> couldn’t retrive the action</p>
            ...
            <div class="row">
              ...
              <div class="col-md-12 radio-tabs-sec active">  
                 <div class="col-md-12 radio-tab-section full_am_main">
                  <input type="radio" id="dispute_no_refund" name="refund" class="radio-but" value="2" checked>
                  ...
                  <div class="col-md-12 radio-tab-section  partial_am_main">
                    ...
                    <input type="radio" id="dispute_partial_refund" name="refund" class="radio-but" value="1" >
                    <label for="partial_refund">Partial  Refund</label> 
                  </div>
    ...
    <!--  Dispute Order and Request Refund  Modal ended here -->
        ...
        <div class="modal fade" id="online-normal-deliver-model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content add-review-rating-modal">
              <div class="modal-body p-0">
                ...
                <input type="hidden" name="order_id" id="deliver_order_id">
                        ...
                        <div class=" select-groups  ">
                                <label for="file" class="form-label" style="  color: #0072b1;font-family: Outfit;   font-weight: 500; line-height: normal;" >Upload File</label >
                                
                                <input type="file" class="form-control " id="file" name="file"   placeholder="Upload File" accept=".pdf,.doc,.docx,.zip" required/>
                              </div>

                                   <div class=" select-groups mt-2  ">
                                <label for="message-deliver" class="form-label" style="  color: #0072b1;font-family: Outfit;   font-weight: 500; line-height: normal;" >Message</label >
                                
                               <textarea class="form-control add-review " name="message" id="message-deliver"  placeholder="type your message..." required ></textarea>
                              </div>

              
                <button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn booking-cancel  btn-outline-danger">Cancel</button>
                <button type="submit" class="btn float-end submit-review-btn" data-bs-dismiss="modal"   > Deliver Order</button>
            </form>
              </div>
            </div>
          </div>
