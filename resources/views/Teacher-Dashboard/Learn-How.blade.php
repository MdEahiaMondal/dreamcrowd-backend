                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="custom-radio-wrapper" style="margin-bottom: 15px;">
                                        <label class="custom-radio-label" style="display: flex; align-items: flex-start; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; cursor: pointer; transition: all 0.3s;">
                                            <input type="radio" name="approval_mode" value="manual" checked style="margin-top: 5px; margin-right: 12px; width: 18px; height: 18px;">
                                            <div>
                                ...
                                <div class="col-md-6">
                                    <div class="custom-radio-wrapper" style="margin-bottom: 15px;">
                                        <label class="custom-radio-label" style="display: flex; align-items: flex-start; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; cursor: pointer; transition: all 0.3s;">
                                            <input type="radio" name="approval_mode" value="instant" style="margin-top: 5px; margin-right: 12px; width: 18px; height: 18px;">
                                            <div>
