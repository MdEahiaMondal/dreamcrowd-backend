              ...
              <section id="hero_section">
                <div class="container-fluid">
                    <div class="row card-radio">
                      <div class="col-md-12">
                <div class="content">
                <h2>What Service would you like to create</h2>
                ...
                <div class="content-box">
                  <div class="radio-inputs">
                    <label>
                     ...
                     <input class="radio-input" type="radio" value="Class" name="engine">
                    
                     {{-- <a href="Class-RADIO-1.html"> --}}
                       <span class="radio-tile">
                          <span class="radio-icon">
                            <img src="assets/teacher/asset/img/phig.png" alt="....">
                          </span>
                          <span class="radio-label">Class Service</span>
                        </span>
                        {{-- </a> --}}
                    </label>
                    <label>
                      <input checked="" class="radio-input" type="radio" value="Freelance" name="engine">
                     {{-- <a href="Learn-How -5.html"> --}}
                      <span class="radio-tile">
                        <span class="radio-icon">
                          <img src="assets/teacher/asset/img/phig2.png" alt="..">                
                        </span>
                        <span class="radio-label">Freelance Service</span>
                      </span>
                    {{-- </a> --}}
                    </label>
                    </div>
                </div>
                <button type="submit" name="action" value="Role" class="btn">Next</button>
              </form>
              </div>
                      </div>
                    </div>
