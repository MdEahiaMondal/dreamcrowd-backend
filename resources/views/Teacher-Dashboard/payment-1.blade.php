...
$(document).ready(function () {
  ...
  // Wrap all the logic inside the DOMContentLoaded event
  document.addEventListener('DOMContentLoaded', function() {
    const startDateInput = document.getElementById('start_date');
    const endDateInput = document.getElementById('end_date');

    // Disable End Date initially until Start Date is selected
    // endDateInput.disabled = true;
 

    // Prevent End Date selection if Start Date is not selected
    endDateInput.addEventListener('focus', function() {
      if (!startDateInput.value) {
        alert("Please select the Start Date first.");
        // Set focus back to the Start Date input
        startDateInput.focus();
      }
    });

    // Optional: Check that End Date is not earlier than Start Date on change
    endDateInput.addEventListener('change', function() {
      ...
      if (endDate < startDate) {
        ...
        this.value = ''; // Reset the end date field if the condition is violated
      }
    });
  });
