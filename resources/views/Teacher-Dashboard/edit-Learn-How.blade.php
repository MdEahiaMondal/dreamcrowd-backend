                ...
                <div class=" col-md-12 ">
                    <div class=" row mainSelect ">
                        <div class=" col-md-6 col-sm-12 ">
                            ...
                            <div class=" select-box ">
                                ...
                                <select name="category" id="category" class="fa">
                                    <option value="{{$gigData->category}}"
                                            class="fa">{{$selectedCate->category}}</option>
                                    @if ($categories)
                                        @php $i = 0; @endphp
                        ...
                        <div class=" col-md-6 col-sm-12 ">
                            ...
                            <input type="hidden" value="{{$gigData->sub_category}}" name="sub_category"
                                   id="sub_category">
                                                ...
                                                <li class="multi-text-li">
                                                    <label>
                                                        <input type="checkbox" name="subcategories[]"
                                                               class="subcat1-input freelancesub" value="{{ $value }}"
                        ...
                        @if ($gig->service_type == 'Inperson')
                                ...
                                <div class=" select-box ">
                                    <select name="service_delivery" id="service_delivery" class="fa">
                                        @if ($gigData->service_delivery == 0)
                                            <option value="0" class="fa" selected>I will visit clients sites to offer
                                                this service
                                            </option>
                                        ...
                                        @elseif ($gigData->service_delivery == 1)
                                            <option value="0" class="fa">I will visit clients sites to offer this
                                                service
                                            </option>
                                            <option value="1" class="fa" selected>This service would be offered at my
                                                work site
                                            </option>
                                            <option value="2" class="fa">Both Delivery Options</option>
                                        @else
                            ...
                            <div class=" col-md-6 col-sm-12 " id="max_distance_main"
                                 @if ($gigData->max_distance == null) style="display: none" @endif>
                                ...
                                <div class=" select-box ">
                                    <select name="max_distance" id="max_distance" class="fa   ">
                                        <option value="{{$gigData->max_distance}}" class="fa"
                                                selected>{{$max_distance}}</option>
                            ...
                            <div class="col-md-6 col-sm-12" id="work_site_main"
                                 @if ($gigData->work_site == null) style="display: none" @endif>
                                <h3 class="Select-Heading mt-2">
                                    Work Site Location
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                         fill="none">
                            ...
                            <div class="col-md-6 col-sm-12 " id="group_type_main"
                                 @if ($gigData->lesson_type != 'Group') style="display: none" @endif >
                                <h3 class=" Select-Heading mt-2 ">Group Type</h3>
                                <div class=" select-box ">
                                    <select name="group_type" id="group_type" class="fa">
                                        @if ($gigData->service_delivery == 0)
            ...
            <div class=" row ">
                <div class=" col-md-12 ">
                    <div class=" mainSelect ">
                        ...
                        <input class=" Class-Title " id="title" value="{{$gigData->title}}" name="title"
                               placeholder="Class Title " type=" text ">
                        <h3 class=" Select-Heading ">Description</h3>
                        <textarea id="description" name="description" rows=" 4 "
                                  cols=" 50 ">{{$gigData->description}}</textarea>
                        <h3 class=" Select-Heading ">Requirements</h3>
                        <textarea id="requirements" name="requirements" rows=" 4 "
                                  cols=" 50 ">{{$gigData->requirements}}</textarea>
