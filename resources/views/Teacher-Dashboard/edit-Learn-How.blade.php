  ...
  <section class="home-section">
     ...
     {{-- ===========Teacher NavBar End==================== --}}
        ...
        <div class=" container-fluid ">
            ...
            <form id="myForm" action="/class-gig-data-update" method="POST" enctype="multipart/form-data"> @csrf
            <div class=" row mx-1 ">
                <div class=" col-md-12 ">
                    <div class=" row mainSelect ">
                        <div class=" col-md-6 col-sm-12 ">
                            ...
                            <div class=" select-box ">
                              <input type="hidden" name="gig_id" id="gig_id" value="{{$gig->id}}">
                              <input type="hidden" name="role" id="role" value="{{$gig->service_role}}">
                              <input type="hidden" name="type" id="type" value="{{$gig->service_type}}">
                                <select name="category" id="category" class="fa">
                                  <option value="{{$gigData->category}}" class="fa">{{$selectedCate->category}}</option>
                                    @if ($categories)
                                    @php $i = 0; @endphp
                            ...
                            <div class=" col-md-6 col-sm-12 ">
                              @php $sub_cates = explode(',',$gigData->sub_category);  
                                 $array1 = $sub_categories; // Main array
                                 $array2 = $sub_cates; // Array with selected values
                                 $selectedValue = implode(', ', array_intersect($array1, $array2));
                                  @endphp
                              <h3 class=" Select-Heading ">Class sub-category </h3>
                                <input type="hidden" value="{{$gigData->sub_category}}" name="sub_category" id="sub_category">
                                <p class="text-danger" id="sub_freelance_error" style="display: none;"></p>
                                  ...
                                  > @if ($selectedValue) {{ $selectedValue }}  @else --select sub-category-- @endif </button>
                                  ...
                                  <div class="row" id="SubCategories">
                                    ...
                                    <div class="col-md-6 freelance_sub">
                                        <li class="multi-text-li">
                                            <label>
                                                <input type="checkbox" name="subcategories[]" class="subcat1-input freelancesub" value="{{ $value }}" 
                                                    {{ in_array($value, $array2) ? 'checked' : '' }}>
                                                {{ $value }}
                                            </label>
                                        </li>
                                    </div>
                          ...
                          <div class=" select-box ">
                              <select name="class_type" id="class_type" class=" fa ">
                                ...
                                @if ($gigData->class_type == 'Live')
                                <option value="Live" class=" fa " selected>Live</option>
                                <option value="Video" class=" fa ">Video Course</option> 
                                @else
                                <option value="Live" class=" fa ">Live</option>
                                <option value="Video" class=" fa " selected>Video Course</option>
                            ...
                            <div class=" col-md-6 col-sm-12 "  id="lesson_type_main_div" @if ($gigData->class_type == 'Video') style="display: none" @endif>
                              <h3 class=" Select-Heading mt-2 ">Class type lesson </h3>
                              <div class=" select-box ">
                                  <select name="lesson_type" id="lesson_type" class=" fa "> 
                                    @if ($gigData->lesson_type == 'One')
                                    <option value="One" class=" fa " selected>1-to-1 Lesson</option>
                                    <option value="Group" class=" fa ">Group Lesson</option> 
                                    @else
                                    <option value="One" class=" fa ">1-to-1 Lesson</option>
                                              <option value="Group" class=" fa " selected>Group Lesson</option> 
                        ...
                        @if ($gig->service_type == 'Online')
                        <div class="col-md-6 col-sm-12 " id="recurring_type_main" @if ($gigData->class_type == 'Video') style="display: none" @endif>
                        ...
                        <div class="col-md-6 col-sm-12 " id="group_type_main" @if ($gigData->group_type == null) style="display: none" @endif >
                          <h3 class=" Select-Heading mt-2 ">Group Type</h3>
                          <div class=" select-box ">  
                            <select name="group_type" id="group_type" class="fa">
                             
                              @if ($gigData->group_type == 'Public')
                              <option value="Public" class="fa" selected>Public Group</option>
                              <option value="Private" class="fa">Private Group</option>
                              <option value="Both" class="fa">Both</option>
                                 
                              @elseif ($gigData->group_type == 'Private')
                                  <option value="Public" class="fa" >Public Group</option>
                                  <option value="Private" class="fa" selected>Private Group</option>
                                  <option value="Both" class="fa">Both</option>
                              @else 
                                  <option value="Public" class="fa">Public Group</option>
                                  <option value="Private" class="fa">Private Group</option>
                                  <option value="Both" class="fa" selected>Both</option>
                                  @endif 
                      ...
                      <div class="col-md-6 col-sm-12 " id="service_delivery_main"  >
                        ...
                        <div class=" select-box ">
                          <select name="service_delivery" id="service_delivery" class="fa">
                            ...
                            <option value="0" class="fa" selected>I will visit clients sites to offer this service</option>
                            ...
                            <option value="2" class="fa">Both Delivery Options </option>
                              ...
                              <option value="1" class="fa" selected>This service would be offered at my work site  </option>
                              <option value="2" class="fa">Both Delivery Options </option>
                              @else 
                              <option value="0" class="fa">I will visit clients sites to offer this service</option>
                              <option value="1" class="fa">This service would be offered at my work site  </option>
                              <option value="2" class="fa" selected>Both Delivery Options </option>
                                  @endif 
                        ...
                        <div class=" col-md-6 col-sm-12 " id="max_distance_main"  @if ($gigData->max_distance == null) style="display: none" @endif>
                          ...
                          @php $max_distance = ($gigData->max_distance == 30) ? $gigData->max_distance.'+ Miles' : $gigData->max_distance.' Miles'; @endphp
                          {{-- <input class=" Class-Title " value="{{$gigData->max_distance}}" id="max_distance" name="max_distance" placeholder="10 Miles" type="number"> --}}
                          <div class=" select-box ">
                            <select name="max_distance" id="max_distance" class="fa   ">
                              <option value="{{$gigData->max_distance}}" class="fa" selected>{{$max_distance}}</option>
                         ...
                         <div class="col-md-6 col-sm-12" id="work_site_main" @if ($gigData->work_site == null) style="display: none" @endif>
                          ...
                          <div style="position: relative;">
                              <input
                                  class="Class-Title"
                                  id="work_site"
                                  name="work_site" value="{{$gigData->work_site}}" 
                        ...
                        <div class="col-md-6 col-sm-12 " id="group_type_main" @if ($gigData->lesson_type != 'Group') style="display: none" @endif >
                          <h3 class=" Select-Heading mt-2 ">Group Type</h3>
                          <div class=" select-box ">
                            <select name="group_type" id="group_type" class="fa">
                              @if ($gigData->service_delivery == 0)
                      ...
                      @endif
                             ...
                             <div class="col-md-12 col-sm-12 " id="experience_level_main"  >
                        <h3 class=" Select-Heading mt-2 ">Experience Level </h3>
                        <div class=" select-box ">
                          <select name="experience_level" id="experience_level" class="fa">
                            @if ($gigData->experience_level == 'Beginner') 
                            <option value="Beginner" selected class="fa">Beginner Level</option>
                            ...
                            @elseif ($gigData->experience_level == 'Intermediate') 
                                    <option value="Beginner"  class="fa">Beginner Level</option>
                            <option value="Intermediate" selected class="fa">Intermediate Level </option>
                            <option value="Expert" class="fa">Expert Level </option>
                            <option value="All" class="fa">All Levels </option>
                            @elseif ($gigData->experience_level == 'Expert') 
                                    <option value="Beginner"  class="fa">Beginner Level</option>
                            <option value="Intermediate"  class="fa">Intermediate Level </option>
                            <option value="Expert" selected class="fa">Expert Level </option>
                            <option value="All" class="fa">All Levels </option>
                            @else
                                  <option value="Beginner"  class="fa">Beginner Level</option>
                            <option value="Intermediate"  class="fa">Intermediate Level </option>
                            <option value="Expert"  class="fa">Expert Level </option>
                            <option value="All" selected class="fa">All Levels </option>
                            @endif
            ...
            <div class=" row ">
                <div class=" col-md-12 ">
                    <div class=" mainSelect ">
                        ...
                        <input class=" Class-Title " id="title" value="{{$gigData->title}}" name="title" placeholder="Class Title " type=" text ">
                        <h3 class=" Select-Heading ">Description</h3>
                        <textarea   id="description" name="description" rows=" 4 " cols=" 50 ">{{$gigData->description}}</textarea>
                        <h3 class=" Select-Heading ">Requirements</h3>
                        <textarea   id="requirements" name="requirements" rows=" 4 " cols=" 50 ">{{$gigData->requirements}}</textarea>
                            ...
                            <div class="col-md-12 identity" id="upload-image1" style="margin-bottom: 10px;">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    ...
                                    accept="image/*,video/*" value="{{$gigData->main_file}}"
                                    @change="previewImage('post-thumbnail1')"
                                    class="input-file"
                                    id="post-thumbnail1"
                                  />
                                  <input type="hidden" id="main_file_hide" value="{{$gigData->main_file}}">
                                </div>
                              </div>
...
function SubmitForm() {
   ...
   const main_file = document.getElementById('main_file_hide').value ;
...
var video = '<?php echo $gigData->video ?>';

if (video != '') {
  var video_data = `assets/teacher/listing/data_${userId}/media/${video}`;
} else {
  var video_data = null;
...
var main_file = '<?php echo $gigData->main_file ?>';
   if (main_file != '') {
  var main_file_data = `assets/teacher/listing/data_${userId}/media/${main_file}`;
} else {
  var main_file_data = null;
 ...
 new Vue({
  ...
  data() {
    return {
      preview: main_file_data, // Preview for existing file
      media: null, // File object for uploaded media
      isImage: main_file ? main_file.endsWith('.jpg') || main_file.endsWith('.png') : true, // Checks existing file type
  ...
  methods: {
    previewImage(id) {
      ...
      if (input.files && input.files[0]) {
        ...
        if (file.size > this.maxFileSize) {
          // Show error for exceeding size
          document.getElementById(id).value = "";
          this.preview = null;
          toastr.options = { "closeButton": true, "progressBar": true };
          toastr.error("File size exceeds the 10 MB limit!");
          return;
        }
        ...
        reader.onload = (e) => {
          ...
          document.getElementById('main_file_hide').value = file.name;
        };
        this.media = file;
    ...
    reset(id) {
      ...
      this.media = null;
      this.preview = null;
      this.isImage = true; // Reset to image
      document.getElementById(id).value = "";
      document.getElementById('main_file_hide').value = ""; // Clear hidden input value
    },
  },
});
 ...
 new Vue({
  ...
  data() {
    return {
      preview: video_data !== null ? video_data : null, // Initialize with the video path from the database
      media: null,
      isImage: false, // Set to false initially since we're dealing with videos
  ...
  methods: {
    ...
    reset: function (id) {
      ...
      this.media = null;
      this.preview = null;
      this.isImage = false; // Reset to default for video
      document.getElementById(id).value = "";
    },
  },
});
...
new Vue({
  ...
  data() {
    return {
      images: [], // Array to hold selected images or videos
  ...
  created() {
    // Fetching the database value and showing previews when the component is created
    this.loadPreviews();
  },
  methods: {
    loadPreviews() {
      var other = '<?php echo $gigData->other ?>'; // Fetch the database value from PHP
      if (other) {
        var userId = <?php echo Auth::user()->id ?>; // Get the user ID from PHP
        var other_img = other.split(',_,'); // Split the filenames by '_,_'
        other_img.forEach(filename => {
          let path = `assets/teacher/listing/data_${userId}/media/${filename}`;
          // Determine if it's an image or a video
          let fileType = filename.split('.').pop().toLowerCase();
          let type = (fileType === 'mp4' || fileType === 'webm' || fileType === 'ogg') ? 'video' : 'image';
        ...
        // Update the hidden input with the initial images
    ...
    previewImages: function (id) {
      ...
      if (selectedFiles.length > this.maxFiles || this.images.length + selectedFiles.length > this.maxFiles) {
        toastr.error("You can only select up to 5 files.");
        return;
      }
      ...
      for (let i = 0; i < selectedFiles.length; i++) {
        ...
        reader.onload = (e) => {
          ...
          // Add the file (image or video) to the images array
          this.images.push({
            src: e.target.result,
            name: file.name,
            type: fileType
    ...
    removeImage: function (index) {
      // Remove the image or video from the array
    ...
    updateImageInputValue: function () {
      // Concatenate the file names with `,_,` separator and set it in the hidden input
      this.imageInputValue = this.images.map(image => image.name).join(',_,');
    },
    
    reset: function (id) {
      // Clear images and reset the file input
      this.images = [];
...
new Vue({
  ...
  methods: {
    loadPreviews() {
  var course = '<?php echo $gigData->course ?>'; // Fetch the database value from PHP
  if (course) {
    var userId = '<?php echo Auth::user()->id ?>'; // Get the user ID from PHP
    var course_video = course.split(',_,'); // Split the filenames by '_,_'
    
    course_video.forEach(filename => {
      if (filename) {
        let file = `assets/teacher/listing/data_${userId}/course/${encodeURIComponent(filename)}`;
         
        this.videos.push({
          file: file, 
          type: 'video', 
          uploaded: true,  // Mark it as already uploaded
          serverName: filename // Store the filename as serverName
        });
      }
    });

    // Update the hidden input with the initial videos
...
new Vue({
  ...
  created() {
    // Load previously uploaded zip files from the database
    this.loadZips();
  },
  methods: {
    ...
    loadZips() {
      ...
      // Fetch the zip files from the database
      var resources = '<?php echo $gigData->resource ?>'; // Fetch the database value from PHP
      
      if (resources) {
        var userId = '<?php echo Auth::user()->id ?>'; // Get the user ID from PHP
        var zipFiles = resources.split(',_,'); // Split the filenames by '_,_'
       
        
        zipFiles.forEach(filename => {
          if (filename) {
            let file = `assets/teacher/listing/data_${userId}/recources/${encodeURIComponent(filename)}`;
        ...
        // Update the hidden input with the initial zip files
