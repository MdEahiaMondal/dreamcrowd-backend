            ...
            <div class="row payment-type mx-1 my-3">
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  ...
                  <input class="payment-input" value="{{$gigPayment->public_rate}}" name="public_rate" id="public_rate" placeholder="$50" type="number"  onfocusout="validateRatePrice(this)" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" value="{{$gigPayment->public_group_size}}" name="public_group_size" id="public_size" placeholder="max 100"  type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" value="{{$gigPayment->public_discount}}" name="public_discount" id="public_discount" placeholder="50%" type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                  ...
                  <input class="payment-input" value="{{$gigPayment->private_rate}}" name="private_rate" id="private_rate" placeholder="$50" type="number"  onfocusout="validateRatePrice(this)" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" value="{{$gigPayment->private_group_size}}" name="private_group_size" id="private_size" placeholder="max 100"  type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" value="{{$gigPayment->private_discount}}" name="private_discount" id="private_discount" placeholder="50%" type="number" />
                </div>
                <div class="col-md-3 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
            ...
            <div class="row payment-type mx-1 my-3">
              <div class="col-md-12">
                ...
                <div class="rAdio-Section">
                  ...
                  <input class="radio-btn" name="minor_attend" onclick="MinorAttend(this.id)" id="minor_attend_1" value="1" type="radio" checked />
                  <span class="Yes">Yes</span>
                  <input class="radio-btn" name="minor_attend"  onclick="MinorAttend(this.id)" id="minor_attend_0"  value="0" type="radio" />
                  <span class="Yes">No</span>
                  @else
                  <input class="radio-btn" name="minor_attend" onclick="MinorAttend(this.id)" id="minor_attend_1" value="1" type="radio"  />
                  <span class="Yes">Yes</span>
...
function SubmitForm() {
    ...
    if (serviceType === 'Online') {
        const classType = '<?php echo $gig->class_type ?>';
        if (classType === 'Video') {
            const duration = document.getElementById('duration').value;
            if (!validateField(duration, "Duration Required!")) return false;
        } else {
    ...
    if (!start_date)return showError("Start Time Required!");
    if (!start_time){
    ...
    var minor_attend = $("input[name='minor_attend']").val();
      if (minor_attend == 1) {
        var childs = parseInt($('#childs').val(), 10) || 0; // Ensure numeric value, minimum 0

if (groupType === 'Public' || groupType === 'Both') {
    var publicSize = parseInt(document.getElementById('public_size').value, 10) || 0;
}

if (groupType === 'Private' || groupType === 'Both') {
    var privateSize = parseInt(document.getElementById('private_size').value, 10) || 0;
}

// Get the smaller value between public_size and private_size
...
if (childs < 0 || childs > maxAllowed) {
  showError("Childs value must be between 0 and " + maxAllowed);
   $('#childs').val(0); // Optionally reset to max allowed
   return false;
}
      ...
      if (size > 100) {
        ...
        toastr.options =
          ...
          "extendedTimeOut": "4410000" // 10 seconds
                  ...
                  toastr.error("Maximmum 100 Group Size Allowed!");
                  return false ;
       }
       ...
       if (discount > 88) {
        ...
        toastr.options =
          ...
          "extendedTimeOut": "4410000" // 10 seconds
                  ...
                  toastr.error("Maximmum 88% Discount Allowed!");
                  return false ;
       }
