        ...
        <div class=" container-fluid ">
            <div class=" row dash-notification ">
                <div class=" col-md-12 ">
                    ...
                    <form action="/teacher-update-faq" method="POST"> @csrf
                        <div class="col-md-12 mb-3 add-category">
                            <a href="/teacher-faq-remove/{{$faq->id}}" class="btn btn-back float-end mb-2" onclick="BackTab(this.id)"   data-tab="7" id="tab_back_btn_7">
                                Remove
                              </a>
                            <label for="" class="label-sec pt-0">Question</label>
                            <input type="hidden" name="id" value="{{$faq->id}}">
                            <input type="text" class="form-control" name="question" value="{{$faq->question}}" placeholder="How can you deliver my project to me?" required>
                              <label for="" class="label-sec">Answer</label>
                              <textarea  name="answer" id="" class="form-control" rows="5" cols="5" placeholder="write the answer here....">{{$faq->answer}}</textarea>
