        ...
        <div class="row payment-page">
          ...
          <div class="col-md-12">
            <div class="row payment-type mx-1 my-3">
              ...
              $earning = explode('|*|',$gigPayment->earning);
              $revision = explode('|*|',$gigPayment->revision);
              $delivery_time = explode('|*|',$gigPayment->delivery_time);
                $rate_1 = isset($rate[0]) ? $rate[0] : '';
              $rate_2 = isset($rate[1]) ? $rate[1] : '';
              $earning_1 = isset($earning[0]) ? $earning[0] : '';
              $earning_2 = isset($earning[1]) ? $earning[1] : '';
              $revision_1 = isset($revision[0]) ? $revision[0] : '';
              $revision_2 = isset($revision[1]) ? $revision[1] : '';

              if ($gig->service_type == 'Inperson' && $gigData->freelance_service == 'Normal') {
                $duration = explode('|*|',$gigPayment->duration); 
              
                  $duration_1 = explode(':', $duration[0]);
                 $duration_1 = array_pad($duration_1, 2, '00');
                  // If there is a second part
                  if (isset($duration[1])) {
                      $duration_2 = explode(':', $duration[1]);
                      $duration_2 = array_pad($duration_2, 2, '00');
                  } else {
                      // No second part — set default
                      $duration_2 = ['00', '00'];
                  }
              } else {
                $delivery_time_1 = isset($delivery_time[0]) ? $delivery_time[0] : '';
              $delivery_time_2 = isset($delivery_time[1]) ? $delivery_time[1] : '';
              }
            ...
            @if ($gig->service_type == 'Inperson' && $gigData->freelance_service == 'Normal')
             ...
             <div class="col-md-6 col-sm-12">
              ...
              <select name="durationH" id="durationH" class="fa">
                    <option  value="{{$duration_1[0]}}" class="fa">{{$duration_1[0]}}</option>
                  ...
                  <select name="durationM" id="durationM" class="fa">
                    @if ($duration_1[1])
                    <option  value="{{$duration_1[1]}}" class="fa">{{$duration_1[1]}}</option>
                       @endif
                    <option  value="00" class="fa">00</option>
             ...
             <div class="col-md-6 col-sm-12">
                ...
                <div class="durationMain-section">
                    ...
                    <input
                      ...
                      placeholder="12" id="delivery_time"  value="{{$delivery_time_1}}" name="delivery_time" style="width: 70px;"
                      type="number"
                    />Days
                  </div>
            ...
            @endif
              ...
              <div class="col-md-6 col-sm-12" style="margin-top: 30px !important">
                  ...
                  <div class="select-box">
                    <select name="revision" id="revision" class="fa"> 
                      @if($revision_1)
                      <option value="{{$revision_1}}"  class="fa" selected>{{$revision_1}}</option>
                       @endif
              ...
              @if ($gig->service_type == 'Inperson' && $gigData->freelance_service == 'Normal')
                ...
                <div class="durationMain-section">
                    ...
                    <option  value="{{$duration_2[0]}}" class="fa">{{$duration_2[0]}}</option>
                    <option  value="00" class="fa">00</option>
                    @for ($i = 1; $i <= 10; $i++)
                    <option  value="{{$i}}" class="fa">{{$i}}</option>
                  ...
                  <select name="durationM_2" id="durationM_2" class="fa">
                    @if ($duration_2[1])
                    <option  value="{{$duration_2[1]}}" class="fa">{{$duration_2[1]}}</option>
                       @endif
                    <option  value="00" class="fa">00</option>
                    <option  value="30" class="fa">30</option>
              ...
              @else
                ...
                <div class="durationMain-section">
                  ...
                  <div class="Duration-time">
                    <input
                      class="Duration-input"
                      placeholder="12" id="delivery_time_2" value="{{$delivery_time_2}}" name="delivery_time_2" style="width: 70px;"
                      type="number"
                    />Days
                  </div>
                </div>
              ...
              <div class="col-md-6 col-sm-12" style="margin-top: 30px !important">
                  ...
                  <div class="select-box">
                    <select name="revision_2" id="revision_2" class="fa"> 
                      @if($revision_2)
                      <option value="{{$revision_2}}"  class="fa" selected>{{$revision_2}}</option>
                       @endif
                       <option value="N/A"  class="fa">N/A</option>
                      @for ($i = 1; $i <= 20; $i++)
                      <option value="{{$i}}"  class="fa">{{$i}}</option>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <input class="payment-input" value="{{$rate_1}}" name="rate" id="rate" placeholder="$50" type="number"  onfocusout="validateRatePrice(this)" />
                </div>
                <div class="col-md-6 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" value="{{$earning_1}}" name="earning" id="estimated_earning" placeholder="$50" readonly type="text" />
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <input class="payment-input"  value="{{$rate_2}}" name="rate_2" id="rate_2" placeholder="$50" type="number"  onfocusout="validateRatePrice(this)"/>
                </div>
                <div class="col-md-6 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input"  value="{{$earning_2}}" name="earning_2" id="estimated_earning_2" placeholder="$50" readonly type="text" />
                </div>
                <p
              ...
              @else
                ...
                <div class="durationMain-section">
                  ...
                  <div class="Duration-time">
                    <input
                      class="Duration-input"
                      placeholder="12" id="delivery_time" value="{{$gigPayment->delivery_time}}" name="delivery_time" style="width: 70px;"
                      type="number"
                    />Days
                  </div>
                </div>
              ...
              <div class="col-md-6 col-sm-12" style="margin-top: 30px !important">
                  ...
                  <div class="select-box">
                    <select name="revision" id="revision" class="fa"> 
                      <option value="{{$gigPayment->revision}}"  class="fa" selected>{{$gigPayment->revision}}</option>
                      <option value="N/A"  class="fa">N/A</option>
                      @for ($i = 1; $i <= 20; $i++)
                      <option value="{{$i}}"  class="fa">{{$i}}</option>
                      @endfor
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <input class="payment-input" value="{{$gigPayment->rate}}" name="rate" id="rate" placeholder="$50" type="number"  onfocusout="validateRatePrice(this)" />
                </div>
                <div class="col-md-6 col-sm-12">
                  <h3
                    class="online-Class-Select-Heading"
                  ...
                  <input class="payment-input" value="{{$gigPayment->earning}}" name="earning" id="estimated_earning" placeholder="$50" readonly type="text" />
                </div>
                <p
                  class="timeDurationdetile"
                  style="margin-top: 10px !important"
          ...
          <div class="col-md-12">
            <div class="row payment-type mx-1 my-3">
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-12">
                    ...
                    <input
                      class="payment-input"
                      placeholder="50%" value="{{$gigPayment->start_date}}"
                  ...
                  <div class="col-md-3 col-sm-12">
                    ...
                    <input
                      class="payment-input"
                      placeholder="50%" value="{{$gigPayment->start_time}}"
                  ...
                  <div class="col-md-3 col-sm-12">
                    ...
                    <input
                      class="payment-input"
                      placeholder="50%" value="{{$gigPayment->end_time}}"
                  ...
                  <div class="col-md-3 col-sm-12">
                    ...
                    <input
                      class="payment-input"
                      placeholder="50%" value="{{$gigPayment->end_date}}"
              ...
              @endphp
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-check form-switch col-md-12">
                      <input class="form-check-input form-control  " type="checkbox" role="switch" name="full_available_check" id="full_available_check" disabled @if ($gigPayment->full_available == 1) checked  @endif value="{{$gigPayment->full_available}}"  > 
                      <input type="hidden"  name="full_available" id="full_available" value="{{$gigPayment->full_available}}">
                    </div>
                  </div>
                </div>
                ...
                <div class="row"  id="main_repeat_on"  @if ($gigPayment->full_available == 1) style="display:nonel" @endif >
                  <div class="col-md-12">
                    <h3
                      class="online-Class-Select-Heading"
                      style="margin-top: 24px"
