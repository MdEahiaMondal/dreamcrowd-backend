...
<html lang="en">
  <head>
   ...
   {{-- =======Toastr CDN ======== --}}
    ...
    <title>Teacher Dashboard | Services Management-FAQ's</title>
  </head>
  <body>
          ...
          <div class="col-md-12">
            <div class="dash">
              <div class="row">
                <div class="col-md-12">
                  <div class="dash-top">
                    ...
                    <h1 class="dash-title">Services Management</h1>
                    <i class="fa-solid fa-chevron-right"></i>
              ...
              <div class="form-section">
                <div class="row">
                  <form action="/upload-faqs-services" method="POST">
                    @csrf
                    ...
                    <div class="col-12 form-sec">
                      <label for="inputAddress2" class="form-label"
                        >Question</label
                      >
                      <input type="hidden" value="{{$id}}" name="gig_id">
                      <input
                        type="text"
                        class="form-control"
                    ...
                    <div class="api-buttons">
                      <div class="row">
                        <div class="col-md-12">
                          <a  href="{{ url()->previous() }}" class="btn float-start cancel-btn">
                            Back
                          </a>
