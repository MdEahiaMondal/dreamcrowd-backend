@extends('layout.app')
@section('title', 'Teacher Dashboard | Zoom Integration')
@push('styles')
    <style>
                ...
                <div class="dash">
                    ...
                    @if ($isConnected)
                        <div class="connection-status-card connected">
                            ...
                            <p class="status-description">Your Zoom account is successfully connected and ready to host live
                                classes!</p>
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-row">
                                ...
                                <span
                                    class="info-value">{{ $user->zoom_connected_at ? $user->zoom_connected_at->format('M d, Y H:i') : 'N/A' }}</span>
                            </div>
                            <div class="info-row">
                        ...
                        <div class="info-card">
                            ...
                            <ul class="feature-list">
                                <li>
                                    ...
                                    <span><strong>Automatic Meeting Creation:</strong> Zoom meetings will be automatically
                                        created 30 minutes before your scheduled classes.</span>
                                </li>
                                <li>
                                    <i class="bx bx-check"></i>
                                    <span><strong>Secure Join Links:</strong> Your students will receive secure, one-time
                                        join links via email.</span>
                                </li>
                                <li>
                                    <i class="bx bx-check"></i>
                                    <span><strong>Attendance Tracking:</strong> We'll track who joins your classes and for
                                        how long.</span>
                                </li>
                                <li>
                                    <i class="bx bx-check"></i>
                                    <span><strong>Token Auto-Refresh:</strong> Your connection will be automatically
                                        maintained without requiring re-login.</span>
                                </li>
                            </ul>
                        </div>
                    @else
                        <div class="connection-status-card disconnected">
                            ...
                            <p class="status-description">Connect your Zoom account to automatically host live classes for
                                your students</p>
                        ...
                        <div class="warning-box">
                            ...
                            <div>
                                <strong>Important:</strong> You need to connect your Zoom account to host live classes.
                                Without this connection, your students won't be able to join your scheduled sessions.
                            </div>
                        </div>
                        ...
                        <div class="info-card mt-4">
                            ...
                            <ul class="feature-list">
                                <li>
                                    ...
                                    <span><strong>Step 1:</strong> Click "Connect with Zoom" to authorize DreamCrowd to
                                        create meetings on your behalf</span>
                                </li>
                                <li>
                                    <i class="bx bx-right-arrow-alt"></i>
                                    <span><strong>Step 2:</strong> Sign in to your Zoom account (if not already signed
                                        in)</span>
                                </li>
                                <li>
                                    <i class="bx bx-right-arrow-alt"></i>
                                    <span><strong>Step 3:</strong> Approve the connection and you'll be redirected
                                        back</span>
                                </li>
                                <li>
                                    <i class="bx bx-right-arrow-alt"></i>
                                    <span><strong>Step 4:</strong> That's it! Your live classes will now use Zoom
                                        automatically</span>
                                </li>
                            </ul>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $('#refreshTokenBtn').click(function() {
                ...
                btn.prop('disabled', true).html(
                    '<i class="bx bx-refresh refresh-spinner"></i> Refreshing...');
            ...
            $('#disconnectBtn').click(function() {
                if (!confirm(
                        'Are you sure you want to disconnect your Zoom account? Your future classes will not be able to use Zoom until you reconnect.'
                    )) {
                    return;
                }
                ...
                btn.prop('disabled', true).html(
                    '<i class="bx bx-loader-alt refresh-spinner"></i> Disconnecting...');
