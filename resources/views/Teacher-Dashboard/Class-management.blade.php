@extends('layout.app')
@section('title', 'Teacher Dashboard | Class Management')
                        ...
                        <div class="myServices-section">
                            ...
                            <div class="select-section">
                                    ...
                                    <form method="GET" action="{{ route('class-management-services') }}">
                                        <p class="mb-0">
                                            <select class="basic" name="service_select" onchange="this.form.submit()">
                                                <option value="All,All" {{ $serviceSelect == 'All,All' ? 'selected' : '' }}>
                                                    All Services</option>
                                                <option value="All,Online"
                                                    {{ $serviceSelect == 'All,Online' ? 'selected' : '' }}>Online Services
                                                </option>
                                                <option value="All,Inperson"
                                                    {{ $serviceSelect == 'All,Inperson' ? 'selected' : '' }}>In-Person
                                                    Services</option>
                                                <option value="Class,Online"
                                                    {{ $serviceSelect == 'Class,Online' ? 'selected' : '' }}>Classes Online
                                                </option>
                                                <option value="Class,Inperson"
                                                    {{ $serviceSelect == 'Class,Inperson' ? 'selected' : '' }}>Classes
                                                    In-Person</option>
                                                <option value="Freelance,Online"
                                                    {{ $serviceSelect == 'Freelance,Online' ? 'selected' : '' }}>Freelance
                                                    Online</option>
                                                <option value="Freelance,Inperson"
                                                    {{ $serviceSelect == 'Freelance,Inperson' ? 'selected' : '' }}>Freelance
                                                    Inperson</option>
                                ...
                                <div class="float-end expert-dropdown service-btn">
                                    <button class="btn action-btn" type="button" id="dropdownMenuButton1"
                                        data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-plus"></i>Add
                                        New Service</button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <form id="myForm" action="/select-service-type" method="POST"
                                            enctype="multipart/form-data"> @csrf
                                            <input type="hidden" id="action_service" name="action" value="Role">
                                            <input type="hidden" id="engine_service" name="engine">
                                            <a type="button" onclick="SetRoleSubmit(this.id)" id="cls_service_submit"
                                                data-role="Class" class="dropdown-item">
                                                <li>Class Service</li>
                                            </a>
                                            <a type="button" onclick="SetRoleSubmit(this.id)" id="fls_service_submit"
                                                data-role="Freelance" class="dropdown-item">
                                                    ...
                                                    <tbody>
                                                        @if ($gigs)
                                                            @foreach ($gigs as $item)
                                                                @if ($item->status == 1)
                                                                    @php
                                                                        $media = \App\Models\TeacherGigData::where([
                                                                            'gig_id' => $item->id,
                                                                        ])->first();
                                                                    @endphp
                                                                    <tr>
                                                                        ...
                                                                        <td class="table-cell">
                                                                            ...
                                                                            @if (Str::endsWith($media->main_file, ['.mp4', '.avi', '.mov', '.webm']))
                                                                                <!-- Video Player -->
                                                                                <video class="table-img" autoplay loop
                                                                                    muted>
                                                                                    <source
                                                                            ...
                                                                            <span
                                                                                class="para-1">{{ $item->title }}</span>
                                                                        </td>
                                                                        <td>{{ $item->service_role }}
                                                                            ...
                                                                            <div class="float-end expert-dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu"
                                                                                    ...
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-service-edit/' . $item->id . '/edit') }}">
                                                                                        <li>Edit service</li>
                                                                                    </a>
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-gig-action/' . $item->id . '/hide') }}">
                                                                                        <li>Sent to Hide</li>
                                                                                    </a>
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-gig-action/' . $item->id . '/delete') }}">
                                                                        ...
                                                                        <td>
                                                                            <div class="float-end expert-dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu"
                                                                                    ...
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-gig-action/' . $item->id . '/publish') }}">
                                                                                        <li>Sent to Publish</li>
                                                                                    </a>
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-gig-action/' . $item->id . '/delete') }}">
                                                                                        <li>Delete Service</li>
                                                                        ...
                                                                        <td>
                                                                            <div class="float-end expert-dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu"
                                                                                    ...
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-gig-action/' . $item->id . '/hide') }}">
                                                                                        <li>Restore to Hide</li>
                                                                                    </a>
                                                                                    <a class="dropdown-item"
                                                                                        href="{{ url('teacher-gig-action/' . $item->id . '/deletepermanent') }}">
                                                                                        <li>Delete Service Permanently</li>
                                                                                    </a>
                                                                                </ul>
                                                                            </div>
                                                                        </td>
