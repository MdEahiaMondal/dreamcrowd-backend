...
<body>
  ...
  <section class="home-section">
                            ...
                            <div class="features">
                                <div class="container-box">
                                    <div class="selector" id="features">
                                        ...
                                        <div class="tab-cont">
                                            <button class="but active feature-1 tab-item"
                                                onclick="feature(event, 'feature-1')">Published</button>
                                            <button class="but feature-2 tab-item" onclick="feature(event, 'feature-2')">Drafts
                                            </button>
                                            <button class="but feature-3 tab-item" onclick="feature(event, 'feature-3')">Paused
                                            </button>
                                            <button class="but feature-4 tab-item" onclick="feature(event, 'feature-4')">Hidden
                                            </button>
                                            <button class="but feature-5 tab-item" onclick="feature(event, 'feature-5')">Deleted
                                            </button>
                                        </div>
                                    ...
                                    <div class="myServices-section">
                                        <div class="service-Side">
                                            <span class="my-Services">
                                                My Services
                                            </span>
                                        </div>
                                        <div class="select-section">
                                            <div class="Select-1">
                                              <form method="GET" action="{{ route('class-management-services') }}">
                                                <p class="mb-0">
                                                    <select class="basic" name="service_select" onchange="this.form.submit()">
                                                      <option value="All,All" {{ $serviceSelect == 'All,All' ? 'selected' : '' }}>All Services</option>
                                                      <option value="All,Online" {{ $serviceSelect == 'All,Online' ? 'selected' : '' }}>Online Services</option>
                                                      <option value="All,Inperson" {{ $serviceSelect == 'All,Inperson' ? 'selected' : '' }}>In-Person Services</option>
                                                      <option value="Class,Online" {{ $serviceSelect == 'Class,Online' ? 'selected' : '' }}>Classes Online</option>
                                                      <option value="Class,Inperson" {{ $serviceSelect == 'Class,Inperson' ? 'selected' : '' }}>Classes In-Person</option>
                                                      <option value="Freelance,Online" {{ $serviceSelect == 'Freelance,Online' ? 'selected' : '' }}>Freelance Online</option>
                                                      <option value="Freelance,Inperson" {{ $serviceSelect == 'Freelance,Inperson' ? 'selected' : '' }}>Freelance Inperson</option>
                                            ...
                                            <div class="float-end expert-dropdown service-btn">
                                              <button class="btn action-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-plus"></i>Add New Service</button>
                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <form id="myForm" action="/select-service-type" method="POST" enctype="multipart/form-data"> @csrf
                                                  <input type="hidden" id="action_service"  name="action" value="Role" >
                                                  <input type="hidden" id="engine_service"  name="engine" >
                                                <a type="button" onclick="SetRoleSubmit(this.id)" id="cls_service_submit" data-role="Class" class="dropdown-item" ><li>Class Service</li></a>
                                                <a type="button" onclick="SetRoleSubmit(this.id)"  id="fls_service_submit" data-role="Freelance"  class="dropdown-item" ><li>Freelance Service</li></a>
                                              </form>
                                              </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-content feature-1 active tab-item" id="feature-1">
                                        ...
                                        <div class="feature-bullet">
                                            <div class="content-text">
                                                <p>A unique, handcrafted experience</p>
                                            </div> -->
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                          ...
                                                                          <td class="table-cell">
                                                                            ...
                                                                            <!-- Video Player -->
                                                                            <video class="table-img" autoplay loop muted  >
                                                                        ...
                                                                        @elseif (Str::endsWith($media->main_file, ['.jpg', '.jpeg', '.png', '.gif']))
                                                                            <!-- Image Display -->
                                                                            <img class="table-img" src="assets/teacher/listing/data_{{ $item->user_id }}/media/{{$media->main_file}}" alt="Service Image">
                                                                        @endif

                                                                             <span  class="para-1">{{$item->title}}</span>
                                                                             </td>
                                                                            ...
                                                                            <td>0</td>
                                                                            @endif
                                                                            @if ($item->cancelation != null)
                                                                            <td> {{$item->cancelation}} </td>
                                                                            @else
                                                                            <td>0</td>
                                                                            @endif
                                                                            @if ($item->orders != null)
                                                                            ...
                                                                            <td> <div class="float-end expert-dropdown">
                                                                              ...
                                                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                                <a class="dropdown-item" href="{{ url('teacher-service-edit/'.$item->id.'/edit') }}"><li>Edit service</li></a> 
                                                                                <a class="dropdown-item" href="{{ url('teacher-gig-action/'.$item->id.'/hide') }}"><li>Sent to Hide</li></a>
                                                                                <a class="dropdown-item" href="{{ url('teacher-gig-action/'.$item->id.'/delete') }}"><li>Delete Service</li></a>
                                                                              </ul>
                                                                            </div>
                                                                          </td>
                                                                        ...
                                                                        {{-- <tr> 
                                                                            <td><img class="table-img"
                                                                                    src="assets/teacher/asset/img/table img.jpeg"><span
                                                                                    class="para-1">Learn How to design</span>
                                                                                <p class="para-2">attractive UI for clients....
                                                                                </p>
                                                                            </td>
                                                                            ...
                                                                            <td> <div class="float-end expert-dropdown">
                                                                              <button class="btn action-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">...</button>
                                                                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                                <a class="dropdown-item" href="#"><li>Edit service</li></a>
                                                                                <a class="dropdown-item" href="#"><li>Sent to Draft</li></a>
                                                                                <a class="dropdown-item" href="#"><li>Delete Service</li></a>
                                                                              </ul>
                                                                            </div>
                                                                          </td>
                                                                        </tr> --}}
                                                              ...
                                                              @endif
                                                                ...
                                                                {{-- <tr> 
                                                                    ...
                                                                    <td> <div class="float-end expert-dropdown">
                                                                      ...
                                                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                        <a class="dropdown-item" href="#"><li>Edit service</li></a>
                                                                        <a class="dropdown-item" href="#"><li>publish service</li></a>
                                                                        <a class="dropdown-item" href="#"><li>Delete Service</li></a>
                                                                      </ul>
                                                                    </div>
                                                                  </td> 
                                ...
                                <div class="tab-content feature-3 tab-item" id="feature-3">
                                  <div class="rewiew-sec" id="installment-contant">
                                    <!-- BEGIN: INSTALLMENT TABLE SECTION -->
                                    <div class="row" id="main-contant-AI">
                                        <div class="col-md-12 installment-table">
                                ...
                                <div class="tab-content feature-4 tab-item" id="feature-4">
                                  <div class="rewiew-sec" id="installment-contant">
                                    <!-- BEGIN: INSTALLMENT TABLE SECTION -->
                                    <div class="row" id="main-contant-AI">
                                        <div class="col-md-12 installment-table">
                                                            ...
                                                            <tbody>
                                                              ...
                                                              @endif
                                                                  ...
                                                                  <td> <div class="float-end expert-dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                      <a class="dropdown-item" href="{{ url('teacher-service-edit/'.$item->id.'/edit') }}"><li>Edit service</li></a> 
                                                                      <a class="dropdown-item" href="{{ url('teacher-gig-action/'.$item->id.'/publish') }}"><li>Sent to Publish</li></a>
                                                                                <a class="dropdown-item" href="{{ url('teacher-gig-action/'.$item->id.'/delete') }}"><li>Delete Service</li></a>
                                                                    </ul>
                                                                  </div>
                                                                </td>
                                ...
                                <div class="tab-content feature-5 tab-item" id="feature-5">
                                  <div class="rewiew-sec" id="installment-contant">
                                    <!-- BEGIN: INSTALLMENT TABLE SECTION -->
                                    <div class="row" id="main-contant-AI">
                                        <div class="col-md-12 installment-table">
                                                            ...
                                                            <tbody>
                                                              ...
                                                              @endif
                                                                  ...
                                                                  <td> <div class="float-end expert-dropdown">
                                                                    <button class="btn action-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">...</button>
                                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"> 
                                                                      <a class="dropdown-item" href="{{ url('teacher-gig-action/'.$item->id.'/hide') }}"><li>Restore to Hide</li></a>
                                                                                <a class="dropdown-item" href="{{ url('teacher-gig-action/'.$item->id.'/deletepermanent') }}"><li>Delete Service Permanently</li></a>
                                                                    </ul>
                                                                  </div>
                                                                </td>
                                                              ...
                                                              @endif
                                                                ...
                                                                {{-- <tr>
                                                                    ...
                                                                    <td> <div class="float-end expert-dropdown">
                                                                      <button class="btn action-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">...</button>
                                                                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                        <a class="dropdown-item" href="#"><li>Unpause Service</li></a>
                                                                        <a class="dropdown-item" href="#"><li>Delete Service</li></a>
                                                                      </ul>
                                                                    </div>
                                                                  </td>
    ...
    {{-- Form Submit Js ==== --}}
    <script>
      function SetRoleSubmit(Clicked) {
        var role = $('#'+Clicked).data('role');
        $('#engine_service').val(role);
        $('#myForm').submit();
        }
    </script>
   <!-- ================ side js start here=============== -->
