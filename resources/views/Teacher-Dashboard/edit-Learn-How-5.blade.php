...
<body>
                        ...
                        <div class=" col-md-6 col-sm-12 ">
                          ...
                          <h3 class=" Select-Heading ">Class sub-category </h3>
                            ...
                            <div class="col-md-6 col-sm-12 mt-3">
                              <h3 class=" Select-Heading "  >Select freelance type<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                              ...
                              <div class=" select-box ">
                                  <select name="freelance_type" id="freelance_type" class=" fa ">
                                    @if ($gigData->freelance_type == 'Basic')
                                    <option value="Basic" class=" fa " selected>Basic Services</option>
                                    <option value="Premium" class=" fa ">Premium Services</option>
                                    <option value="Both" class=" fa ">Both Services</option>
                                   @elseif($gigData->freelance_type == 'Premium')
                                   <option value="Basic" class=" fa ">Basic Services</option>
                                   <option value="Premium" class=" fa " selected>Premium Services</option>
                                   <option value="Both" class=" fa ">Both Services</option>
                                    @else
                                    <option value="Basic" class=" fa ">Basic Services</option>
                                    <option value="Premium" class=" fa " >Premium Services</option>
                                    <option value="Both" class=" fa " selected>Both Services</option>
                                    @endif
                          ...
                          <div class="col-md-6 col-sm-12  mt-3">
                            ...
                            <div class=" select-box ">
                              <select name="freelance_service" id="freelance_service" class="fa">
                                @if ($gigData->freelance_service == 'Normal')
                                <option value="Normal" class="fa" selected>Normal Freelance</option>
                                <option value="Consultation" class="fa">Consultation Service</option>
                                    @else
                                    <option value="Normal" class="fa">Normal Freelance</option>
                                    <option value="Consultation" class="fa" selected>Consultation Service</option>
                                    @endif 
                          ...
                          @if ($gig->service_type == 'Online')
                            ...
                            <div class="col-md-6 col-sm-12" id="meeting_platform_main" @if ($gigData->freelance_service == 'Normal') style="display: none;" @endif>
                                ...
                                <div class="select-box">
                                    <select name="meeting_platform" id="meeting_platform" class="fa">
                                        ...
                                        <option value="Zoom" class="fa" @if($gigData->meeting_platform == 'Zoom') selected @endif>
                                            Zoom
                                        </option>
                                        <option value="Google" class="fa" @if($gigData->meeting_platform == 'Google') selected @endif>
                                            Google Meet
                                        </option>
                                    </select>
                                </div>
                          ...
                          <div class="col-md-6 col-sm-12  mt-3" id="video_call_main_div" @if ($gigData->freelance_service == 'Normal') style="display: none;"  @endif >
                            <h3 class=" Select-Heading ">Would you require a scheduled video call <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                              <path d="M8 1.5C6.71442 1.5 5.45772 1.88122 4.3888 2.59545C3.31988 3.30968 2.48676 4.32484 1.99479 5.51256C1.50282 6.70028 1.37409 8.00721 1.6249 9.26809C1.8757 10.529 2.49477 11.6872 3.40381 12.5962C4.31285 13.5052 5.47104 14.1243 6.73192 14.3751C7.99279 14.6259 9.29973 14.4972 10.4874 14.0052C11.6752 13.5132 12.6903 12.6801 13.4046 11.6112C14.1188 10.5423 14.5 9.28558 14.5 8C14.4982 6.27665 13.8128 4.62441 12.5942 3.40582C11.3756 2.18722 9.72335 1.50182 8 1.5ZM8 13.5C6.91221 13.5 5.84884 13.1774 4.94437 12.5731C4.0399 11.9687 3.33495 11.1098 2.91867 10.1048C2.50238 9.09977 2.39347 7.9939 2.60568 6.927C2.8179 5.86011 3.34173 4.8801 4.11092 4.11091C4.8801 3.34172 5.86011 2.8179 6.92701 2.60568C7.9939 2.39346 9.09977 2.50238 10.1048 2.91866C11.1098 3.33494 11.9687 4.03989 12.5731 4.94436C13.1774 5.84883 13.5 6.9122 13.5 8C13.4983 9.45818 12.9184 10.8562 11.8873 11.8873C10.8562 12.9184 9.45819 13.4983 8 13.5ZM9 11C9 11.1326 8.94732 11.2598 8.85356 11.3536C8.75979 11.4473 8.63261 11.5 8.5 11.5C8.23479 11.5 7.98043 11.3946 7.7929 11.2071C7.60536 11.0196 7.5 10.7652 7.5 10.5V8C7.36739 8 7.24022 7.94732 7.14645 7.85355C7.05268 7.75979 7 7.63261 7 7.5C7 7.36739 7.05268 7.24021 7.14645 7.14645C7.24022 7.05268 7.36739 7 7.5 7C7.76522 7 8.01957 7.10536 8.20711 7.29289C8.39465 7.48043 8.5 7.73478 8.5 8V10.5C8.63261 10.5 8.75979 10.5527 8.85356 10.6464C8.94732 10.7402 9 10.8674 9 11ZM7 5.25C7 5.10166 7.04399 4.95666 7.1264 4.83332C7.20881 4.70999 7.32595 4.61386 7.46299 4.55709C7.60003 4.50032 7.75083 4.48547 7.89632 4.51441C8.04181 4.54335 8.17544 4.61478 8.28033 4.71967C8.38522 4.82456 8.45665 4.9582 8.48559 5.10368C8.51453 5.24917 8.49968 5.39997 8.44291 5.53701C8.38615 5.67406 8.29002 5.79119 8.16668 5.8736C8.04334 5.95601 7.89834 6 7.75 6C7.55109 6 7.36032 5.92098 7.21967 5.78033C7.07902 5.63968 7 5.44891 7 5.25Z" fill="#0072B1"/>
                            </svg></h3>
                            <div class=" select-box ">
                              <select name="video_call" id="video_call" class="fa">

                                <option value="Yes" class="fa" selected>Yes</option>
                ...
                <div class=" col-md-12 ">
                    <div class=" mainSelect ">
                      <div>
                        ...
                        @php
                            $description = explode('|*|',$gigData->description);
                            $requirements = explode('|*|',$gigData->requirements);
                        @endphp
                        <div>
                          <h3 class=" Select-Heading "  id="heading_d_1">Description (Basic)</h3>
                        <textarea   id="description" name="description" rows=" 4 " cols=" 50 ">{{$description[0]}}</textarea>
                        </div>

                        <div>
                          <h3 class=" Select-Heading "  id="heading_r_1">Requirements (Basic)</h3>
                          <textarea   id="requirements" name="requirements" rows=" 4 " cols=" 50 ">{{$requirements[0]}}</textarea>
                        </div>

                        <div id="d_main_2" style="display: block">
                          <h3 class=" Select-Heading " id="heading_d_2">Description (Premium)</h3>
                          <textarea   id="description_2" name="description_2" rows=" 4 " cols=" 20 ">{{$description[1]}}</textarea>
                        </div>
                       <div id="r_main_2"  style="display: block">
                        <h3 class=" Select-Heading mt-2" id="heading_r_2">Requirements (Premium)</h3>
                        <textarea   id="requirements_2" name="requirements_2" rows=" 4 " cols=" 20 ">{{$requirements[1]}}</textarea>
                       </div>
                        ...
                        <div>
                          <h3 class=" Select-Heading "  id="heading_r_1">Requirements</h3>
 ...
 if (freelance_type == 'Both') { 
   ...
   $('#heading_r_1').html('Requirements (Basic)');
    $('#d_main_2').css('display', 'block');
   $('#r_main_2').css('display', 'block');
  //  $('#d_main_2').show();
  //  $('#r_main_2').show();
 } else { 
   $('#heading_d_1').html('Description');
   $('#heading_r_1').html('Requirements');
   $('#d_main_2').css('display', 'none');
   $('#r_main_2').css('display', 'none');
  //  $('#d_main_2').hide();
  //  $('#r_main_2').hide();
 }
                    ...
                    if (!description_2 || description_2.length < 10) {
                      toastr.options =
                          ...
                          "extendedTimeOut": "4410000" // 10 seconds
                                  ...
                                  toastr.error("Write Description Premium!");
                        valid = false;
                        return false ;
                    }
                    ...
                    if (!requirements_2 || requirements_2.length < 10) {
                      toastr.options =
                          ...
                          "extendedTimeOut": "4410000" // 10 seconds
                                  ...
                                  toastr.error("Write Requirements Premium!");
                        valid = false;
                        return false ;
                    }
