  ...
  @endif
      ...
      <hr>
                  ...
                  {{-- <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <input type="number" name="distance" class="form-control filter-input" id="distance" placeholder="10km" onfocus="getLiveLocation()">
    ...
    <div class="filter-list-items">
      <ul>
        ...
        <a   onclick="SelectCategory(this.id)"  id="cats_{{$i}}" data-category="{{$item->sub_category}}" data-category_type ="Sub_Category"><li>{{$item->sub_category}}</li></a>
        <hr>
        @php $i++; @endphp
        @endforeach
