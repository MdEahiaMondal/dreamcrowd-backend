        ...
        <div class="booking-det pt-0">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="service-pay">
                  ...
                  @endphp
                  <p>{{$gig->service_type}} {{$gig->service_role}} | {{$lesson_type}} Booking | {{$payment_type}} Payment |  {{$totalMinutes }} mins
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            @endphp
              ...
              <div class="tabs">
                <div class="tabs-nav" role="tablist" aria-label="Content sections" @if ($gigData->freelance_type == 'Premium') style="justify-content: flex-start;" @endif>
                            ...
                            <div class="row g-3">
                              ...
                              <div class="col-md-4 guest select-groups guests_set_div">
                                ...
                                <input
                                  type="number"
                                  class="form-control"
                                  id="guests" name="guests"  onfocusout="GroupSize(this.id)"
                                  placeholder="Number of Adults"  value="1"
                                />
                              </div>
                              ...
                              <div class="col-md-4 guest select-groups input-sec  guests_set_div">
                                <input
                                  ...
                                  id="childs" name="childs" onfocusout="GroupSize(this.id)"
                              ...
                              <div class="col-md-12 multiple-val-input multiemail guests_set_div">
                                ...
                                <div class="col-12 email-id-row mt-2">
                                  ...
                                  <input type="email"  class="enter-mail-id emails" id="email" placeholder="Enter the email id .." style="width: 100%;" />
