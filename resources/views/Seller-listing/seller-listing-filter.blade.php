...
<head>
     ...
     <!-- Animate css -->
     <link rel="stylesheet" href="assets/seller-listing/libs/animate/css/animate.css" />
 
     <!-- AOS Animation css-->
     <link rel="stylesheet" href="assets/seller-listing/libs/aos/css/aos.css" />
     
     <!-- Datatable css  -->
     
     <link rel="stylesheet" href="assets/seller-listing/libs/datatable/css/datatable.css" />
    ...
    <!-- Select2 css -->
     ...
     <link href="assets/seller-listing/libs/select2/css/select2.min.css" rel="stylesheet" />
     
     <!-- Owl carousel css -->
     
     <link href="assets/seller-listing/libs/owl-carousel/css/owl.carousel.css" rel="stylesheet" />
     <link href="assets/seller-listing/libs/owl-carousel/css/owl.theme.green.css" rel="stylesheet" />
 {{-- Datepicker Ui Jquery CDN --}}
 ...
 <link rel="stylesheet" href="https://code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
   ...
   {{-- =======Toastr CDN ======== --}}
     <!-- Defualt css -->
     <link rel="stylesheet" type="text/css" href="assets/seller-listing/asset/css/seller-listing.css" />
     <link rel="stylesheet" href="assets/seller-listing/asset/css/logedin_navbar.css">
...
<body>
  ...
  @endif
    ...
    <div class="container-fluid">
                ...
                <div class="col-md-3 seller-listing">
                    ...
                    <div class="row">                       
                        <div class="col-md-12">
                          ...
                          <select class="form-control filter-input" name="service_type" id="service_type_selector">
                            @if ($service_type != 'All')
                            <option value="{{$service_type}}" selected>{{$service_type}} Services</option>
                            @endif
                            <option value="All">Online & Inperson</option>
                            <option value="Online">Online Only</option>
                            <option value="Inperson">Inperson Only</option>
                          </select>
                    ...
                    <form id="filterForm" action="/seller-listing-search"> @csrf
                <div class="filter-lists dropdown-content" id="main">
                  <h6>Filter</h6>
                  <div   class="filter-radio-items">
                    <input type="hidden" name="service_type" value="{{$service_type}}" id="service_type">
                    <input type="hidden" name="service_role" value="{{$service_role}}" id="service_role">
                    ...
                    <p>
                      <input type="radio" id="test4" name="seller_type" value="Top Seller" checked>
                      <label for="test4">Top Seller</label>
                    </p>
                    <p>
                      <input type="radio" id="test2"  name="seller_type" value="High To Low">
                      <label for="test2">High to Low</label>
                    </p>
                    <p>
                      <input type="radio" id="test1"  name="seller_type" value="Low To High" >
                      <label for="test1">Low to High</label>
                    </p>
                 
                    <p>
                      <input type="radio" id="test3"  name="seller_type" value="Trending">
                      <label for="test3">Trending</label>
                    </p> 
                    <p>
                      <input type="radio" id="test5"  name="seller_type" value="Rating">
                      <label for="test5">Rating</label>
                    </p>
                  </div>
      <hr>
                  ...
                  <h6>Location</h6>
                  {{-- <div class="mb-3 row">
                    <label for="inputPassword" class="col-sm-2 col-form-label filter-label">Postcode</label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control filter-input" id="inputPassword" placeholder="enter your postcode">
                    </div>
                    </div> --}}
                    <div class="mb-3 row">
                      <label for="distance" class="col-sm-2 col-form-label filter-label">Distance</label>
                      <div class="col-sm-6">
                        <input type="number" name="distance" class="form-control filter-input" value="{{$miles_distance}}" id="distance" placeholder="10km" onfocus="getLiveLocation()" style="width: 100%">
                        <input type="hidden" name="latitude" id="latitude" value="{{$latitude}}">
                        <input type="hidden" name="longitude" id="longitude" value="{{$longitude}}">
                      </div>
                      <div class="col-sm-4" style="padding-left: 0;">
                        <select name="miles" class="form-select form-control filter-input" id="" style="width: 85%;">
                          @if ($unit == 'KM')
                  ...
                  <dl class="dropdown"> 
                    ...
                    <a >
                      ...
                      <p class="multiSel"></p> 
                      @else
                      <span class="hida" style="display: none;">Select language</span>    
                      <p class="multiSel"></p> 
                      @endif  
                    </a>
                    </dt>
                    ...
                    <dd>
                        <div class="mutliSelect">
                            <ul>
                              ...
                              @if ($language_selected != null)
                              @php $language = explode(',',$language_selected); @endphp

                              @if (in_array($item->language, $language))
                              <li>  <input type="checkbox" name="languages[]" value="{{$item->language}}" checked autocompleted/>{{$item->language}}</li>
                                  
                              @else
                              <li>  <input type="checkbox" name="languages[]" value="{{$item->language}}" />{{$item->language}}</li>
                              ...
                              {{-- <li>   <input type="checkbox" value="Urdu" />Urdu</li> --}}
                  ...
                  <div  class="filter-radio-items">
                    <p>
                      <input type="radio" id="test14"  name="payment_type" value="All" @if ($payment_type == "All") checked  @endif >
                      <label for="test14">All Payment</label>
                    </p>
                    <p>
                      <input type="radio" id="test15"  name="payment_type" value="OneOff" @if ($payment_type == "OneOff") checked  @endif>
                      <label for="test15">One-off Payment</label>
                    </p>
                    <p>
                      <input type="radio" id="test16"  name="payment_type" value="Subscription" @if ($payment_type == "Subscription") checked  @endif>
                      <label for="test16">Subscription</label>
                    </p>
                  </div>
                  <hr>
                  @if (in_array($service_role, ['All', 'Freelance']))
                  <h6>Freelance Type</h6>
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="test25"  name="freelance_type" value="All"  @if ($freelance_type == "All") checked  @endif>
                      <label for="test25">All Plans</label>
                    </p>
                    <p>
                      <input type="radio" id="test9"  name="freelance_type" value="Premium" @if ($freelance_type == "Premium") checked  @endif >
                      <label for="test9">Premium Plan</label>
                    </p>
                    <p>
                      <input type="radio" id="test10"  name="freelance_type" value="Basic" @if ($freelance_type == "Basic") checked  @endif>
                      <label for="test10">Basic Plan</label>
                    </p>
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="testd25"  name="delivery_time" value="All" @if ($delivery_time == "All") checked  @endif>
                      <label for="testd25">All Delivery Times</label>
                    </p>
                    <p>
                      <input type="radio" id="testd9"  name="delivery_time" value="1" @if ($delivery_time == "1") checked  @endif>
                      <label for="testd9">Within 1 Day</label>
                    </p>
                    <p>
                      <input type="radio" id="testd11"  name="delivery_time" value="2" @if ($delivery_time == "2") checked  @endif>
                      <label for="testd11">Within 2 days</label>
                    </p>
                    <p>
                      <input type="radio" id="testd12"  name="delivery_time" value="3" @if ($delivery_time == "3") checked  @endif>
                      <label for="testd12">Within 3 days</label>
                    </p>
                    <p>
                      <input type="radio" id="testd13"  name="delivery_time" value="4" @if ($delivery_time == "4") checked  @endif>
                      <label for="testd13">Within 4+days</label>
                    </p>
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="testr25"  name="revision" value="All" @if ($revision == "All") checked  @endif>
                      <label for="testr25">All Revisions</label>
                    </p>
                    <p>
                      <input type="radio" id="testr9"  name="revision" value="1 to 5" @if ($revision == "1 to 5") checked  @endif>
                      <label for="testr9">1 to 5</label>
                    </p>
                    <p>
                      <input type="radio" id="testr11"  name="revision" value="5 to 10" @if ($revision == "5 to 10") checked  @endif>
                      <label for="testr11">5 to 10</label>
                    </p>
                    <p>
                      <input type="radio" id="testr12"  name="revision" value="10 to 20" @if ($revision == "10 to 20") checked  @endif>
                      <label for="testr12">10 to 20</label>
                    </p>
                    <p>
                      <input type="radio" id="testr13"  name="revision" value="Unlimited" @if ($revision == "Unlimited") checked  @endif>
                      <label for="testr13">Unlimited</label>
                    </p>
                  ...
                  @if (in_array($service_role, ['All', 'Class']))
                  <h6>Class Type</h6>
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="test6"  name="lesson_type" value="All"  @if ($lesson_type == "All") checked  @endif>
                      <label for="test6">All Classes</label>
                    </p>
                    <p>
                      <input type="radio" id="test7"  name="lesson_type" value="One" @if ($lesson_type == "One") checked  @endif>
                      <label for="test7">1 to 1 Class</label>
                    </p>
                    <p>
                      <input type="radio" id="test8"  name="lesson_type" value="Group" @if ($lesson_type == "Group") checked  @endif>
                      <label for="test8">Group Class</label>
                    </p>
                  </div>
                  <hr>
                  <h6>Class Form</h6>
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="test28"  name="class_type" value="All"  @if ($class_type == "All") checked  @endif>
                      <label for="test28">All Formats</label>
                    </p>
                    <p>
                      <input type="radio" id="test26"  name="class_type" value="Live" @if ($class_type == "Live") checked  @endif>
                      <label for="test26">Live Classes</label>
                    </p>
                    <p>
                      <input type="radio" id="test27"  name="class_type" value="Recorded" @if ($class_type == "Recorded") checked  @endif>
                      <label for="test27">Recorded Classes</label>
                    </p> 
                  </div>
                  <hr>
                  @endif
      ...
      <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label filter-label">Min</label>
        <div class="col-sm-10">
          <input type="text" class="form-control filter-input" name="min_price" value="{{$min_price}}" id="inputPassword" placeholder="$12000">
        </div>
        </div>

      <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label filter-label">Max</label>
        <div class="col-sm-10">
          <input type="text" class="form-control filter-input" name="max_price" value="{{$max_price}}" id="inputPassword" placeholder="$12000">
        </div>
        </div>
       
           <hr>

          <h6><img src="assets/seller-listing/asset/img/calendarsearch.svg" alt="">&nbsp;&nbsp;Select Date</h6>

          <div class="mb-3 row">
             <div class="col-sm-12">
              <input type="text" class="form-control filter-input" name="date_time" id="selectDateTime" value="{{$date}}" readonly placeholder="Select Date">
            </div>
            </div>

          {{-- <button type="button" class="btn select-date" data-bs-toggle="modal" data-bs-target="#select-date-modal">
            <img src="assets/seller-listing/asset/img/calendarsearch.svg" alt="">&nbsp;&nbsp;Select Date
          </button> --}}
           
          <hr>
                  
      <div class="text-center">
      <a href="seller-listing"   type="button" class="btn btn-secondary apply-filter-bt">Clear Filter</a>
      <button id="ApplyButton" type="submit" class="btn apply-filter-btn">Apply Filter</button>
    </div>
      <hr>
    </div>
  </form>
    <div class="filter-list-items">
      <ul>
        ...
        <a  onclick="SelectCategory(this.id)"  id="cats_{{$i}}" data-category="{{$item->sub_category}}" data-category_type ="Category" ><li>{{$item->category}}</li></a>
        <hr>
        ...
        @if ($categories_tab)
        @php $j = 1; @endphp
        @foreach ($categories_tab as $item2)
        <a  onclick="SelectCategory(this.id)"  id="sub_cats_{{$j}}" data-category="{{$item2->sub_category}}" data-category_type ="Sub_Category" ><li>{{$item2->sub_category}}</li></a>
        <hr>
             ...
             <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist">
                        <li class="nav-item" role="presentation">
                          <button
                            data-mdb-tab-init
                            class="nav-link all-services-tab ms-0 @if ($service_role == 'All') active @endif "
                        ...
                        <li class="nav-item" role="presentation">
                          <button
                            data-mdb-tab-init
                            class="nav-link  @if ($service_role == 'Freelance') active @endif "
                            ...
                            aria-selected="false" --}}
                          >Freelance Experts</button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button
                            data-mdb-tab-init
                            class="nav-link  @if ($service_role == 'Class') active @endif "
                            ...
                            aria-selected="false" --}}
                          >Teaching Experts</button>
                        </li>
                        <li class="nav-item searchbar-sec" role="presentation">
                          <div class="searchwrapper">
                            <div class="searchbox">
                              <div class="row search-sec search-container search-container-main">
                                <div class="col-md-8 col-5 search-container search-container-main">
                                  <input type="text" class="form-control search-form" autocomplete="off" id="keyword_search" placeholder="Find a service">
                                  <div class="suggestions" id="suggestions_main" style="width:24%;top: 22%;"></div>
                                </div>
                                <div class="col-md-3 col-5 p-0"><input type="text" class="form-control search-form" id="location_search" placeholder="Location"></div>
                                <div class="col-md-1 col-2" onclick="searhBtn()"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <div class="wrapper">
                ...
                <ul class="tabs-box">
                  ...
                  <li class="tab" onclick="SelectCategory(this.id)"  id="cats_{{$i}}" data-category="{{$item->sub_category}}" data-category_type ="Sub_Category" >{{$item->sub_category}}</li>
                  @else
                  
                  <li class="tab" onclick="SelectCategory(this.id)"  id="cats_{{$i}}" data-category="{{$item->category}}" data-category_type ="Category" >{{$item->category}}</li>
                  @endif
            ...
            @endif
              ...
              {{-- <div class="col-lg-3 col-md-6 col-12">
                  <div class="main-Dream-card">
                      <div class="card dream-Card">
                          <div class="dream-card-upper-section">
                              <img src="assets/seller-listing/asset/img/card-main-img.png" alt="">
                              <div class="card-img-overlay overlay-inner">
                                  <p>
                                      Top Seller
                                  </p>
                          ...
                          <a href="#" style="text-decoration: none;">
                              <div class="dream-card-dawon-section" type="button" data-bs-toggle="offcanvas" data-bs-target="#inline-person" aria-controls="offcanvasRight">
                                  <div class="dream-Card-inner-profile">
                                      <img src="assets/seller-listing/asset/img/inner-profile.png" alt="">
                                      <i class="fa-solid fa-check tick"></i>
                                  </div>
                                  ...
                                  <div class="card-last">
                                      ...
                                      <!-- word img -->
                                      <img data-toggle="tooltip" title="In Person-Service" src="assets/seller-listing/asset/img/handshake.png" style="height: 28px; width: 28px;" alt="">
                                  </div>
                              </div>
                      </div>
                  </div>
...
<ul class="pagination"> 
    ...
    @else
    <li class="page-item">
      <a   class="page-link" href="{{ $gigs->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
    ...
    @for ($i = $start; $i <= $end; $i++)
        ...
        <li class="page-item active" aria-current="page"><a class="page-link" >{{ $i }}</a></li>
          @else
        <li class="page-item "><a class="page-link" href="{{ $gigs->url($i) }}">{{ $i }}</a></li>
         @endif
    @endfor
    ...
    <li class="page-item">
      <a class="page-link" href="{{ $gigs->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
        »
      </a>
  </li>
...
@endif
    ...
    <!-- No record found section start from here -->
    <div class="container">
        <!-- online service section -->
        {{-- <div class="online-service">
          <div class="row">
    ...
    <div class="offcanvas offcanvas-end services-offcanvas" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      ...
      <div class="offcanvas-body services-details">
        <div class="row">
            <div class="col-md-1">
                <div class="profile">
                    <img src="assets/seller-listing/asset/img/profile.png" alt="" />
                </div>
            </div>
            <div class="col-md-11">
            ...
            <div class="col-md-12">
                <div class="booking-det">
                    ...
                    <h5>Service & Payment Type : <span class="in-person">In-Person</span><span> Freelance | Group Booking | Subscription</span></h5>
                    <h5>Price : <span>From $10</span></h5>
                    <h5>Delivery & Completion Date : <span>Within 15 days each month</span></h5>
                    <h5>Max. Travel Distance : <span>Able to travel up to 10 miles from London, United Kingdom</span></h5>
                    <h5>Description :</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae ut tellus quis a euismod ut nisl, quis. Tristique bibendum morbi vel vitae ultrices donec accumsan. Tincidunt eget habitant pellentesque id purus. Hendrerit varius sapien, nunc, turpis augue arcu venenatis. At sed consectetur in viverra duis tincidunt diam.
                    Fames diam, interdum fringilla venenatis sed mi quis. Convallis enim, sit pharetra fermentum pellentesque eros. Tortor cras nulla sit dui tincidunt platea mauris. Enim, risus non posuere venenatis non quis id nec. Consectetur vitae gravida ut morbi tellus arcu. In pretium in malesuada neque. At mauris massa magna mauris, </p>
                    <h5>Requirements :</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae ut tellus quis a euismod ut nisl, quis. Tristique bibendum morbi vel vitae ultrices donec accumsan. Tincidunt eget habitant pellentesque id purus. Hendrerit varius sapien, nunc, turpis augue arcu venenatis. At sed consectetur in viverra duis tincidunt diam.</p>
                    <h5>Booking & Cancelation Details :</h5>
                    <p>After booking a class or activity, you will be emailed instructions on how to attend the experience on Zoom.
                        You can cancel or reschedule a booking up to 24 hours before the experience starts for free</p>
                        <div class="portfolio-sec">
                            <h5>Portfolio</h5>
                            <div class="row">
                                <div class="col-md-3">
                                <a href="assets/img/portfolioimg (1).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing/asset/img/portfolioimg (1).png" />
                                  </a>
                                </div>
                                <div class="col-md-3">
                                  <a href="assets/img/portfolioimg (2).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing/asset/img/portfolioimg (2).png" />
                                  </a>
                                </div>
                                <div class="col-md-3">
                                  <a href="assets/img/portfolioimg (3).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing/asset/img/portfolioimg (3).png" />
                                  </a>
                                </div>
                                <div class="col-md-3">
                                  <a href="assets/img/portfolioimg (4).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing/asset/img/portfolioimg (4).png" />
                                  </a>
                                </div>                           
                              </div> <!-- row / end -->
                        </div>
                        <div class="portfolio-form">
                            <form class="row g-3">
                                ...
                                <div class="col-md-4 guest">
                                    <input type="number" class="form-control numberof-childs" id="inputPassword4" placeholder="0">
                                  </div>
                                  <div class="col-md-6 frequency">
                                    <label for="inputEmail4" class="form-label">Select Class Frequency</label>
                                    <input type="text" class="form-control" id="inputEmail4" placeholder="Select Class Frequency">
                                  </div>
                                  <div class="col-md-6 multiple-val-input multiemail">
                                    <label for="inputEmail4" class="form-label">Enter Guests Emails for Class Invitation</label> <br>
                                    <ul>
                                  ...
                                  <div class="col-md-12">
                                    <label for="inputEmail4" class="form-label">How far away are you  from seller location</label>
                                    <input type="email" class="form-control" id="inputEmail4" placeholder="7 mile">
                                  </div>
                                  <div class="col-md-12 field_wrapper date-time">
                                    <div>
                                      <label for="inputEmail4" class="form-label">Select Date & Time</label>
                                        <input class="add-input" type="text" name="field_name[]" value="" placeholder="Select Date & Time"/>
                                        <a href="javascript:void(0);" class="add_button" title="Add field"><img src="assets/seller-listing/asset/img/add-input.svg"/></a>
                                    </div>
                                </div>
                              </form>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-7 booking-notes">
                                <h5>Notes</h5>
                                <ul class="p-0">
                                    <li>To ensure that your payments are protected under our terms, never transfer money or send messages outside of the Dreamcrowd platform.</li> <br>
                                    <li>Payments made outside of our platform are not eligible for disputes & refunds under our terms.</li> <br>
                                    <li>Please send us a report if you have been asked by a Creator to communicate or pay outside of our  platform.</li>
                                  </ul>
                            </div>
                        </div>
                </div>
      ...
      <div class="amount-sec">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="float-end">
                    <a href="#" type="button" class="btn contact-btn" data-bs-toggle="modal" data-bs-target="#exampleModal1">Contact Us</a>
                    <!-- Modal -->
            ...
            <div class="modal-body p-0">
                <div class="row">
                    <div class="col-md-12 name-label">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" placeholder="Usama Aslam">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Email</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="usamaaslam@gmail.com">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Country</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="Your Country">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">City</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="Your City">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Your Area</label>
                        <input type="email" class="form-control" id="inputEmail4" placeholder="Your Area">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Type of expert needed</label>
                        <select name="" id="">
                      ...
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Type of service</label> <br>
                        <select name="" id="">
                    ...
                    <div class="col-md-12 check-services">
                      <div class="form-group">
                        <label for="exampleFormControlTextarea4" class="label-sec">Describe the help you require</label>
                        <textarea class="form-control" id="exampleFormControlTextarea4" rows="3" placeholder="Describe the help you require..."></textarea>
                      </div>
                    </div>
                    <div class="col-md-12 booking-buttons">
                        <button type="submit" class="btn request-booking">Submit</button>
                        <button type="button" class="btn booking-cancel" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
          </div>
  ...
  >
    <div class="modal-dialog modal-dialog-centered mt-5">
     ...
     <div class="container-fluid footer-section">
      <div class="container">
          <div class="row">
              <div class="col-md-5">
                  <img src="assets/seller-listing/asset/img/Logo.png" alt="">
                  ...
                  <p>By subscribing, you agree to our <a href="">terms</a> and <a href="">privacy policy.</a></p>
              </div>
              <div class="col-md-7">
                  <div class="row">
    ...
    <script src="assets/seller-listing/libs/jquery/jquery.js"></script>
    <script src="assets/seller-listing/libs/datatable/js/datatable.js"></script>
    <script src="assets/seller-listing/libs/datatable/js/datatablebootstrap.js"></script>
    <script src="assets/seller-listing/libs/select2/js/select2.min.js"></script>
    <script src="assets/seller-listing/libs/owl-carousel/js/owl.carousel.min.js"></script>
    <script src="assets/seller-listing/libs/aos/js/aos.js"></script>
    <script src="assets/seller-listing/asset/js/bootstrap.min.js"></script>
    <script src="assets/seller-listing/asset/js/script.js"></script>
    
      {{-- Select Date Model Angular CDN Link --}}
      <script src="assets/seller-listing/asset/js/date-pick-script.js"></script>
    ...
    >
      ...
      <div class="offcanvas-body services-details">
        <div class="row">
          <div class="col-md-1">
            <div class="profile">
              <img src="assets/seller-listing/asset/img/personal-profile.png" alt="" />
            </div>
          </div>
          <div class="col-md-11">
            <div class="profile-det">
            ...
            <div class="booking-det">
              ...
              <div class="portfolio-sec">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <a
                      href="assets/img/portfolioimg (2).png"
                      data-fancybox="gallery"
                      data-caption=""
                    >
                      <img src="assets/seller-listing/asset/img/portfolioimg (2).png" />
                  ...
                  <div class="col-md-3">
                    <a
                      href="assets/img/portfolioimg (3).png"
                      data-fancybox="gallery"
                      data-caption=""
                    >
                      <img src="assets/seller-listing/asset/img/portfolioimg (3).png" />
                  ...
                  <div class="col-md-3">
                    <a
                      href="assets/img/portfolioimg (4).png"
                      data-fancybox="gallery"
                      data-caption=""
                    >
                      <img src="assets/seller-listing/asset/img/portfolioimg (4).png" />
...
<script>
  ...
  {{-- OnSelect Form Submit Script Start=== --}}
  <script>

$('#service_type_selector').change(function () { 
 var service_type = $('#service_type_selector').val();
...
<script>
    $(document).ready(function () {
      ...
      var fieldHTML = '<div><input class="add-input" type="datetime-local" name="field_name[]" value="" placeholder="Select Date & Time"/><a href="javascript:void(0);" class="remove_button" title="Remove field"><img src="assets/seller-listing/asset/img/remove-icon.svg"/></a></div>'; //New input field html
