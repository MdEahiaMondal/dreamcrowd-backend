...
<body>
  ...
  @endif
    ...
    <div class="container-fluid">
                    ...
                    <div class="row">                       
                        <div class="col-md-12">
                            <div class="listing">
                              <div class="marg-sec">
                                <div class="dropdown">
                                  <button class="btn calendar-sec dropdown-toggle w-100" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    @if ($Data['service_type'] == 'All') Online/In-person @else {{$Data['service_type']}}  @endif  
                                  </button>
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                      <a class="dropdown-item" >
                                        <p>
                                          <input type="radio" id="test23" name="radio-group" value="All" @if ($Data['service_type'] == 'All') checked @endif   onclick="updateButtonText(this.id)">
                                    ...
                                    <li>
                                      <a class="dropdown-item" >
                                        <p>
                                          <input type="radio" id="test21" name="radio-group" value="Online"  @if ($Data['service_type'] == 'Online') checked @endif  onclick="updateButtonText(this.id)">
                                    ...
                                    <li>
                                      <a class="dropdown-item" >
                                        <p>
                                          <input type="radio" id="test22" name="radio-group" value="Inperson"  @if ($Data['service_type']== 'Inperson') checked @endif  onclick="updateButtonText(this.id)">
                              ...
                              <input type="hidden" name="service_type" value="{{$Data['service_type']}}" id="service_type">
                              <input type="hidden" name="service_role" value="{{$Data['service_role']}}" id="service_role">
                              <input type="hidden" name="date_time" id="selectDateTime"  >
                              <input type="hidden" name="keyword"   id="keyword">
                              <input type="hidden" name="location"   id="location">
                              <input type="hidden" name="category_type"   id="category_type" value="{{$Data['category_type']}}">
                              <input type="hidden" name="category_service"   id="category_service" value="{{$Data['category']}}">
                        ...
                        <!-- <button type="button" class="btn select-date" data-bs-toggle="modal" data-bs-target="#exampleModal">
                          ...
                          <button class="btn calendar-sec dropdown-toggle filter-sec" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                            <li>
                              <a class="dropdown-item" >
                                <p>
                                  <input type="radio" id="test24" name="seller_type"  value="Relevence" @if ($Data['sort_by'] == 'Relevence') checked @endif>
                            ...
                            <li>
                              <a class="dropdown-item" >
                                <p>
                                  <input type="radio" id="test25" name="seller_type" value="High to Low" @if ($Data['sort_by'] == 'High to Low') checked @endif>
                            ...
                            <li>
                              <a class="dropdown-item" >
                                <p>
                                  <input type="radio" id="test29" name="seller_type" value="Low to High" @if ($Data['sort_by'] == 'Low to High') checked @endif>
                            ...
                            <li>
                              <a class="dropdown-item" >
                                <p>
                                  <input type="radio" id="test26" name="seller_type" value="Trending" @if ($Data['sort_by'] == 'Trending') checked @endif>
                            ...
                            <li>
                              <a class="dropdown-item"  >
                                <p>
                                  <input type="radio" id="test27" name="seller_type" value="Top Seller" @if ($Data['sort_by'] == 'Top Seller') checked @endif>
                            ...
                            <li>
                              <a class="dropdown-item" >
                                <p>
                                  <input type="radio" id="test28" name="seller_type" value="Rating" @if ($Data['sort_by'] == 'Rating') checked @endif>
                      ...
                      <dd>
                          <div class="multiSelectContainer">
                              <ul style="max-height: 300px;" id="side_categories">
                                ...
                                <li> <input type="checkbox" class="side_cates" name="categories_list" value="{{$item->$catetype}}" />{{$item->$catetype}}</li>
                ...
                <h6>Payment Type</h6>
                  ...
                  <div class="mb-3 row align-items-center">
                   <div class="col-lg-4 col-md-12">
                    ...
                    <div class="col-sm-12">
                      <input type="number" class="form-control filter-input"  name="max_price_app" id="max_price_app" placeholder="Max.">
                    </div>
                   </div>
                   <div class="col-lg-4 col-md-12">
                    <label for="inputPassword" class="col-sm-12 col-form-label filter-label">Minimum</label>
                    <div class="col-sm-12">
                      <input type="number" class="form-control filter-input"  name="min_price_app" id="min_price_app" placeholder="Min.">
                    </div>
                   </div>
                      <div class="col-lg-4 col-md-12">
                      ...
                      <dd>
                        <div class="mutliSelect">
                          <ul>
                              ...
                              <li class="option"><input type="checkbox"  name="languages_list" value="English" /> English</li>
                              @if ($languages)
                              @foreach ($languages as $item)
                               <li class="option"><input type="checkbox" name="languages_list" value="{{$item->language}}" /> {{$item->language}}</li>
                              @endforeach
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="mb-3 row align-items-center">
                      <div class="col-xl-5 col-lg-6 col-md-6">
                       <label for="inputPassword" class="col-sm-12 col-form-label filter-label">Distance</label>
                       <div class="col-sm-12">
                         <input type="number"  name="distance_app"  id="distance_app"   class="form-control filter-input"  placeholder="Distance" fdprocessedid="3xjur9">
                       ...
                       <div class="col-sm-12">
                        <select name="miles_app" id="miles_app" class="form-control distance-select mt-2">
                         ...
                         <div class="col-xl-3 col-lg-12 col-md-12">
                           <label for="inputPassword" class="col-sm-12 col-form-label filter-label"></label>
                           <button onclick="getLiveLocation()" class="btn btn-apply apply-price mt-2 w-100" fdprocessedid="laa309">Apply</button>
                          </div>
                         </div>
                    </div>
                <hr>
                  
                <div class="freelance_div_main"  @if (in_array($service_role, ['All', 'Freelance'])) style="display: block;" @else  style="display: none;" @endif>
          ...
          <div  class="class_div_main"  @if (in_array($service_role, ['All', 'Class'])) style="display: block;" @else  style="display: none;" @endif>
             ...
             <div class="row">
                            ...
                            <div class="searchbox">
                              <div class="row search-sec">
                                <div class="col-md-8 col-5 search-container search-container-main">
                                  <input type="text"  autocomplete="off" id="keyword_search" class="form-control search-form" placeholder="Find a service">
                                  <div class="suggestions" id="suggestions_main" style="width:24%;top: 22%;"></div>
                                </div>
                                <div class="col-md-3 col-5 p-0">
                                  <input type="text"  id="location_search" class="form-control search-form" placeholder="Location">
                                </div>
              ...
              <div class="wrapper">
                ...
                <ul class="tabs-box" id="top_categories">
                  ...
                  @php $i = 1; @endphp
                  @foreach ($categories_tab as $item)
                  <li class="tab" onclick="SelectCategory(this.id)"  id="cats_{{$i}}" data-category="{{$item->$catetype}}" data-category_type ="{{$category_type}}" >{{$item->$catetype}}</li>
                  @php $i++; @endphp
                  @endforeach
                          ...
                          <a href="#" style="text-decoration: none;">
                              <div class="dream-card-dawon-section" type="button" data-bs-toggle="offcanvas" data-bs-target="#inline-person" aria-controls="offcanvasRight">
                                  ...
                                  <div class="card-last">
                                      <span>Starting at $5</span>
                                      <!-- word img -->
                                      <img data-toggle="tooltip" title="In Person-Service" src="assets/seller-listing-new/asset/img/handshake.png" style="height: 28px; width: 28px;" alt="">
                                  </div>
                              </div>
                      </div>
                  </div>
                ...
                <div class="booking-det">
                    ...
                    <p>After booking a class or activity, you will be emailed instructions on how to attend the experience on Zoom.
                        ...
                        <div class="portfolio-sec">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                <a href="assets/seller-listing-new/asset/img/portfolioimg (1).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing-new/asset/img/portfolioimg (1).png" />
                                  </a>
                                </div>
                                <div class="col-md-3">
                                  <a href="assets/seller-listing-new/asset/img/portfolioimg (2).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing-new/asset/img/portfolioimg (2).png" />
                                  </a>
                                </div>
                                <div class="col-md-3">
                                  <a href="assets/seller-listing-new/asset/img/portfolioimg (3).png" data-fancybox="gallery" data-caption="">
                                    <img src="assets/seller-listing-new/asset/img/portfolioimg (3).png" />
                                  </a>
                                </div>
                                <div class="col-md-3">
                                  <a href="assets/seller-listing-new/asset/img/portfolioimg (4).png" data-fancybox="gallery" data-caption="">
                        ...
                        <div class="portfolio-form">
                            <form class="row g-3">
                                ...
                                <div class="col-md-4 guest">
                                    <input type="number" class="form-control numberof-childs" id="inputPassword5" placeholder="0">
                                  </div>
                                  <div class="col-md-6 frequency">
                                    <label for="inputEmail4" class="form-label">Select Class Frequency</label>
                                    <input type="text" class="form-control" id="inputEmail41" placeholder="Select Class Frequency">
                                  </div>
                                  ...
                                  <div class="col-md-12 field_wrapper date-time">
                                    <div>
                                      <label for="inputEmail4" class="form-label">Select Date & Time</label>
                                        ...
                                        <a href="javascript:void(0);" class="add_button" title="Add field"><img src="assets/seller-listing-new/asset/img/add-input.svg"/></a>
                                    </div>
                                </div>
                              </form>
                        </div>
            ...
            <div class="modal-body p-0">
                <div class="row">
                    <div class="col-md-12 name-label">
                        ...
                        <input type="text" class="form-control" id="inputEmail43" placeholder="Usama Aslam">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Email</label>
                        <input type="email" class="form-control" id="inputEmail44" placeholder="usamaaslam@gmail.com">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Country</label>
                        <input type="email" class="form-control" id="inputEmail45" placeholder="Your Country">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">City</label>
                        <input type="email" class="form-control" id="inputEmail46" placeholder="Your City">
                      </div>
                      <div class="col-md-12 name-label">
                        <label for="inputEmail4" class="form-label label-sec">Your Area</label>
                        <input type="email" class="form-control" id="inputEmail47" placeholder="Your Area">
                      </div>
                      <div class="col-md-12 name-label">
              ...
              <p class="location">
                ...
                >
                  <path
                    ...
                    fill="#7D7D7D"
                  /></svg>Huston, London, United Kingdom
              </p>
            </div>
          </div>
          <div class="col-md-12">
