  ...
  @endif
    ...
    <div class="container-fluid">
            <div class="row">
                ...
                <div class="filter-lists dropdown-content" id="main">
                  ...
                  <div   class="filter-radio-items">
                    <input type="hidden" name="service_type" value="All" id="service_type">
                    <input type="hidden" name="service_role" value="All" id="service_role">
      ...
      <hr>
                  ...
                  {{-- <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-6">
                        <input type="number" name="distance" class="form-control filter-input" id="distance" placeholder="10km" onfocus="getLiveLocation()" style="width: 100%">
                    ...
                    <dd>
                        <div class="mutliSelect">
                            <ul>
                              ...
                              <li>  <input typeF="checkbox" name="languages[]" value="{{$item->language}}" />{{$item->language}}</li>
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="test25"  name="freelance_type" value="All" checked>
                      <label for="test25">All Plans</label>
                    </p>
                    <p>
                      <input type="radio" id="test9"  name="freelance_type" value="Premium" >
                      <label for="test9">Premium Plan</label>
                    </p>
                    <p>
                      <input type="radio" id="test10"  name="freelance_type" value="Basic">
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="testd25"  name="delivery_time" value="All" checked>
                      <label for="testd25">All Delivery Times</label>
                    </p>
                    <p>
                      <input type="radio" id="testd9"  name="delivery_time" value="1" >
                      <label for="testd9">Within 1 Day</label>
                    </p>
                    <p>
                      <input type="radio" id="testd11"  name="delivery_time" value="2">
                      <label for="testd11">Within 2 days</label>
                    </p>
                    <p>
                      <input type="radio" id="testd12"  name="delivery_time" value="3">
                      <label for="testd12">Within 3 days</label>
                    </p>
                    <p>
                      <input type="radio" id="testd13"  name="delivery_time" value="4">
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="testr25"  name="revision" value="All" checked>
                      <label for="testr25">All Revisions</label>
                    </p>
                    <p>
                      <input type="radio" id="testr9"  name="revision" value="1 to 5" >
                      <label for="testr9">1 to 5</label>
                    </p>
                    <p>
                      <input type="radio" id="testr11"  name="revision" value="5 to 10">
                      <label for="testr11">5 to 10</label>
                    </p>
                    <p>
                      <input type="radio" id="testr12"  name="revision" value="10 to 20">
                      <label for="testr12">10 to 20</label>
                    </p>
                    <p>
                      <input type="radio" id="testr13"  name="revision" value="Unlimited">
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="test6"  name="lesson_type" value="All" checked>
                      <label for="test6">All Classes</label>
                    </p>
                    <p>
                      <input type="radio" id="test7"  name="lesson_type" value="One">
                      <label for="test7">1 to 1 Class</label>
                    </p>
                    <p>
                      <input type="radio" id="test8"  name="lesson_type" value="Group">
                  ...
                  <div   class="filter-radio-items">
                    <p>
                      <input type="radio" id="test28"  name="class_type" value="All" checked>
                      <label for="test28">All Formats</label>
                    </p>
                    <p>
                      <input type="radio" id="test26"  name="class_type" value="Live">
                      <label for="test26">Live Classes</label>
                    </p>
                    <p>
                      <input type="radio" id="test27"  name="class_type" value="Recorded">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control filter-input" name="min_price" id="inputPassword" placeholder="$12000">
        </div>
        </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control filter-input" name="max_price" id="inputPassword" placeholder="$12000">
        </div>
        </div>
          ...
          <div class="mb-3 row">
             <div class="col-sm-12">
              <input type="text" class="form-control filter-input" name="date_time" id="selectDateTime" readonly placeholder="Select Date">
            </div>
            </div>
    ...
    <div class="filter-list-items">
      <ul>
        ...
        <a   onclick="SelectCategory(this.id)"  id="cats_{{$i}}" data-category="{{$item->category}}" data-category_type ="Category"><li>{{$item->category}}</li></a>
        <hr>
        @php $i++; @endphp
        @endforeach
