                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control filter-input" id="inputPassword" placeholder="enter your postcode">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" name="distance" class="form-control filter-input" id="distance"
                                       placeholder="10km" onfocus="getLiveLocation()" style="width: 100%">
                                    ...
                                    <ul>
                                        @if ($languages)
                                            @foreach ($languages as $item)
                                                <li><input typeF="checkbox" name="languages[]"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control filter-input" name="min_price" id="inputPassword"
                                       placeholder="$12000">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control filter-input" name="max_price" id="inputPassword"
                                       placeholder="$12000">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-12">
                                <input type="text" class="form-control filter-input" name="date_time"
                                       id="selectDateTime" readonly placeholder="Select Date">
                            </div>
                        </div>
                        ...
                        @if ($categories)
                            ...
                            @foreach ($categories as $item)
                                <a onclick="SelectCategory(this.id)" id="cats_{{$i}}"
                                   data-category="{{$item->category}}" data-category_type="Category">
                                    <li>{{$item->category}}</li>
                                </a>
                                <hr>
                                @php $i++; @endphp
