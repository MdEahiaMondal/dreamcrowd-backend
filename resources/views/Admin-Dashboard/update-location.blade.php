          ...
          <div class="col-md-12">
            <div class="dash">
              <div class="row">
                <div class="col-md-12">
                  <div class="dash-top">
                    ...
                    <h1 class="dash-title">Seller Management</h1>
                    <i class="fa-solid fa-chevron-right"></i>
                    <h1 class="dash-title">Seller Request</h1>
                    <i class="fa-solid fa-chevron-right"></i>
                    <span class="min-title">Request Detail</span>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <input
                      ...
                      class="form-control"
                      id="inputAddress"
                      placeholder="Islamic Republic of Pakistan"
                      readonly
                    />
                  </div>
                  <div class="col-md-6">
              ...
              <div class="api-section">
                <div class="row">
                  <div class="col-md-12">
                    <h5 class="mb-0">New Location Request</h5>
                  </div>
                </div>
              </div>
              ...
              <div class="form-section conditions">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <label for="inputAddress" class="form-label">Request</label>
                    <textarea
                      name=""
                      id=""
                      cols="5"
              ...
              <div class="row btns-section">
                <div class="col-md-12">
                  <button
                    type="button"
                    class="btn float-start verify-btns rjct-btn"
                  >
                    Reject
                  </button>
                  <button
                    type="button"
                    class="btn float-start verify-btns aprv-btn"
                  >
                    Approve
                  </button>
                  <button
                    type="button"
                    class="btn float-end verify-btns update-btn"
                  >
                    Meeting Request
                  </button>
                </div>
