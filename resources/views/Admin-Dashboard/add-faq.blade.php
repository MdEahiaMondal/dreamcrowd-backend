          ...
          <div class="col-md-12">
            <div class="dash">
              ...
              <div class="form-section">
                <div class="row">
                  <form action="/upload-faqs-dynamic" method="POST">
                    @csrf
                  ...
                  <form action="/upload-faqs-dynamic" method="POST">
                    ...
                    <div class="col-12 form-sec">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        id="inputAddress2" name="question"
                        placeholder="How This Work?" required
                      />
                    </div>
                    <div class="col-12 mt-0">
                      ...
                      >
                      <br />
                      <textarea id="test" name="answer"></textarea>
                    </div>
                  ...
                  <form action="/upload-faqs-dynamic" method="POST">
                    ...
                    <div class="col-12 form-sec">
                      ...
                      <select class="form-control" name="heading" id="">
                        <option selected disabled value="">--Select Faq's Heading--</option>
                        @if ($headings)
