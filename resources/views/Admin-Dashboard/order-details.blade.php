...
<head>
    ...
    <title>Order Details - {{ $order->order_number }} | Admin Dashboard</title>
            ...
            <div class="order-header">
                <div class="d-flex justify-content-between align-items-start flex-wrap">
                    <div>
                        ...
                        <p style="margin: 0; opacity: 0.9;">Complete order information and management</p>
                    </div>
                    <div>
                        @php
                            $statusClasses = [
            ...
            @if($order->user_disputed || $order->teacher_disputed)
                <div class="alert-custom alert-danger-custom">
                    ...
                    <div>
                        ...
                        @if($order->user_disputed && $order->teacher_disputed)
                            Both buyer and seller have raised disputes on this order.
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="info-card">
                        ...
                        <h5 style="margin-bottom: 15px; color: #667eea;">Buyer</h5>
                        ...
                        <h5 style="margin: 25px 0 15px 0; color: #667eea;">Seller/Teacher</h5>
                        <div class="participant-card">
                ...
                <div class="col-lg-4">
                    ...
                    @if($order->transaction)
                        <div class="info-card">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value"><small>{{ $order->transaction->id }}</small></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">Payment ID</span>
                                <span class="info-value"><small>{{ $order->transaction->payment_id ?? 'N/A' }}</small></span>
                            </div>
                            <div class="info-row">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value">
                                    @if($order->transaction->payout_status == 1)
                                        <span class="badge bg-success">Completed</span>
                                    @else
                                        <span class="badge bg-warning text-dark">Pending</span>
                                    @endif
                    ...
                    <div class="info-card">
                        ...
                        <div class="d-grid gap-3">
                            <a href="/admin/all-orders" class="btn btn-secondary">
                                <i class='bx bx-arrow-back'></i> Back to Orders
                            </a>
                            @if($order->status == 1 || $order->status == 2)
                                <button class="btn btn-success-custom btn-action" onclick="alert('Feature coming soon')">
                                    <i class='bx bx-check-circle'></i> Mark as Completed
                                </button>
                            @endif
                            @if($order->transaction && $order->transaction->payout_status == 0)
                                <button class="btn btn-primary-custom btn-action" onclick="alert('Feature coming soon')">
                                    <i class='bx bx-money'></i> Process Payout
                                </button>
                            @endif
                            @if($order->user_disputed || $order->teacher_disputed)
                                <button class="btn btn-danger-custom btn-action" onclick="alert('Feature coming soon')">
                                    <i class='bx bx-error-circle'></i> Handle Dispute
                                </button>
                            @endif
                        </div>
                    </div>
