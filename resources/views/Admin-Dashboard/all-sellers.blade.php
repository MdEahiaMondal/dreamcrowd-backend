                                          ...
                                          <table class="table">
                                            <thead>
                                              <tr class="text-nowrap">
                                                ...
                                                <th class="h-2">Seller ID</th>
                                                <th class="h-3">Reg. Date</th>
                                                <th class="h-4">
                                                  Service Type
                                                </th>
                                                <th class="h-5">Category</th>
                                                <th class="h-3">Location</th>
                                                <th class="h-7">Rating</th>
                                                <th class="h-8">Total Order</th>
                                                <th class="h-8">
                                                  Total Amount
                                                </th>
                                                <th class="h-8">Refunds</th>
                                                <th class="h-9 act">Action</th>
                                              </tr>
                                            </thead>
                                            <tbody>
                                              <tr>
