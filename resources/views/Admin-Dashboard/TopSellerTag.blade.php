            ...
            <div class="dash">
              ...
              <div class="col-md-12 manage-profile-faq-sec edit-faqs">
               ...
               <div class="form-section">
                <div class="row">
                  <form action="/update-top-seller-re" method="POST">
                    @csrf
                    ...
                    <div class="col-12 mt-0">
                      ...
                      <input
                      type="text"
                      class="form-control" value="@if($tag){{$tag->earning}}@endif"
                      id="earning" name="earning"
                      placeholder="Minimmum : $20000" required />
                    ...
                    <div class="col-12 mt-0">
                      ...
                      <input
                      type="text"
                      class="form-control" value="@if($tag){{$tag->booking}}@endif"
                      id="booking" name="booking"
                      placeholder="Minimmum : 100" required />
                    ...
                    <div class="col-12 mt-0">
                      ...
                      <input
                      type="text"
                      class="form-control" value="@if($tag){{$tag->review}}@endif"
                      id="review" name="review"
                      placeholder="Minimmum : 4" required />
                    </div>
...
<script>
  const numberInputs = ['earning', 'booking', 'review'];
