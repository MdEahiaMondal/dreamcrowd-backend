                      ...
                      <div class="col-md-6 identity" id="upload-image">
                        ...
                        <div class="input-file-wrapper transition-linear-3 position-relative">
                          ...
                          <input
                            ...
                            accept="image/*" value="@if($home){{$home->site_logo}}@endif"
                      ...
                      <div class="col-md-6 identity" id="upload-image1">
                        ...
                        <div class="input-file-wrapper transition-linear-3 position-relative">
                          ...
                          <input
                            ...
                            accept="image/*" value="@if($home){{$home->fav_icon}}@endif"
                        ...
                        <div class="">
                            ...
                            <div class="col-12 form-sec">
                              <label for="inputAddress" class="form-label"
                                >Show/Hide</label
                              >
                              <input type="hidden"  name="notification_bar" id="notification_check" >
                              <input type="checkbox"id="aa1"   class="add-page-check" @if ($home) @if ($home->notification_bar == 1) checked  @endif @endif >
                            ...
                            <div class="col-12 form-sec">
                              ...
                              >
                              <input
                                type="text" required name="notification_heading"
                                class="form-control"
                                id="inputAddress2" value="@if($home){{$home->notification_heading}}@endif"
                            ...
                            <div class="col-12 form-sec">
                              ...
                              >
                              <input
                                type="text"  required name="notification"
                                class="form-control"
                                id="inputAddress2" value="@if($home){{$home->notification}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                      ...
                      <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="col-12 form-sec">
                              ...
                              >
                              <input
                                type="text"  required name="hero_text"
                                class="form-control"
                                id="inputAddress" value="@if($home){{$home->hero_text}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <div class="col-12 form-sec">
                              <label for="inputAddress2" class="form-label"
                                >Display Text Description</label
                              >
                              <input
                                type="text" required name="hero_description"
                                class="form-control"
                                id="inputAddress2" value="@if($home){{$home->hero_discription}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <!--Image-->
                            <div class="col-md-12 personal-info identity" id="upload-image2">
                              ...
                              <div class="input-file-wrapper transition-linear-3 position-relative">
                                ...
                                <input
                                  ...
                                  accept="image/*" value="@if($home){{$home->hero_image}}@endif"
                      ...
                      <div class="col-md-12">
                        <div class="row g-3">
                          <div class="col-6">
                            ...
                            <input
                              type="text" required name="counter_heading1"
                              class="form-control"
                              id="inputAddress" value="@if($home){{$home->counter_heading_1}}@endif"
                          ...
                          <div class="col-6 api-secret">
                            ...
                            <input
                              type="number" required name="counter_number1"
                              class="form-control"
                              id="inputAddress2"  value="@if($home){{$home->counter_number_1}}@endif"
                              placeholder="25900"
                            />
                          </div>
                          <div class="col-6">
                            <label for="inputAddress" class="form-label">Heading </label>
                            <input
                              type="text" required name="counter_heading2"
                              class="form-control"
                              id="inputAddress"  value="@if($home){{$home->counter_heading_2}}@endif"
                          ...
                          <div class="col-6 api-secret">
                            <label for="inputAddress2" class="form-label">Numbers</label>
                            <input
                              type="number" required name="counter_number2"
                              class="form-control"
                              id="inputAddress2"  value="@if($home){{$home->counter_number_2}}@endif"
                              placeholder="10000"
                            />
                          </div>
                          <div class="col-6">
                            <label for="inputAddress" class="form-label">Heading </label>
                            <input
                              type="text" required name="counter_heading3"
                              class="form-control"
                              id="inputAddress"  value="@if($home){{$home->counter_heading_3}}@endif"
                          ...
                          <div class="col-6 api-secret">
                            <label for="inputAddress2" class="form-label">Numbers</label>
                            <input
                              type="number" required name="counter_number3"
                              class="form-control"
                              id="inputAddress2"  value="@if($home){{$home->counter_number_3}}@endif"
                              placeholder="5000"
                            />
                          </div>
                          <div class="col-6">
                            <label for="inputAddress" class="form-label">Heading </label>
                            <input
                              type="text" required name="counter_heading4"
                              class="form-control"
                              id="inputAddress"  value="@if($home){{$home->counter_heading_4}}@endif"
                          ...
                          <div class="col-6 api-secret">
                            <label for="inputAddress2" class="form-label">Numbers</label>
                            <input
                              type="number" required name="counter_number4"
                              class="form-control"
                              id="inputAddress2"  value="@if($home){{$home->counter_number_4}}@endif"
                              placeholder="8000"
                            />
                          </div>
                        </div>
                      ...
                      <div class="">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input
                              type="text" required name="rating_heading"
                              class="form-control"
                              id="inputEmail4"  value="@if($home){{$home->rating_heading}}@endif"
                              placeholder="5k + student"
                            />
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Stars</label>
                            <select  required name="rating_stars" class="form-select" aria-label="Default select example">
                              @if ($home)
                            ...
                            <div class="row">
                              <div class="col-md-2 gallery identity" id="upload-image3">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    type="file"   name="rating_image1"
                                    accept="image/*"  value="@if($home){{$home->rating_image_1}}@endif"
                              ...
                              <div class="col-md-2 gallery identity" id="upload-image4">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    type="file"    name="rating_image2"
                                    accept="image/*"   value="@if($home){{$home->rating_image_2}}@endif"
                              ...
                              <div class="col-md-2 gallery identity" id="upload-image5">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    type="file"   name="rating_image3"
                                    accept="image/*"  value="@if($home){{$home->rating_image_3}}@endif"
                              ...
                              <div class="col-md-2 gallery identity" id="upload-image6">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    type="file"   name="rating_image4"
                                    accept="image/*"  value="@if($home){{$home->rating_image_4}}@endif"
                              ...
                              <div class="col-md-2 gallery identity" id="upload-image7">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    type="file"   name="rating_image5"
                                    accept="image/*"  value="@if($home){{$home->rating_image_5}}@endif"
                              ...
                              <div class="col-md-2 gallery identity" id="upload-image8">
                                <div class="input-file-wrapper transition-linear-3 position-relative">
                                  ...
                                  <input
                                    type="file"   name="rating_image6"
                                    accept="image/*"  value="@if($home){{$home->rating_image_6}}@endif"
                      ...
                      <div class="">
                        <div class="row">                         
                            <div class="col-md-12">
                              <label for="inputEmail4" class="form-label">Heading</label>
                              <input
                                type="text"  required name="work_heading"
                                class="form-control"
                                id="inputEmail4"  value="@if($home){{$home->work_heading}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <div class="col-md-12 work-sec">
                              ...
                              <input
                                type="text"  required name="work_tagline"
                                class="form-control"
                                id="inputEmail4"  value="@if($home){{$home->work_tagline}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image9">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"   name="work_image1"
                                accept="image/*"  value="@if($home){{$home->work_image_1}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-12">
                                          <label for="inputEmail4" class="form-label">Heading</label>
                                          <input
                                            type="text" required name="work_heading1"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home){{$home->work_heading_1}}@endif"
                                            placeholder="Heading"
                                          />
                                        </div>
                                        <div class="col-md-12 desc">
                                          ...
                                          <input
                                            type="text" required name="work_description1"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home){{$home->work_description_1}}@endif"
                        ...
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image10">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="work_image2"
                                accept="image/*" value="@if($home){{$home->work_image_2}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-12">
                                          <label for="inputEmail4" class="form-label">Heading</label>
                                          <input
                                            type="text" required name="work_heading2"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home){{$home->work_heading_2}}@endif"
                                            placeholder="Heading"
                                          />
                                        </div>
                                        <div class="col-md-12 desc">
                                          <label for="inputEmail4" class="form-label">Description</label>
                                          <input
                                            type="text" required name="work_description2"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home){{$home->work_description_2}}@endif"
                                            placeholder="Description"
                                          />
                                        </div>
                                  </div>
                        ...
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image11">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="work_image3"
                                accept="image/*" value="@if($home){{$home->work_image_3}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-12">
                                          <label for="inputEmail4" class="form-label">Heading</label>
                                          <input
                                            type="text" required name="work_heading3"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home){{$home->work_heading_3}}@endif"
                                            placeholder="Heading"
                                          />
                                        </div>
                                        <div class="col-md-12 desc">
                                          <label for="inputEmail4" class="form-label">Description</label>
                                          <input
                                            type="text" required name="work_description3"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home){{$home->work_description_3}}@endif"
                                            placeholder="Description"
                                          />
                                        </div>
                                  </div>
                      ...
                      <div class="">
                        <div class="row">      
                            <div class="col-md-12">
                              <label for="inputEmail4" class="form-label">Heading</label>
                              <input
                                type="text" required name="category_heading"
                                class="form-control"
                                id="inputEmail4" value="@if($home){{$home->category_heading}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <div class="col-md-12 work-sec">
                              <label for="inputEmail4" class="form-label">Tagline</label>
                              <input
                                type="text" required name="category_tagline"
                                class="form-control"
                                id="inputEmail4" value="@if($home){{$home->category_tagline}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image12">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image1"
                                accept="image/*" value="@if($home){{$home->category_image_1}}@endif"
                          ...
                          <div class="col-md-3 gallery identity" id="upload-image13">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image2"
                                accept="image/*" value="@if($home){{$home->category_image_2}}@endif"
                          ...
                          <div class="col-md-3 gallery identity" id="upload-image14">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image3"
                                accept="image/*" value="@if($home){{$home->category_image_3}}@endif"
                          ...
                          <div class="col-md-3 gallery identity" id="upload-image15">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image4"
                                accept="image/*" value="@if($home){{$home->category_image_4}}@endif"
                        ...
                        <div class="row work-sec">
                            <div class="col-md-3">
                                ...
                                <select class="form-control form-select" name="category_name1" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_1}}" selected>{{$home->category_name_1}}</option>
                                  @endif
                                  @php
                                ...
                                @php  $category = \App\Models\Category::where(['service_type'=>'Inperson', 'service_role'=>'Freelance'])->where('category','%like%',$item->category)->first();
                            //  $result = preg_replace('/\(.*?\)/', '', $item->category);
                              ...
                              <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name2" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_2}}" selected>{{$home->category_name_2}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                            ...
                            //  $result = preg_replace('/\(.*?\)/', '', $item->category); 
                              ...
                              <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name3" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_3}}" selected>{{$home->category_name_3}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                            ...
                            //  $result = preg_replace('/\(.*?\)/', '', $item->category); 
                              ...
                              <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name4" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_4}}" selected>{{$home->category_name_4}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                        ...
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image16">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image5"
                                accept="image/*" value="@if($home){{$home->category_image_5}}@endif"
                          ...
                          <div class="col-md-3 gallery identity" id="upload-image17">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image6"
                                accept="image/*" value="@if($home){{$home->category_image_6}}@endif"
                          ...
                          <div class="col-md-3 gallery identity" id="upload-image18">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image7"
                                accept="image/*" value="@if($home){{$home->category_image_7}}@endif"
                          ...
                          <div class="col-md-3 gallery identity" id="upload-image19">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="category_image8"
                                accept="image/*" value="@if($home){{$home->category_image_8}}@endif"
                        ...
                        <div class="row work-sec">
                            <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name5" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_5}}" selected>{{$home->category_name_5}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                            ...
                            //  $result = preg_replace('/\(.*?\)/', '', $item->category); 
                              ...
                              <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name6" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_6}}" selected>{{$home->category_name_6}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                            ...
                            //  $result = preg_replace('/\(.*?\)/', '', $item->category);
                              ...
                              <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name7" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_7}}" selected>{{$home->category_name_7}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                            ...
                            //  $result = preg_replace('/\(.*?\)/', '', $item->category);
                              ...
                              <div class="col-md-3">
                                <label for="inputAddress" class="form-label">Category Name</label>
                                <select class="form-control form-select" name="category_name8" id="">
                                  @if($home)
                                  <option value="{{$home->category_name_8}}" selected>{{$home->category_name_8}}</option>
                                  @endif
                                  @php
                                $categories = \App\Models\Category::where(['service_type'=>'Online','status'=>1 , 'service_role'=>'Class'])->get();
                                @endphp
                  ...
                  <div class="form-section" id="divMsg6">
                     <div class="row">
                      ...
                      <div class="row form-det">
                        <div class="col-md-12">
                            <label for="inputAddress" class="form-label">Heading</label>
                            <input type="text"  value="@if($home){{$home->expert_heading}}@endif" required name="expert_heading" class="form-control" id="inputAddress" placeholder="Discover Classes and Freelance Categories">
                        </div>
                        <div class="col-md-12 work-sec">
                            <label for="inputAddress" class="form-label">Tagline</label>
                            <input type="text" required name="expert_tagline"  value="@if($home){{$home->expert_tagline}}@endif" class="form-control" id="inputAddress" placeholder="Discover Classes and Freelance Categories">
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text"  required name="expert_link1"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_1}}@endif"
                        ...
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link2"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_2}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                      ...
                      <div class="row form-det">
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link3"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_3}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link4"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_4}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link5"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_5}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link6"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_6}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link7"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_7}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="row align-items-center">
                            ...
                            <div class="col-10">
                              <input
                                type="text" required name="expert_link8"
                                id="inputPassword6"
                                class="form-control" value="@if($home){{$home->expert_link_8}}@endif"
                                aria-describedby="passwordHelpInline"
                                placeholder="ID link"
                              />
                            </div>
                      ...
                      <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="col-12 form-sec">
                              ...
                              >
                              <input
                                type="text" required name="banner1_heading"
                                class="form-control"
                                id="inputAddress" value="@if($home2){{$home2->banner_1_heading}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <div class="col-12 form-sec">
                              <label for="inputAddress2" class="form-label"
                                >Description</label
                              >
                              <textarea  required name="banner1_description" id="" cols="5" rows="3" placeholder="Discover Classes and Freelance Categories">@if($home2){{$home2->banner_1_description}}@endif</textarea>
                            </div>
                            <!--Image-->
                            <div class="col-md-12 mb-4 personal-info identity" id="upload-image20">
                              ...
                              <div class="input-file-wrapper transition-linear-3 position-relative">
                                ...
                                <input
                                  type="file"  name="banner1_image"
                                  accept="image/*" value="@if($home2){{$home2->banner_1_image}}@endif"
                                  @change="previewImage('post-thumbnail20')"
                                  class="input-file"
                                  id="post-thumbnail20"
                                />
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="row align-items-center">
                                  ...
                                  <div class="col-9 mt-3">
                                    <input
                                      type="text" required name="banner1_btn1"
                                      id="inputPassword6" value="@if($home2){{$home2->banner_1_btn1_name}}@endif"
                              ...
                              <div class="col-md-6">
                                <div class="row align-items-center">
                                  ...
                                  <div class="col-10 mt-3">
                                    <input
                                      type="text" required name="banner1_link1"
                                      id="inputPassword6" value="@if($home2){{$home2->banner_1_btn1_link}}@endif"
                                      class="form-control mb-0"
                                      aria-describedby="passwordHelpInline"
                              ...
                              <div class="row form-det">
                                <div class="col-md-6">
                                  <div class="row align-items-center">
                                    ...
                                    <div class="col-9 mt-3">
                                      <input
                                        type="text" required name="banner1_btn2"
                                        id="inputPassword6" value="@if($home2){{$home2->banner_1_btn2_name}}@endif"
                                        class="form-control mb-0"
                                        aria-describedby="passwordHelpInline"
                                        placeholder="Get Started"
                                      />
                                ...
                                <div class="col-md-6">
                                  <div class="row align-items-center">
                                    ...
                                    <div class="col-10 mt-3">
                                      <input
                                        type="text" required name="banner1_link2"
                                        id="inputPassword6" value="@if($home2){{$home2->banner_1_btn2_link}}@endif"
                                        class="form-control mb-0"
                                        aria-describedby="passwordHelpInline"
                                        placeholder="https://www.example.org"
                                      />
                  ...
                  <div class="form-section" id="divMsg9">
                    <div class="row">
                        ...
                        <div class="row form-det">
                          <div class="col-md-12">
                              <label for="inputAddress" class="form-label">Heading</label>
                              <input type="text"  value="@if($home2){{$home2->service_heading}}@endif" required name="service_heading" class="form-control" id="inputAddress" placeholder="Discover Classes and Freelance Categories">
                          </div>
                          <div class="col-md-12 work-sec">
                              <label for="inputAddress" class="form-label">Tagline</label>
                              <input type="text" value="@if($home2){{$home2->service_tagline}}@endif" required name="service_tagline" class="form-control" id="inputAddress" placeholder="Discover Classes and Freelance Categories">
                          </div>
                          <div class="row work-sec"></div>
                          <div class="col-md-6">
                            <div class="row align-items-center">
                              <div class="col-auto">
                                <label for="inputPassword6" class="col-form-label"
                                  >Service ID link</label
                                >
                              </div>
                              <div class="col-10">
                                <input
                                  type="text" required name="service_link1"
                                  id="inputPassword6" value="@if($home2){{$home2->service_link_1}}@endif"
                                  class="form-control"
                                  aria-describedby="passwordHelpInline"
                                  placeholder="ID link"
                                />
                          ...
                          <div class="col-md-6">
                            <div class="row align-items-center">
                              ...
                              <div class="col-10">
                                <input
                                  type="text" required name="service_link2"
                                  id="inputPassword6"
                                  class="form-control" value="@if($home2){{$home2->service_link_2}}@endif"
                                  aria-describedby="passwordHelpInline"
                                  placeholder="ID link"
                                />
                              </div>
                        ...
                        <div class="row form-det">
                          <div class="col-md-6">
                            <div class="row align-items-center">
                              ...
                              <div class="col-10">
                                <input
                                  type="text" required name="service_link3"
                                  id="inputPassword6"
                                  class="form-control" value="@if($home2){{$home2->service_link_3}}@endif"
                                  aria-describedby="passwordHelpInline"
                                  placeholder="ID link"
                                />
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="row align-items-center">
                              ...
                              <div class="col-10">
                                <input
                                  type="text" required name="service_link4"
                                  id="inputPassword6"
                                  class="form-control" value="@if($home2){{$home2->service_link_4}}@endif"
                                  aria-describedby="passwordHelpInline"
                                  placeholder="ID link"
                                />
                              </div>
                      ...
                      <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="col-12 form-sec">
                              ...
                              >
                              <input
                                type="text" required name="banner2_heading"
                                class="form-control"
                                id="inputAddress" value="@if($home2){{$home2->banner_2_heading}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <div class="col-12 form-sec">
                              <label for="inputAddress2" class="form-label"
                                >Description</label
                              >
                              <textarea  required name="banner2_description" id="" cols="5" rows="3" placeholder="Discover Classes and Freelance Categories">@if($home2){{$home2->banner_2_description}}@endif</textarea>
                            </div>
                            <!--Image-->
                            <div class="col-md-12 mb-4 personal-info identity" id="upload-image30">
                              ...
                              <div class="input-file-wrapper transition-linear-3 position-relative">
                                ...
                                <input
                                  type="file"  name="banner2_image"
                                  accept="image/*" value="@if($home2){{$home2->banner_2_image}}@endif"
                                  @change="previewImage('post-thumbnail30')"
                                  class="input-file"
                                  id="post-thumbnail30"
                                />
                              </div>
                            ...
                            <div class="row form-det">
                              <div class="col-md-6">
                                <div class="row align-items-center">
                                  ...
                                  <div class="col-9 mt-3">
                                    <input
                                      type="text" required name="banner2_btn1"
                                      id="inputPassword6" value="@if($home2){{$home2->banner_2_btn1_name}}@endif"
                                      class="form-control mb-0"
                                      aria-describedby="passwordHelpInline"
                                      placeholder="Get Started"
                                    />
                              ...
                              <div class="col-md-6">
                                <div class="row align-items-center">
                                  ...
                                  <div class="col-10 mt-3">
                                    <input
                                      type="text" required name="banner2_link1"
                                      id="inputPassword6" value="@if($home2){{$home2->banner_2_btn1_link}}@endif"
                                      class="form-control mb-0"
                                      aria-describedby="passwordHelpInline"
                                      placeholder="https://www.example.org"
                                    />
                              ...
                              <div class="row form-det">
                                <div class="col-md-6">
                                  <div class="row align-items-center">
                                    ...
                                    <div class="col-9 mt-3">
                                      <input
                                        type="text" required name="banner2_btn2"
                                        id="inputPassword6" value="@if($home2){{$home2->banner_2_btn2_name}}@endif"
                                        class="form-control mb-0"
                                        aria-describedby="passwordHelpInline"
                                        placeholder="Get Started"
                                      />
                                ...
                                <div class="col-md-6">
                                  <div class="row align-items-center">
                                    ...
                                    <div class="col-10 mt-3">
                                      <input
                                        type="text" required name="banner2_link2"
                                        id="inputPassword6" value="@if($home2){{$home2->banner_2_btn2_link}}@endif"
                                        class="form-control mb-0"
                                        aria-describedby="passwordHelpInline"
                                        placeholder="https://www.example.org"
                                      />
                      ...
                      <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                              <label for="inputEmail4" class="form-label">Heading</label>
                              <input
                                type="text" required name="review_heading"
                                class="form-control"
                                id="inputEmail4" value="@if($home2){{$home2->review_heading}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                            <div class="col-md-12 work-sec">
                              <label for="inputEmail4" class="form-label">Tagline</label>
                              <input
                                type="text" required name="review_tagline"
                                class="form-control"
                                id="inputEmail4" value="@if($home2){{$home2->review_tagline}}@endif"
                                placeholder="Discover Classes and Freelance Categories"
                              />
                            </div>
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image21">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="review_image1"
                                accept="image/*" value="@if($home2){{$home2->review_image_1}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-4">
                                          ...
                                          <input
                                            type="text" required name="review_name1"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_name_1}}@endif"
                                        ...
                                        <div class="col-md-4 desc">
                                          ...
                                          <input
                                            type="text" required name="review_designation1"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_designation_1}}@endif"
                                        ...
                                        <div class="col-md-4 desc">
                                            ...
                                            <input
                                              type="text" required name="review_rating1"
                                              class="form-control"
                                              id="inputEmail4" value="@if($home2){{$home2->review_rating_1}}@endif"
                                              placeholder="4"
                                            />
                                          </div>
                                          <div class="col-md-12">
                                            <label for="inputEmail4" class="form-label">Review</label>
                                            <input
                                              type="text" required name="review_review1"
                                              class="form-control"
                                              id="inputEmail4" value="@if($home2){{$home2->review_review_1}}@endif"
                        ...
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image22">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="review_image2"
                                accept="image/*" value="@if($home2){{$home2->review_image_2}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-4">
                                          <label for="inputEmail4" class="form-label">Name</label>
                                          <input
                                            type="text" required name="review_name2"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_name_2}}@endif"
                                            placeholder="eg. Usama A."
                                          />
                                        </div>
                                        <div class="col-md-4 desc">
                                          <label for="inputEmail4" class="form-label">Designation</label>
                                          <input
                                            type="text" required name="review_designation2"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_designation_2}}@endif"
                                            placeholder="Designation"
                                          />
                                        </div>
                                        <div class="col-md-4 desc">
                                            <label for="inputEmail4" class="form-label">Rating</label>
                                            <input
                                              type="text" required name="review_rating2"
                                              class="form-control"
                                              id="inputEmail4" value="@if($home2){{$home2->review_rating_2}}@endif"
                                              placeholder="4"
                                            />
                                          </div>
                                          <div class="col-md-12">
                                            <label for="inputEmail4" class="form-label">Review</label>
                                            <input
                                              type="text" required name="review_review2"
                                              class="form-control"
                        ...
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image23">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="review_image3"
                                accept="image/*" value="@if($home2){{$home2->review_image_3}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-4">
                                          <label for="inputEmail4" class="form-label">Name</label>
                                          <input
                                            type="text" required name="review_name3"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_name_3}}@endif"
                                            placeholder="eg. Usama A."
                                          />
                                        </div>
                                        <div class="col-md-4 desc">
                                          <label for="inputEmail4" class="form-label">Designation</label>
                                          <input
                                            type="text" required name="review_designation3"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_designation_3}}@endif"
                                            placeholder="Designation"
                                          />
                                        </div>
                                        <div class="col-md-4 desc">
                                            <label for="inputEmail4" class="form-label">Rating</label>
                                            <input
                                              type="text" required name="review_rating3"
                                              class="form-control"
                                              id="inputEmail4" value="@if($home2){{$home2->review_rating_3}}@endif"
                                              placeholder="4"
                                            />
                                          </div>
                                          <div class="col-md-12">
                                            <label for="inputEmail4" class="form-label">Review</label>
                                            <input
                                              type="text" required name="review_review3"
                                              class="form-control"
                        ...
                        <div class="row work-sec">
                          <div class="col-md-3 gallery identity" id="upload-image24">
                            <div class="input-file-wrapper transition-linear-3 position-relative">
                              ...
                              <input
                                type="file"  name="review_image4"
                                accept="image/*" value="@if($home2){{$home2->review_image_4}}@endif"
                              ...
                              <div class="col-md-9">
                                  <div class="row">
                                      <div class="col-md-4">
                                          <label for="inputEmail4" class="form-label">Name</label>
                                          <input
                                            type="text" required name="review_name4"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_name_4}}@endif"
                                            placeholder="eg. Usama A."
                                          />
                                        </div>
                                        <div class="col-md-4 desc">
                                          <label for="inputEmail4" class="form-label">Designation</label>
                                          <input
                                            type="text" required name="review_designation4"
                                            class="form-control"
                                            id="inputEmail4" value="@if($home2){{$home2->review_designation_4}}@endif"
                                            placeholder="Designation"
                                          />
                                        </div>
                                        <div class="col-md-4 desc">
                                            <label for="inputEmail4" class="form-label">Rating</label>
                                            <input
                                              type="text" required name="review_rating4"
                                              class="form-control"
                                              id="inputEmail4" value="@if($home2){{$home2->review_rating_4}}@endif"
                                              placeholder="4"
                                            />
                                          </div>
                                          <div class="col-md-12">
                                            <label for="inputEmail4" class="form-label">Review</label>
                                            <input
                                              type="text" required name="review_review4"
                                              class="form-control"
      ...
      if (input.files) {
        ...
        reader.onload = (e) => {
          ...
          "extendedTimeOut": "4410000" // 10 seconds 
                       ...
                       toastr.error("Logo Image Height 40px and Width 265px Only Allowed!");
                        data = "false"; 
                      }else{
                        data = "true"; 
                    }
      ...
      if (input.files) {               
        ...
        reader.onload = (e) => {
          ...
          "extendedTimeOut": "4410000" // 10 seconds
                       ...
                       toastr.error("Hero Image Height 408px and Width 612px Only Allowed!");
                        data = "false"; 
                      }else{
                        data = "true"; 
                    }
      ...
      if (input.files) {
        ...
        reader.onload = (e) => {
          ...
          "extendedTimeOut": "4410000" // 10 seconds
                      ...
                      toastr.error("Work Image Height 280px and Width 400px Only Allowed!");
                      data = "false"; 
                      }else{
                        data = "true"; 
                    }
      ...
      if (input.files) {
        ...
        reader.onload = (e) => {
          ...
          "extendedTimeOut": "4410000" // 10 seconds
                      ...
                      toastr.error("Category Image Height 160px and Width 295px Only Allowed!");
                      data = "false"; 
                      }else{
                        data = "true"; 
                    }
      ...
      if (input.files) {
        ...
        reader.onload = (e) => {
          ...
          "extendedTimeOut": "4410000" // 10 seconds
                       ...
                       toastr.error("Banner Image Height 320px and Width 400px Only Allowed!");
                       data = "false"; 
                      }else{
                        data = "true"; 
                    }
