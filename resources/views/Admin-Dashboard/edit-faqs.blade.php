          ...
          <div class="col-md-12">
            <div class="dash">
              ...
              <div class="col-md-12 manage-profile-faq-sec edit-faqs">
                <h5>Edit FAQ Heading</h5>
                {{-- <a href="/delete-faqs-heading-dynamic/{{$faq->id}}"></a> --}}
                <button class="btn float-end remove-btn"  onclick="DeleteConfirmation(this.id)" id="delete-btn{{$faq->id}}" data-type="heading" data-id="{{$faq->id}}">Remove</button>
              </div>

               <!-- form add faq's -->
               <div class="form-section">
                <div class="row">
                  <form action="/update-faqs-dynamic" method="POST">
                    @csrf
                    ...
                    <div class="col-12 form-sec">
                      ...
                      <select class="form-control" name="heading_type" id="">
                        @if ($faq->type == 'seller')
                        <option selected value="seller">Expert</option>
                    ...
                    <div class="col-12 mt-0">
                      ...
                      <input
                      type="text"
                      class="form-control" value="{{$faq->heading}}"
                      id="inputAddress2" name="heading"
                    ...
                    <div class="api-buttons">
                      <div class="row">
                        <div class="col-md-12">
                          <a  href="/admin-faq-dynamic" class="btn float-start cancel-btn">
                            Back
                          </a>
              ...
              <div class="col-md-12 manage-profile-faq-sec edit-faqs">
                <h5>Edit FAQ</h5>
                {{-- <a href="/delete-faqs-general-dynamic/{{$faq->id}}"
                  ><button class="btn float-end remove-btn">Remove</button>
                </a> --}}
                <button class="btn float-end remove-btn"  onclick="DeleteConfirmation(this.id)" id="delete-btn{{$faq->id}}" data-type="general" data-id="{{$faq->id}}">Remove</button>
              </div>
                  ...
                  <form action="/update-faqs-dynamic" method="POST">
                    ...
                    <div class="col-12 form-sec">
                      <label for="inputAddress2" class="form-label"
                        >Type</label
                      >
                      <select class="form-control" name="faq_type" id="">
                        @if ($faq->type == 'seller')
                        <option selected value="seller">Expert</option>
                        <option value="buyer">Buyer</option>
                        @else
                    ...
                    <div class="col-12 mt-0">
                      ...
                      >
                      <br />
                      <textarea id="test" name="answer">{!!$faq->answer!!}</textarea>
                    </div>
              ...
              <div class="col-md-12 manage-profile-faq-sec edit-faqs">
                <h5>Edit FAQ</h5>
                {{-- <a href="/delete-faqs-dynamic/{{$faq->id}}"
                  ><button class="btn float-end remove-btn">Remove</button>
                </a> --}}
                <button class="btn float-end remove-btn"  onclick="DeleteConfirmation(this.id)" id="delete-btn{{$faq->id}}" data-type="faq" data-id="{{$faq->id}}">Remove</button>
              </div>
                  ...
                  <form action="/update-faqs-dynamic" method="POST">
                    ...
                    <div class="col-12 form-sec">
                      <label for="inputAddress2" class="form-label"
                        >Heading</label
                      >
                      <select class="form-control" name="heading" id="">
                        <option selected  value="{{$heading->id}}">{{$heading->heading}}</option>
                        @if ($headings)
