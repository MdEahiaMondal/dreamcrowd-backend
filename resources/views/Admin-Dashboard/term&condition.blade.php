...
<html lang="en">
  <head>
   ...
   {{-- =======Toastr CDN ======== --}}
    ...
    <title>
      Super Admin Dashboard | Dynamic Management-T&C and Privacy Policy
    </title>
  </head>
  <style>
    .button {
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="dash-top">
                    ...
                    <i class="fa-solid fa-chevron-right"></i>
                    <span class="min-title">T&C and Privacy Policy</span>
                  </div>
                </div>
              </div>
              ...
              <div class="form-section conditions">
                <div class="row">
                  <div class="col-md-12">
                    <div class="">
                      <form class="row">
                        <h5>All Privacy Policies</h5>

                        @if ($privacy)

                        @foreach ($privacy as $item)
                        <div class="col-md-6">
                          <a href="/edit-term-condition-dynamic/{{$item->id}}">
                            <input
                              type="email"
                              class="form-control"
                              id="inputEmail4"
                        ...
                        <div class="col-md-6">
                          <a >
                            <input
                              ...
                              class="form-control"
                              id="inputEmail4"
                              placeholder="Not Added Any Privacy & Policies Yet!" readonly
                          /></a>
                        </div>   
                        @endif
                      ...
                      @php $type = 'privacy';  @endphp
                      <a
                        class="btn float-end condition-btn"
                        href="/add-term-condition-dynamic/{{$type}}"
                      >
                        Add New Policy
                      </a>
                    </div>
                        ...
                        <div class="col-md-6">
                          <a >
                            <input
                              ...
                              class="form-control"
                              id="inputEmail4"
                              placeholder="Not Added Any Term & Conditions Yet!" readonly
                          /></a>
                        </div>   
                        @endif
