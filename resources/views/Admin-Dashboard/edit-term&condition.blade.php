          ...
          <div class="col-md-12">
            <div class="dash">
              ...
              <div class="send-notify">
                <div class="row">
                  <div class="col-md-12 edit-policy">
                    ...
                    <div class="float-end">
                      {{-- <a href="/delete-term-condition-dynamic/{{$term->id}}"></a> --}}
                        <button class="btn remove-button remove"  onclick="DeleteConfirmation(this.id)" id="delete-btn{{$term->id}}"  data-id="{{$term->id}}">Remove</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-section">
                <div class="row">
                  <form action="/update-term-condition-dynamic" method="POST">
                    @csrf
                    <div class="col-12 form-sec">
                      ...
                      <input
                        ...
                        id="inputAddress"  value="{{$term->heading}}"
                    ...
                    <div class="col-12 mt-0">
                      <label for="inputAddress2" class="form-label"
                        >Terms & Conditions Detail</label
                      >
                      <br />
                      <textarea id="test" name="detail">{!! $term->detail !!}</textarea>
                    </div>
...
<script>
  function DeleteConfirmation(Clicked) {
    var id = $('#'+Clicked).data('id');
      ...
      $("#delete-submit").attr("href", "/delete-term-condition-dynamic/"+id);
