              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="dash-top">
                    ...
                    <i class="fa-solid fa-chevron-right"></i>
                    <span class="min-title">Seller Request</span>
                  </div>
                </div>
              </div>
                                ...
                                <table class="table">
                                  <thead>
                                    <tr class="text-nowrap">
                                      ...
                                      <th class="h-2">Email</th>

                                      <th class="h-4">Request Type</th>

                                      <th class="h-8">Request Date</th>

                                      <th class="h-12">Action</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    @if ($request)
                                    ...
                                    <tr>
                                      <td>
                                        <div class="d-flex gap-2">
                                          <img style="width: 50px; height:50px; border-radius: 100%;"
                                            src="assets/profile/img/{{$user->profile}}"
                                            alt=""
                                          />
                                      ...
                                      <td>{{$user->email}}</td>
                                      <td>
                                        @if ($item->request_type == 'location')
                                            Update Location 
                                            @elseif($item->request_type == 'category')
                                            Add a New Category
                                            @else
                                            Update Profile
                                        @endif
                                      ...
                                      <td>
                                        <a
                                          href="/seller-update-request/{{$item->id}}"
                                    ...
                                    {{-- <tr>
                                      ...
                                      <td>Profession Update</td>
                                      <td>October 23, 2023</td>
                                      <td>
                                        <a
                                          href="../User-Dashboard/Application-request.html"
                                          ><button class="view-btn">
                                            View Application
                                          </button></a
                                        >
