<div class="sidebar"> 
    ...
    <ul class="nav-links">
      ...
      <ul class="sub-menu">
          ...
          <li>
            <a href="/admin-commission-set">Commission</a>
          </li>
        </ul>
      </li>
      ...
      <li>
       ...
       <li>
        <a href="discount-code.html">
            <i class='bx bxs-discount icon'title="Discount Codes" ></i>
          <span class="link_name">Discount Codes</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="discount-code.html">Discount Codes</a></li>
        </ul>
      </li>
