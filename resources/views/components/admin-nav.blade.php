        ...
        <div class="col-md-4" style="padding: 0px 12px">
          <div class="nav-profile">
           ...
           @php  $firstLetter = strtoupper(substr(Auth::user()->first_name, 0, 1));  @endphp
               <div class="img_profile" style="width: 50px; height: 50px; background: #28a745; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 20px; border-radius: 50%;">
                 {{ $firstLetter }}
              </div>
           @else
