...
<div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu blank">
          <li>
            <a class="link_name" href="{{ route('user.notifications') }}">Notifications</a>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="/reviews">Reviews</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
...
<script src="/assets/user/asset/js/sidebar.js"></script>
<!-- Active Menu Script -->
<script src="/assets/user/asset/js/active-menu.js"></script>
<!-- Common Modal Script (requires jQuery) -->
<script src="/assets/user/asset/js/modals.js"></script>
